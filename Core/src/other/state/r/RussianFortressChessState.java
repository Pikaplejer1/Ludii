...
/** Auto-generated State subclass for RussianFortressChess. */
public class RussianFortressChessState extends State {
    ...
    public RussianFortressChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresTeams()) teams = new int[game.players().size()];
    }

    public RussianFortressChessState(final RussianFortressChessState other) {
        super(other);
    ...
    @Override public RussianFortressChessState copy() { return new RussianFortressChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RussianFortressChessState o = (RussianFortressChessState) other;
