...
/** Auto-generated State subclass for Residuel. */
public class ResiduelState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ResiduelState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ResiduelState(final ResiduelState other) {
        super(other);
    ...
    @Override public ResiduelState copy() { return new ResiduelState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ResiduelState o = (ResiduelState) other;
