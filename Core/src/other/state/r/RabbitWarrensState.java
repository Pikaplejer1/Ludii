...
/** Auto-generated State subclass for RabbitWarrens. */
public class RabbitWarrensState extends State {
    ...
    public RabbitWarrensState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RabbitWarrensState(final RabbitWarrensState other) {
        super(other);
    ...
    @Override public RabbitWarrensState copy() { return new RabbitWarrensState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RabbitWarrensState o = (RabbitWarrensState) other;
