...
/** Auto-generated State subclass for Ratio. */
public class RatioState extends State {
    ...
    public RatioState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RatioState(final RatioState other) {
        super(other);
    ...
    @Override public RatioState copy() { return new RatioState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RatioState o = (RatioState) other;
