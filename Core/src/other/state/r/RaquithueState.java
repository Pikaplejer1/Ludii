...
/** Auto-generated State subclass for Raquithue. */
public class RaquithueState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RaquithueState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RaquithueState(final RaquithueState other) {
        super(other);
    ...
    @Override public RaquithueState copy() { return new RaquithueState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RaquithueState o = (RaquithueState) other;
