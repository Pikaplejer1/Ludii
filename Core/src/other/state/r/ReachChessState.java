...
/** Auto-generated State subclass for ReachChess. */
public class ReachChessState extends State {
    ...
    public ReachChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ReachChessState(final ReachChessState other) {
        super(other);
    ...
    @Override public ReachChessState copy() { return new ReachChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ReachChessState o = (ReachChessState) other;
