...
/** Auto-generated State subclass for RajaPasuMandiri. */
public class RajaPasuMandiriState extends State {
    ...
    public RajaPasuMandiriState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RajaPasuMandiriState(final RajaPasuMandiriState other) {
        super(other);
    ...
    @Override public RajaPasuMandiriState copy() { return new RajaPasuMandiriState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RajaPasuMandiriState o = (RajaPasuMandiriState) other;
