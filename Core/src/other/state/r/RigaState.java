...
/** Auto-generated State subclass for Riga. */
public class RigaState extends State {
    ...
    public RigaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RigaState(final RigaState other) {
        super(other);
    ...
    @Override public RigaState copy() { return new RigaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RigaState o = (RigaState) other;
