...
/** Auto-generated State subclass for Redstone. */
public class RedstoneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RedstoneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RedstoneState(final RedstoneState other) {
        super(other);
    ...
    @Override public RedstoneState copy() { return new RedstoneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RedstoneState o = (RedstoneState) other;
