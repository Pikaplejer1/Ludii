...
/** Auto-generated State subclass for Ryakati. */
public class RyakatiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public RyakatiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RyakatiState(final RyakatiState other) {
        super(other);
    ...
    @Override public RyakatiState copy() { return new RyakatiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RyakatiState o = (RyakatiState) other;
