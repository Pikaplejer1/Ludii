...
/** Auto-generated State subclass for RwandanAlignmentGame. */
public class RwandanAlignmentGameState extends State {
    ...
    public RwandanAlignmentGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RwandanAlignmentGameState(final RwandanAlignmentGameState other) {
        super(other);
    ...
    @Override public RwandanAlignmentGameState copy() { return new RwandanAlignmentGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RwandanAlignmentGameState o = (RwandanAlignmentGameState) other;
