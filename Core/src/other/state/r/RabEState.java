...
/** Auto-generated State subclass for RabE. */
public class RabEState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public RabEState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RabEState(final RabEState other) {
        super(other);
    ...
    @Override public RabEState copy() { return new RabEState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RabEState o = (RabEState) other;
