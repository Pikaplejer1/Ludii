...
/** Auto-generated State subclass for Rascals. */
public class RascalsState extends State {
    ...
    public RascalsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RascalsState(final RascalsState other) {
        super(other);
    ...
    @Override public RascalsState copy() { return new RascalsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RascalsState o = (RascalsState) other;
