...
/** Auto-generated State subclass for Refugia. */
public class RefugiaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RefugiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RefugiaState(final RefugiaState other) {
        super(other);
    ...
    @Override public RefugiaState copy() { return new RefugiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RefugiaState o = (RefugiaState) other;
