...
/** Auto-generated State subclass for Rithmomachia. */
public class RithmomachiaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RithmomachiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RithmomachiaState(final RithmomachiaState other) {
        super(other);
    ...
    @Override public RithmomachiaState copy() { return new RithmomachiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RithmomachiaState o = (RithmomachiaState) other;
