...
/** Auto-generated State subclass for RumiShatranj. */
public class RumiShatranjState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RumiShatranjState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RumiShatranjState(final RumiShatranjState other) {
        super(other);
    ...
    @Override public RumiShatranjState copy() { return new RumiShatranjState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RumiShatranjState o = (RumiShatranjState) other;
