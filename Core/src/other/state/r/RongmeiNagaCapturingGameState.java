...
/** Auto-generated State subclass for RongmeiNagaCapturingGame. */
public class RongmeiNagaCapturingGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RongmeiNagaCapturingGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RongmeiNagaCapturingGameState(final RongmeiNagaCapturingGameState other) {
        super(other);
    ...
    @Override public RongmeiNagaCapturingGameState copy() { return new RongmeiNagaCapturingGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RongmeiNagaCapturingGameState o = (RongmeiNagaCapturingGameState) other;
