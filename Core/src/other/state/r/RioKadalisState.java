...
/** Auto-generated State subclass for RioKadalis. */
public class RioKadalisState extends State {
    ...
    public RioKadalisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RioKadalisState(final RioKadalisState other) {
        super(other);
    ...
    @Override public RioKadalisState copy() { return new RioKadalisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RioKadalisState o = (RioKadalisState) other;
