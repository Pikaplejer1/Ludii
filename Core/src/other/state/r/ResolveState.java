...
/** Auto-generated State subclass for Resolve. */
public class ResolveState extends State {
    ...
    public ResolveState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ResolveState(final ResolveState other) {
        super(other);
    ...
    @Override public ResolveState copy() { return new ResolveState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ResolveState o = (ResolveState) other;
