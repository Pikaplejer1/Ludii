...
/** Auto-generated State subclass for RoyalGameOfUr. */
public class RoyalGameOfUrState extends State {
    ...
    public RoyalGameOfUrState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public RoyalGameOfUrState(final RoyalGameOfUrState other) {
        super(other);
    ...
    @Override public RoyalGameOfUrState copy() { return new RoyalGameOfUrState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RoyalGameOfUrState o = (RoyalGameOfUrState) other;
