...
/** Auto-generated State subclass for Rimoe. */
public class RimoeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RimoeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RimoeState(final RimoeState other) {
        super(other);
    ...
    @Override public RimoeState copy() { return new RimoeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RimoeState o = (RimoeState) other;
