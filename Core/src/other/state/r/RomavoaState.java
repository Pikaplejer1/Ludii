...
/** Auto-generated State subclass for Romavoa. */
public class RomavoaState extends State {
    ...
    public RomavoaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public RomavoaState(final RomavoaState other) {
        super(other);
    ...
    @Override public RomavoaState copy() { return new RomavoaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RomavoaState o = (RomavoaState) other;
