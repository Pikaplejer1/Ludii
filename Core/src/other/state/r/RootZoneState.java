...
/** Auto-generated State subclass for RootZone. */
public class RootZoneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RootZoneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RootZoneState(final RootZoneState other) {
        super(other);
    ...
    @Override public RootZoneState copy() { return new RootZoneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RootZoneState o = (RootZoneState) other;
