...
/** Auto-generated State subclass for RenardEtLesPoules. */
public class RenardEtLesPoulesState extends State {
    ...
    public RenardEtLesPoulesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RenardEtLesPoulesState(final RenardEtLesPoulesState other) {
        super(other);
    ...
    @Override public RenardEtLesPoulesState copy() { return new RenardEtLesPoulesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RenardEtLesPoulesState o = (RenardEtLesPoulesState) other;
