...
/** Auto-generated State subclass for Rampart. */
public class RampartState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RampartState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RampartState(final RampartState other) {
        super(other);
    ...
    @Override public RampartState copy() { return new RampartState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RampartState o = (RampartState) other;
