...
/** Auto-generated State subclass for RimauRimauOneTiger. */
public class RimauRimauOneTigerState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public RimauRimauOneTigerState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public RimauRimauOneTigerState(final RimauRimauOneTigerState other) {
        super(other);
    ...
    @Override public RimauRimauOneTigerState copy() { return new RimauRimauOneTigerState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final RimauRimauOneTigerState o = (RimauRimauOneTigerState) other;
