...
/** Auto-generated State subclass for Owasokotz. */
public class OwasokotzState extends State {
    ...
    public OwasokotzState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public OwasokotzState(final OwasokotzState other) {
        super(other);
    ...
    @Override public OwasokotzState copy() { return new OwasokotzState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OwasokotzState o = (OwasokotzState) other;
