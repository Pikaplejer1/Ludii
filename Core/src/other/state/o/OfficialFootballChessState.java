...
/** Auto-generated State subclass for OfficialFootballChess. */
public class OfficialFootballChessState extends State {
    ...
    public OfficialFootballChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OfficialFootballChessState(final OfficialFootballChessState other) {
        super(other);
    ...
    @Override public OfficialFootballChessState copy() { return new OfficialFootballChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OfficialFootballChessState o = (OfficialFootballChessState) other;
