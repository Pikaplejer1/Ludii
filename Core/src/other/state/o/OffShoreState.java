...
/** Auto-generated State subclass for OffShore. */
public class OffShoreState extends State {
    ...
    public OffShoreState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OffShoreState(final OffShoreState other) {
        super(other);
    ...
    @Override public OffShoreState copy() { return new OffShoreState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OffShoreState o = (OffShoreState) other;
