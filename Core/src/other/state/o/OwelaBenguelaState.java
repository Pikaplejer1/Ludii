...
/** Auto-generated State subclass for OwelaBenguela. */
public class OwelaBenguelaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public OwelaBenguelaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OwelaBenguelaState(final OwelaBenguelaState other) {
        super(other);
    ...
    @Override public OwelaBenguelaState copy() { return new OwelaBenguelaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OwelaBenguelaState o = (OwelaBenguelaState) other;
