...
/** Auto-generated State subclass for Ovalhu. */
public class OvalhuState extends State {
    ...
    public OvalhuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OvalhuState(final OvalhuState other) {
        super(other);
    ...
    @Override public OvalhuState copy() { return new OvalhuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OvalhuState o = (OvalhuState) other;
