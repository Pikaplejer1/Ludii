...
/** Auto-generated State subclass for OkweAchalla. */
public class OkweAchallaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public OkweAchallaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OkweAchallaState(final OkweAchallaState other) {
        super(other);
    ...
    @Override public OkweAchallaState copy() { return new OkweAchallaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OkweAchallaState o = (OkweAchallaState) other;
