...
/** Auto-generated State subclass for OddEvenTree. */
public class OddEvenTreeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OddEvenTreeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OddEvenTreeState(final OddEvenTreeState other) {
        super(other);
    ...
    @Override public OddEvenTreeState copy() { return new OddEvenTreeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OddEvenTreeState o = (OddEvenTreeState) other;
