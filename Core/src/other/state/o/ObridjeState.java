...
/** Auto-generated State subclass for Obridje. */
public class ObridjeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public ObridjeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ObridjeState(final ObridjeState other) {
        super(other);
    ...
    @Override public ObridjeState copy() { return new ObridjeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ObridjeState o = (ObridjeState) other;
