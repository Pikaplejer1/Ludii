...
/** Auto-generated State subclass for OmegaChess. */
public class OmegaChessState extends State {
    ...
    public OmegaChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OmegaChessState(final OmegaChessState other) {
        super(other);
    ...
    @Override public OmegaChessState copy() { return new OmegaChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OmegaChessState o = (OmegaChessState) other;
