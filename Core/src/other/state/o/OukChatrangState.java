...
/** Auto-generated State subclass for OukChatrang. */
public class OukChatrangState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OukChatrangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OukChatrangState(final OukChatrangState other) {
        super(other);
    ...
    @Override public OukChatrangState copy() { return new OukChatrangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OukChatrangState o = (OukChatrangState) other;
