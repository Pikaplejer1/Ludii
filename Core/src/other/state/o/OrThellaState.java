...
/** Auto-generated State subclass for OrThella. */
public class OrThellaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OrThellaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OrThellaState(final OrThellaState other) {
        super(other);
    ...
    @Override public OrThellaState copy() { return new OrThellaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OrThellaState o = (OrThellaState) other;
