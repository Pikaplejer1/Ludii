...
/** Auto-generated State subclass for Omny. */
public class OmnyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public OmnyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OmnyState(final OmnyState other) {
        super(other);
    ...
    @Override public OmnyState copy() { return new OmnyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OmnyState o = (OmnyState) other;
