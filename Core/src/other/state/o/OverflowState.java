...
/** Auto-generated State subclass for Overflow. */
public class OverflowState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OverflowState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OverflowState(final OverflowState other) {
        super(other);
    ...
    @Override public OverflowState copy() { return new OverflowState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OverflowState o = (OverflowState) other;
