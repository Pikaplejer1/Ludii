...
/** Auto-generated State subclass for OAnQuan. */
public class OAnQuanState extends State {
    ...
    public OAnQuanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OAnQuanState(final OAnQuanState other) {
        super(other);
    ...
    @Override public OAnQuanState copy() { return new OAnQuanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OAnQuanState o = (OAnQuanState) other;
