...
/** Auto-generated State subclass for OneEyedGo. */
public class OneEyedGoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OneEyedGoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OneEyedGoState(final OneEyedGoState other) {
        super(other);
    ...
    @Override public OneEyedGoState copy() { return new OneEyedGoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OneEyedGoState o = (OneEyedGoState) other;
