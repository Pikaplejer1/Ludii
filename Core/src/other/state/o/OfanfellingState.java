...
/** Auto-generated State subclass for Ofanfelling. */
public class OfanfellingState extends State {
    ...
    public OfanfellingState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public OfanfellingState(final OfanfellingState other) {
        super(other);
    ...
    @Override public OfanfellingState copy() { return new OfanfellingState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OfanfellingState o = (OfanfellingState) other;
