...
/** Auto-generated State subclass for Oriath. */
public class OriathState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OriathState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OriathState(final OriathState other) {
        super(other);
    ...
    @Override public OriathState copy() { return new OriathState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OriathState o = (OriathState) other;
