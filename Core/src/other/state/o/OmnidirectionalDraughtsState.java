...
/** Auto-generated State subclass for OmnidirectionalDraughts. */
public class OmnidirectionalDraughtsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public OmnidirectionalDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OmnidirectionalDraughtsState(final OmnidirectionalDraughtsState other) {
        super(other);
    ...
    @Override public OmnidirectionalDraughtsState copy() { return new OmnidirectionalDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OmnidirectionalDraughtsState o = (OmnidirectionalDraughtsState) other;
