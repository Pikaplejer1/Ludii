...
/** Auto-generated State subclass for OmanguntaPeeta. */
public class OmanguntaPeetaState extends State {
    ...
    public OmanguntaPeetaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public OmanguntaPeetaState(final OmanguntaPeetaState other) {
        super(other);
    ...
    @Override public OmanguntaPeetaState copy() { return new OmanguntaPeetaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final OmanguntaPeetaState o = (OmanguntaPeetaState) other;
