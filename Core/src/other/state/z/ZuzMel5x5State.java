...
/** Auto-generated State subclass for ZuzMel5x5. */
public class ZuzMel5x5State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ZuzMel5x5State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ZuzMel5x5State(final ZuzMel5x5State other) {
        super(other);
    ...
    @Override public ZuzMel5x5State copy() { return new ZuzMel5x5State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ZuzMel5x5State o = (ZuzMel5x5State) other;
