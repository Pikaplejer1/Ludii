...
/** Auto-generated State subclass for Zamma. */
public class ZammaState extends State {
    ...
    public ZammaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ZammaState(final ZammaState other) {
        super(other);
    ...
    @Override public ZammaState copy() { return new ZammaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ZammaState o = (ZammaState) other;
