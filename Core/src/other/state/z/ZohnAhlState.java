...
/** Auto-generated State subclass for ZohnAhl. */
public class ZohnAhlState extends State {
    ...
    public ZohnAhlState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ZohnAhlState(final ZohnAhlState other) {
        super(other);
    ...
    @Override public ZohnAhlState copy() { return new ZohnAhlState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ZohnAhlState o = (ZohnAhlState) other;
