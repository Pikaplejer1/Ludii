...
/** Auto-generated State subclass for Zola. */
public class ZolaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ZolaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ZolaState(final ZolaState other) {
        super(other);
    ...
    @Override public ZolaState copy() { return new ZolaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ZolaState o = (ZolaState) other;
