...
/** Auto-generated State subclass for Zombego. */
public class ZombegoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public ZombegoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ZombegoState(final ZombegoState other) {
        super(other);
    ...
    @Override public ZombegoState copy() { return new ZombegoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ZombegoState o = (ZombegoState) other;
