...
/** Auto-generated State subclass for BheriBakhri. */
public class BheriBakhriState extends State {
    ...
    public BheriBakhriState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BheriBakhriState(final BheriBakhriState other) {
        super(other);
    ...
    @Override public BheriBakhriState copy() { return new BheriBakhriState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BheriBakhriState o = (BheriBakhriState) other;
