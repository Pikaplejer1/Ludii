...
/** Auto-generated State subclass for BrazilianDraughts. */
public class BrazilianDraughtsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BrazilianDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BrazilianDraughtsState(final BrazilianDraughtsState other) {
        super(other);
    ...
    @Override public BrazilianDraughtsState copy() { return new BrazilianDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BrazilianDraughtsState o = (BrazilianDraughtsState) other;
