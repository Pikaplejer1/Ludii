...
/** Auto-generated State subclass for Bao. */
public class BaoState extends State {
    ...
    public BaoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaoState(final BaoState other) {
        super(other);
    ...
    @Override public BaoState copy() { return new BaoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaoState o = (BaoState) other;
