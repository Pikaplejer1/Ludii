...
/** Auto-generated State subclass for BayKhom. */
public class BayKhomState extends State {
    ...
    public BayKhomState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BayKhomState(final BayKhomState other) {
        super(other);
    ...
    @Override public BayKhomState copy() { return new BayKhomState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BayKhomState o = (BayKhomState) other;
