...
/** Auto-generated State subclass for BuffaDeBaldrac. */
public class BuffaDeBaldracState extends State {
    ...
    public BuffaDeBaldracState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BuffaDeBaldracState(final BuffaDeBaldracState other) {
        super(other);
    ...
    @Override public BuffaDeBaldracState copy() { return new BuffaDeBaldracState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BuffaDeBaldracState o = (BuffaDeBaldracState) other;
