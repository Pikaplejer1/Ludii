...
/** Auto-generated State subclass for Buqruru. */
public class BuqruruState extends State {
    ...
    public BuqruruState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BuqruruState(final BuqruruState other) {
        super(other);
    ...
    @Override public BuqruruState copy() { return new BuqruruState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BuqruruState o = (BuqruruState) other;
