...
/** Auto-generated State subclass for Boukerourou. */
public class BoukerourouState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BoukerourouState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BoukerourouState(final BoukerourouState other) {
        super(other);
    ...
    @Override public BoukerourouState copy() { return new BoukerourouState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoukerourouState o = (BoukerourouState) other;
