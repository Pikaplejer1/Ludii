...
/** Auto-generated State subclass for BranchingCoral. */
public class BranchingCoralState extends State {
    ...
    public BranchingCoralState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BranchingCoralState(final BranchingCoralState other) {
        super(other);
    ...
    @Override public BranchingCoralState copy() { return new BranchingCoralState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BranchingCoralState o = (BranchingCoralState) other;
