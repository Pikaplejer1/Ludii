...
/** Auto-generated State subclass for Barjis. */
public class BarjisState extends State {
    ...
    public BarjisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BarjisState(final BarjisState other) {
        super(other);
    ...
    @Override public BarjisState copy() { return new BarjisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BarjisState o = (BarjisState) other;
