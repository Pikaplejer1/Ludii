...
/** Auto-generated State subclass for BoxOff. */
public class BoxOffState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BoxOffState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BoxOffState(final BoxOffState other) {
        super(other);
    ...
    @Override public BoxOffState copy() { return new BoxOffState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoxOffState o = (BoxOffState) other;
