...
/** Auto-generated State subclass for Bechi. */
public class BechiState extends State {
    ...
    public BechiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BechiState(final BechiState other) {
        super(other);
    ...
    @Override public BechiState copy() { return new BechiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BechiState o = (BechiState) other;
