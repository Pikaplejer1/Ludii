...
/** Auto-generated State subclass for BaghBatti. */
public class BaghBattiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BaghBattiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaghBattiState(final BaghBattiState other) {
        super(other);
    ...
    @Override public BaghBattiState copy() { return new BaghBattiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaghBattiState o = (BaghBattiState) other;
