...
/** Auto-generated State subclass for Banqi. */
public class BanqiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BanqiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BanqiState(final BanqiState other) {
        super(other);
    ...
    @Override public BanqiState copy() { return new BanqiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BanqiState o = (BanqiState) other;
