...
/** Auto-generated State subclass for Bug. */
public class BugState extends State {
    ...
    public BugState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BugState(final BugState other) {
        super(other);
    ...
    @Override public BugState copy() { return new BugState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BugState o = (BugState) other;
