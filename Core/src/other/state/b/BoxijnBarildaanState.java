...
/** Auto-generated State subclass for BoxijnBarildaan. */
public class BoxijnBarildaanState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BoxijnBarildaanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BoxijnBarildaanState(final BoxijnBarildaanState other) {
        super(other);
    ...
    @Override public BoxijnBarildaanState copy() { return new BoxijnBarildaanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoxijnBarildaanState o = (BoxijnBarildaanState) other;
