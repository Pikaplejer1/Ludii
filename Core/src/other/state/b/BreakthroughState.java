...
/** Auto-generated State subclass for Breakthrough. */
public class BreakthroughState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BreakthroughState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BreakthroughState(final BreakthroughState other) {
        super(other);
    ...
    @Override public BreakthroughState copy() { return new BreakthroughState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BreakthroughState o = (BreakthroughState) other;
