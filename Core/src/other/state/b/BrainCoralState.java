...
/** Auto-generated State subclass for BrainCoral. */
public class BrainCoralState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public BrainCoralState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BrainCoralState(final BrainCoralState other) {
        super(other);
    ...
    @Override public BrainCoralState copy() { return new BrainCoralState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BrainCoralState o = (BrainCoralState) other;
