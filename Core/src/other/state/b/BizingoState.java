...
/** Auto-generated State subclass for Bizingo. */
public class BizingoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BizingoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BizingoState(final BizingoState other) {
        super(other);
    ...
    @Override public BizingoState copy() { return new BizingoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BizingoState o = (BizingoState) other;
