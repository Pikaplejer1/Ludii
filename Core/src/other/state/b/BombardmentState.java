...
/** Auto-generated State subclass for Bombardment. */
public class BombardmentState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BombardmentState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BombardmentState(final BombardmentState other) {
        super(other);
    ...
    @Override public BombardmentState copy() { return new BombardmentState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BombardmentState o = (BombardmentState) other;
