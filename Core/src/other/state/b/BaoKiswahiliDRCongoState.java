...
/** Auto-generated State subclass for BaoKiswahiliDRCongo. */
public class BaoKiswahiliDRCongoState extends State {
    ...
    public BaoKiswahiliDRCongoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaoKiswahiliDRCongoState(final BaoKiswahiliDRCongoState other) {
        super(other);
    ...
    @Override public BaoKiswahiliDRCongoState copy() { return new BaoKiswahiliDRCongoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaoKiswahiliDRCongoState o = (BaoKiswahiliDRCongoState) other;
