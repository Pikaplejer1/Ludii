...
/** Auto-generated State subclass for BaghGuti. */
public class BaghGutiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BaghGutiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaghGutiState(final BaghGutiState other) {
        super(other);
    ...
    @Override public BaghGutiState copy() { return new BaghGutiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaghGutiState o = (BaghGutiState) other;
