...
/** Auto-generated State subclass for BanyarwandaMillGame. */
public class BanyarwandaMillGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BanyarwandaMillGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BanyarwandaMillGameState(final BanyarwandaMillGameState other) {
        super(other);
    ...
    @Override public BanyarwandaMillGameState copy() { return new BanyarwandaMillGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BanyarwandaMillGameState o = (BanyarwandaMillGameState) other;
