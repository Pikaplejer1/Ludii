...
/** Auto-generated State subclass for Bargese. */
public class BargeseState extends State {
    ...
    public BargeseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BargeseState(final BargeseState other) {
        super(other);
    ...
    @Override public BargeseState copy() { return new BargeseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BargeseState o = (BargeseState) other;
