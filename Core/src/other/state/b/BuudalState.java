...
/** Auto-generated State subclass for Buudal. */
public class BuudalState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BuudalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BuudalState(final BuudalState other) {
        super(other);
    ...
    @Override public BuudalState copy() { return new BuudalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BuudalState o = (BuudalState) other;
