...
/** Auto-generated State subclass for Baralie. */
public class BaralieState extends State {
    ...
    public BaralieState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BaralieState(final BaralieState other) {
        super(other);
    ...
    @Override public BaralieState copy() { return new BaralieState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaralieState o = (BaralieState) other;
