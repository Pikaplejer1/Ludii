...
/** Auto-generated State subclass for Boolik. */
public class BoolikState extends State {
    ...
    public BoolikState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BoolikState(final BoolikState other) {
        super(other);
    ...
    @Override public BoolikState copy() { return new BoolikState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoolikState o = (BoolikState) other;
