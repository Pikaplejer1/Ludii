...
/** Auto-generated State subclass for BruskyChess. */
public class BruskyChessState extends State {
    ...
    public BruskyChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BruskyChessState(final BruskyChessState other) {
        super(other);
    ...
    @Override public BruskyChessState copy() { return new BruskyChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BruskyChessState o = (BruskyChessState) other;
