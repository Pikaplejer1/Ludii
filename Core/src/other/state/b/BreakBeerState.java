...
/** Auto-generated State subclass for BreakBeer. */
public class BreakBeerState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BreakBeerState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BreakBeerState(final BreakBeerState other) {
        super(other);
    ...
    @Override public BreakBeerState copy() { return new BreakBeerState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BreakBeerState o = (BreakBeerState) other;
