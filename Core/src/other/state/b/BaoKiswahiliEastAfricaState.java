...
/** Auto-generated State subclass for BaoKiswahiliEastAfrica. */
public class BaoKiswahiliEastAfricaState extends State {
    ...
    public BaoKiswahiliEastAfricaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaoKiswahiliEastAfricaState(final BaoKiswahiliEastAfricaState other) {
        super(other);
    ...
    @Override public BaoKiswahiliEastAfricaState copy() { return new BaoKiswahiliEastAfricaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaoKiswahiliEastAfricaState o = (BaoKiswahiliEastAfricaState) other;
