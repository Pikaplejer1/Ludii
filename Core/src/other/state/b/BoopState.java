...
/** Auto-generated State subclass for Boop. */
public class BoopState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BoopState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BoopState(final BoopState other) {
        super(other);
    ...
    @Override public BoopState copy() { return new BoopState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoopState o = (BoopState) other;
