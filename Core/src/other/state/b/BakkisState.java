...
/** Auto-generated State subclass for Bakkis. */
public class BakkisState extends State {
    ...
    public BakkisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BakkisState(final BakkisState other) {
        super(other);
    ...
    @Override public BakkisState copy() { return new BakkisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BakkisState o = (BakkisState) other;
