...
/** Auto-generated State subclass for Breakback. */
public class BreakbackState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BreakbackState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BreakbackState(final BreakbackState other) {
        super(other);
    ...
    @Override public BreakbackState copy() { return new BreakbackState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BreakbackState o = (BreakbackState) other;
