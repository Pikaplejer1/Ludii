...
/** Auto-generated State subclass for Brood. */
public class BroodState extends State {
    ...
    public BroodState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BroodState(final BroodState other) {
        super(other);
    ...
    @Override public BroodState copy() { return new BroodState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BroodState o = (BroodState) other;
