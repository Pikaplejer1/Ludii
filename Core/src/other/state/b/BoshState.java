...
/** Auto-generated State subclass for Bosh. */
public class BoshState extends State {
    ...
    public BoshState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BoshState(final BoshState other) {
        super(other);
    ...
    @Override public BoshState copy() { return new BoshState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BoshState o = (BoshState) other;
