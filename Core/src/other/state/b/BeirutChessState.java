...
/** Auto-generated State subclass for BeirutChess. */
public class BeirutChessState extends State {
    ...
    public BeirutChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BeirutChessState(final BeirutChessState other) {
        super(other);
    ...
    @Override public BeirutChessState copy() { return new BeirutChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BeirutChessState o = (BeirutChessState) other;
