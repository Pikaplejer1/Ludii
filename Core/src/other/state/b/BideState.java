...
/** Auto-generated State subclass for Bide. */
public class BideState extends State {
    ...
    public BideState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BideState(final BideState other) {
        super(other);
    ...
    @Override public BideState copy() { return new BideState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BideState o = (BideState) other;
