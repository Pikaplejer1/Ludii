...
/** Auto-generated State subclass for BreakthroughCheckers. */
public class BreakthroughCheckersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BreakthroughCheckersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BreakthroughCheckersState(final BreakthroughCheckersState other) {
        super(other);
    ...
    @Override public BreakthroughCheckersState copy() { return new BreakthroughCheckersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BreakthroughCheckersState o = (BreakthroughCheckersState) other;
