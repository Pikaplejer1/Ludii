...
/** Auto-generated State subclass for Brandub. */
public class BrandubState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BrandubState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BrandubState(final BrandubState other) {
        super(other);
    ...
    @Override public BrandubState copy() { return new BrandubState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BrandubState o = (BrandubState) other;
