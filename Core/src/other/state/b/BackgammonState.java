...
public class BackgammonState extends State {
    ...
    public BackgammonState(final Game game, final StateConstructorLock lock) {
        ...
        super(game, lock);
        System.out.println(">>> v4 BackgammonState ctor done: currentDice@end=" + java.util.Arrays.deepToString(currentDice));
...
//        System.out.println(">>> CTOR DONE id=" + System.identityHashCode(this) 
//        + " currentDice=" + (currentDice == null ? "NULL" : "len=" + currentDice.length));
    ...
    @Override public int[][] currentDice() { 
        if (currentDice == null) {
            new Throwable("currentDice null in override").printStackTrace();
        }
        return currentDice; 
    }   
