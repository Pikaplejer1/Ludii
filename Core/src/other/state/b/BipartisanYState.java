...
/** Auto-generated State subclass for BipartisanY. */
public class BipartisanYState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public BipartisanYState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BipartisanYState(final BipartisanYState other) {
        super(other);
    ...
    @Override public BipartisanYState copy() { return new BipartisanYState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BipartisanYState o = (BipartisanYState) other;
