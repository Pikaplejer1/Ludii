...
/** Auto-generated State subclass for Battleships. */
public class BattleshipsState extends State {
    ...
    public BattleshipsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BattleshipsState(final BattleshipsState other) {
        super(other);
    ...
    @Override public BattleshipsState copy() { return new BattleshipsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BattleshipsState o = (BattleshipsState) other;
