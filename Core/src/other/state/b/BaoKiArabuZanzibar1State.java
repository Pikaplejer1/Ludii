...
/** Auto-generated State subclass for BaoKiArabuZanzibar1. */
public class BaoKiArabuZanzibar1State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public BaoKiArabuZanzibar1State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public BaoKiArabuZanzibar1State(final BaoKiArabuZanzibar1State other) {
        super(other);
    ...
    @Override public BaoKiArabuZanzibar1State copy() { return new BaoKiArabuZanzibar1State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BaoKiArabuZanzibar1State o = (BaoKiArabuZanzibar1State) other;
