...
/** Auto-generated State subclass for Barail. */
public class BarailState extends State {
    ...
    public BarailState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public BarailState(final BarailState other) {
        super(other);
    ...
    @Override public BarailState copy() { return new BarailState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final BarailState o = (BarailState) other;
