...
/** Auto-generated State subclass for ChengFangChengLong. */
public class ChengFangChengLongState extends State {
    ...
    public ChengFangChengLongState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChengFangChengLongState(final ChengFangChengLongState other) {
        super(other);
    ...
    @Override public ChengFangChengLongState copy() { return new ChengFangChengLongState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChengFangChengLongState o = (ChengFangChengLongState) other;
