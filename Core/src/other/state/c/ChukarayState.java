...
/** Auto-generated State subclass for Chukaray. */
public class ChukarayState extends State {
    ...
    public ChukarayState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ChukarayState(final ChukarayState other) {
        super(other);
    ...
    @Override public ChukarayState copy() { return new ChukarayState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChukarayState o = (ChukarayState) other;
