...
/** Auto-generated State subclass for Comina. */
public class CominaState extends State {
    ...
    public CominaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public CominaState(final CominaState other) {
        super(other);
    ...
    @Override public CominaState copy() { return new CominaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CominaState o = (CominaState) other;
