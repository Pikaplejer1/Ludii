...
/** Auto-generated State subclass for ChianaWaKunja. */
public class ChianaWaKunjaState extends State {
    ...
    public ChianaWaKunjaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChianaWaKunjaState(final ChianaWaKunjaState other) {
        super(other);
    ...
    @Override public ChianaWaKunjaState copy() { return new ChianaWaKunjaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChianaWaKunjaState o = (ChianaWaKunjaState) other;
