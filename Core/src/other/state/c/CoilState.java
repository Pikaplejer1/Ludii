...
/** Auto-generated State subclass for Coil. */
public class CoilState extends State {
    ...
    public CoilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public CoilState(final CoilState other) {
        super(other);
    ...
    @Override public CoilState copy() { return new CoilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CoilState o = (CoilState) other;
