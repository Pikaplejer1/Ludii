...
/** Auto-generated State subclass for Chuka. */
public class ChukaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public ChukaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChukaState(final ChukaState other) {
        super(other);
    ...
    @Override public ChukaState copy() { return new ChukaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChukaState o = (ChukaState) other;
