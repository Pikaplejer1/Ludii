...
/** Auto-generated State subclass for Callanish. */
public class CallanishState extends State {
    ...
    public CallanishState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CallanishState(final CallanishState other) {
        super(other);
    ...
    @Override public CallanishState copy() { return new CallanishState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CallanishState o = (CallanishState) other;
