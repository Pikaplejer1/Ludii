...
/** Auto-generated State subclass for Chaturanga14x14. */
public class Chaturanga14x14State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public Chaturanga14x14State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public Chaturanga14x14State(final Chaturanga14x14State other) {
        super(other);
    ...
    @Override public Chaturanga14x14State copy() { return new Chaturanga14x14State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final Chaturanga14x14State o = (Chaturanga14x14State) other;
