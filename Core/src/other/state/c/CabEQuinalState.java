...
/** Auto-generated State subclass for CabEQuinal. */
public class CabEQuinalState extends State {
    ...
    public CabEQuinalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public CabEQuinalState(final CabEQuinalState other) {
        super(other);
    ...
    @Override public CabEQuinalState copy() { return new CabEQuinalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CabEQuinalState o = (CabEQuinalState) other;
