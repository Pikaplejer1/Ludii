...
/** Auto-generated State subclass for Competitive2048. */
public class Competitive2048State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public Competitive2048State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public Competitive2048State(final Competitive2048State other) {
        super(other);
    ...
    @Override public Competitive2048State copy() { return new Competitive2048State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final Competitive2048State o = (Competitive2048State) other;
