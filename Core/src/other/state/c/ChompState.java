...
/** Auto-generated State subclass for Chomp. */
public class ChompState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChompState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChompState(final ChompState other) {
        super(other);
    ...
    @Override public ChompState copy() { return new ChompState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChompState o = (ChompState) other;
