...
/** Auto-generated State subclass for Conspirateurs. */
public class ConspirateursState extends State {

    private static final long serialVersionUID = 1L;

    private java.util.BitSet visited = new java.util.BitSet();

    public ConspirateursState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public ConspirateursState(final ConspirateursState other) {
        super(other);
        visited = (other.visited != null) ? (java.util.BitSet) other.visited.clone() : new java.util.BitSet();
    }

    @Override public ConspirateursState copy() { return new ConspirateursState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ConspirateursState o = (ConspirateursState) other;
