...
/** Auto-generated State subclass for ClaimJumpers. */
public class ClaimJumpersState extends State {
    ...
    public ClaimJumpersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ClaimJumpersState(final ClaimJumpersState other) {
        super(other);
    ...
    @Override public ClaimJumpersState copy() { return new ClaimJumpersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ClaimJumpersState o = (ClaimJumpersState) other;
