...
/** Auto-generated State subclass for CittabhramanrpasyaKhelanam. */
public class CittabhramanrpasyaKhelanamState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CittabhramanrpasyaKhelanamState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CittabhramanrpasyaKhelanamState(final CittabhramanrpasyaKhelanamState other) {
        super(other);
    ...
    @Override public CittabhramanrpasyaKhelanamState copy() { return new CittabhramanrpasyaKhelanamState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CittabhramanrpasyaKhelanamState o = (CittabhramanrpasyaKhelanamState) other;
