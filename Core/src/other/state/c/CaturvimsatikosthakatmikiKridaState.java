...
/** Auto-generated State subclass for CaturvimsatikosthakatmikiKrida. */
public class CaturvimsatikosthakatmikiKridaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CaturvimsatikosthakatmikiKridaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CaturvimsatikosthakatmikiKridaState(final CaturvimsatikosthakatmikiKridaState other) {
        super(other);
    ...
    @Override public CaturvimsatikosthakatmikiKridaState copy() { return new CaturvimsatikosthakatmikiKridaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CaturvimsatikosthakatmikiKridaState o = (CaturvimsatikosthakatmikiKridaState) other;
