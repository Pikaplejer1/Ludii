...
/** Auto-generated State subclass for Choko. */
public class ChokoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public ChokoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChokoState(final ChokoState other) {
        super(other);
    ...
    @Override public ChokoState copy() { return new ChokoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChokoState o = (ChokoState) other;
