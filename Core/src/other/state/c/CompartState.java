...
/** Auto-generated State subclass for Compart. */
public class CompartState extends State {
    ...
    public CompartState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CompartState(final CompartState other) {
        super(other);
    ...
    @Override public CompartState copy() { return new CompartState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CompartState o = (CompartState) other;
