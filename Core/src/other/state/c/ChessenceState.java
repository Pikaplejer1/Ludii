...
/** Auto-generated State subclass for Chessence. */
public class ChessenceState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChessenceState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChessenceState(final ChessenceState other) {
        super(other);
    ...
    @Override public ChessenceState copy() { return new ChessenceState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChessenceState o = (ChessenceState) other;
