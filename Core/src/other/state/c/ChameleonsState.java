...
/** Auto-generated State subclass for Chameleons. */
public class ChameleonsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChameleonsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChameleonsState(final ChameleonsState other) {
        super(other);
    ...
    @Override public ChameleonsState copy() { return new ChameleonsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChameleonsState o = (ChameleonsState) other;
