...
/** Auto-generated State subclass for CylinderChess. */
public class CylinderChessState extends State {
    ...
    public CylinderChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CylinderChessState(final CylinderChessState other) {
        super(other);
    ...
    @Override public CylinderChessState copy() { return new CylinderChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CylinderChessState o = (CylinderChessState) other;
