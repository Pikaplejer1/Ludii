...
/** Auto-generated State subclass for Cage. */
public class CageState extends State {
    ...
    public CageState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CageState(final CageState other) {
        super(other);
    ...
    @Override public CageState copy() { return new CageState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CageState o = (CageState) other;
