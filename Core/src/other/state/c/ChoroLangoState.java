...
/** Auto-generated State subclass for ChoroLango. */
public class ChoroLangoState extends State {
    ...
    public ChoroLangoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChoroLangoState(final ChoroLangoState other) {
        super(other);
    ...
    @Override public ChoroLangoState copy() { return new ChoroLangoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChoroLangoState o = (ChoroLangoState) other;
