...
/** Auto-generated State subclass for Chucka. */
public class ChuckaState extends State {
    ...
    public ChuckaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChuckaState(final ChuckaState other) {
        super(other);
    ...
    @Override public ChuckaState copy() { return new ChuckaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChuckaState o = (ChuckaState) other;
