...
/** Auto-generated State subclass for ChessSiberia. */
public class ChessSiberiaState extends State {
    ...
    public ChessSiberiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChessSiberiaState(final ChessSiberiaState other) {
        super(other);
    ...
    @Override public ChessSiberiaState copy() { return new ChessSiberiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChessSiberiaState o = (ChessSiberiaState) other;
