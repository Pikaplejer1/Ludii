...
/** Auto-generated State subclass for ChongSakhalin. */
public class ChongSakhalinState extends State {
    ...
    public ChongSakhalinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ChongSakhalinState(final ChongSakhalinState other) {
        super(other);
    ...
    @Override public ChongSakhalinState copy() { return new ChongSakhalinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChongSakhalinState o = (ChongSakhalinState) other;
