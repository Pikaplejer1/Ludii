...
/** Auto-generated State subclass for Clobber. */
public class ClobberState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ClobberState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ClobberState(final ClobberState other) {
        super(other);
    ...
    @Override public ClobberState copy() { return new ClobberState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ClobberState o = (ClobberState) other;
