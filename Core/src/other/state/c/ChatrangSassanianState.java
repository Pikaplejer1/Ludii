...
/** Auto-generated State subclass for ChatrangSassanian. */
public class ChatrangSassanianState extends State {
    ...
    public ChatrangSassanianState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ChatrangSassanianState(final ChatrangSassanianState other) {
        super(other);
    ...
    @Override public ChatrangSassanianState copy() { return new ChatrangSassanianState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChatrangSassanianState o = (ChatrangSassanianState) other;
