...
/** Auto-generated State subclass for ContrarePuff. */
public class ContrarePuffState extends State {
    ...
    public ContrarePuffState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ContrarePuffState(final ContrarePuffState other) {
        super(other);
    ...
    @Override public ContrarePuffState copy() { return new ContrarePuffState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ContrarePuffState o = (ContrarePuffState) other;
