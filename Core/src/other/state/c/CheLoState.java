...
/** Auto-generated State subclass for CheLo. */
public class CheLoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CheLoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CheLoState(final CheLoState other) {
        super(other);
    ...
    @Override public CheLoState copy() { return new CheLoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CheLoState o = (CheLoState) other;
