...
/** Auto-generated State subclass for Cannon. */
public class CannonState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CannonState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CannonState(final CannonState other) {
        super(other);
    ...
    @Override public CannonState copy() { return new CannonState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CannonState o = (CannonState) other;
