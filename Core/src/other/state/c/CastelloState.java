...
/** Auto-generated State subclass for Castello. */
public class CastelloState extends State {
    ...
    public CastelloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public CastelloState(final CastelloState other) {
        super(other);
    ...
    @Override public CastelloState copy() { return new CastelloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CastelloState o = (CastelloState) other;
