...
/** Auto-generated State subclass for Ceelkoqyuqkoqiji. */
public class CeelkoqyuqkoqijiState extends State {
    ...
    public CeelkoqyuqkoqijiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CeelkoqyuqkoqijiState(final CeelkoqyuqkoqijiState other) {
        super(other);
    ...
    @Override public CeelkoqyuqkoqijiState copy() { return new CeelkoqyuqkoqijiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CeelkoqyuqkoqijiState o = (CeelkoqyuqkoqijiState) other;
