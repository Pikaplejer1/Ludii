...
/** Auto-generated State subclass for ChainsOfThought. */
public class ChainsOfThoughtState extends State {
    ...
    public ChainsOfThoughtState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChainsOfThoughtState(final ChainsOfThoughtState other) {
        super(other);
    ...
    @Override public ChainsOfThoughtState copy() { return new ChainsOfThoughtState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChainsOfThoughtState o = (ChainsOfThoughtState) other;
