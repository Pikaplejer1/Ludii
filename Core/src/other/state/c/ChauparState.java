...
/** Auto-generated State subclass for Chaupar. */
public class ChauparState extends State {
    ...
    public ChauparState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ChauparState(final ChauparState other) {
        super(other);
    ...
    @Override public ChauparState copy() { return new ChauparState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChauparState o = (ChauparState) other;
