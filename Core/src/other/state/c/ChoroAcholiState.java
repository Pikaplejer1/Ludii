...
/** Auto-generated State subclass for ChoroAcholi. */
public class ChoroAcholiState extends State {
    ...
    public ChoroAcholiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChoroAcholiState(final ChoroAcholiState other) {
        super(other);
    ...
    @Override public ChoroAcholiState copy() { return new ChoroAcholiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChoroAcholiState o = (ChoroAcholiState) other;
