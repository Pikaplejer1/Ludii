...
/** Auto-generated State subclass for Chaturanga. */
public class ChaturangaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChaturangaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChaturangaState(final ChaturangaState other) {
        super(other);
    ...
    @Override public ChaturangaState copy() { return new ChaturangaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChaturangaState o = (ChaturangaState) other;
