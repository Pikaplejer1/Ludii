...
/** Auto-generated State subclass for Cumi. */
public class CumiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CumiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CumiState(final CumiState other) {
        super(other);
    ...
    @Override public CumiState copy() { return new CumiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CumiState o = (CumiState) other;
