...
/** Auto-generated State subclass for CustAndantino. */
public class CustAndantinoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CustAndantinoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CustAndantinoState(final CustAndantinoState other) {
        super(other);
    ...
    @Override public CustAndantinoState copy() { return new CustAndantinoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CustAndantinoState o = (CustAndantinoState) other;
