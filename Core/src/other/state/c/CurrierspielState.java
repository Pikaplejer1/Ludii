...
/** Auto-generated State subclass for Currierspiel. */
public class CurrierspielState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CurrierspielState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CurrierspielState(final CurrierspielState other) {
        super(other);
    ...
    @Override public CurrierspielState copy() { return new CurrierspielState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CurrierspielState o = (CurrierspielState) other;
