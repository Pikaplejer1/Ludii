...
/** Auto-generated State subclass for Catchup. */
public class CatchupState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public CatchupState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CatchupState(final CatchupState other) {
        super(other);
    ...
    @Override public CatchupState copy() { return new CatchupState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CatchupState o = (CatchupState) other;
