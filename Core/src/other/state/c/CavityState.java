...
/** Auto-generated State subclass for Cavity. */
public class CavityState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CavityState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CavityState(final CavityState other) {
        super(other);
    ...
    @Override public CavityState copy() { return new CavityState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CavityState o = (CavityState) other;
