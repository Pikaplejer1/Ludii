...
/** Auto-generated State subclass for ChallisGhutia. */
public class ChallisGhutiaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChallisGhutiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChallisGhutiaState(final ChallisGhutiaState other) {
        super(other);
    ...
    @Override public ChallisGhutiaState copy() { return new ChallisGhutiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChallisGhutiaState o = (ChallisGhutiaState) other;
