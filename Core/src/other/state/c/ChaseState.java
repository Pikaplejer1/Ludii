...
/** Auto-generated State subclass for Chase. */
public class ChaseState extends State {
    ...
    public ChaseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChaseState(final ChaseState other) {
        super(other);
    ...
    @Override public ChaseState copy() { return new ChaseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChaseState o = (ChaseState) other;
