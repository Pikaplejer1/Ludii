...
/** Auto-generated State subclass for ChaturangaAlAdli. */
public class ChaturangaAlAdliState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ChaturangaAlAdliState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChaturangaAlAdliState(final ChaturangaAlAdliState other) {
        super(other);
    ...
    @Override public ChaturangaAlAdliState copy() { return new ChaturangaAlAdliState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChaturangaAlAdliState o = (ChaturangaAlAdliState) other;
