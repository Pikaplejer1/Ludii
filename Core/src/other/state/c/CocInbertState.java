...
/** Auto-generated State subclass for CocInbert. */
public class CocInbertState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CocInbertState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CocInbertState(final CocInbertState other) {
        super(other);
    ...
    @Override public CocInbertState copy() { return new CocInbertState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CocInbertState o = (CocInbertState) other;
