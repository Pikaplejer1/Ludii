...
/** Auto-generated State subclass for CrossGeo. */
public class CrossGeoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CrossGeoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CrossGeoState(final CrossGeoState other) {
        super(other);
    ...
    @Override public CrossGeoState copy() { return new CrossGeoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CrossGeoState o = (CrossGeoState) other;
