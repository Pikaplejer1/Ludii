...
/** Auto-generated State subclass for Cascades. */
public class CascadesState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CascadesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CascadesState(final CascadesState other) {
        super(other);
    ...
    @Override public CascadesState copy() { return new CascadesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CascadesState o = (CascadesState) other;
