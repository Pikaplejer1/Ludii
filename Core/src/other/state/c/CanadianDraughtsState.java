...
/** Auto-generated State subclass for CanadianDraughts. */
public class CanadianDraughtsState extends State {
    ...
    public CanadianDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CanadianDraughtsState(final CanadianDraughtsState other) {
        super(other);
    ...
    @Override public CanadianDraughtsState copy() { return new CanadianDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CanadianDraughtsState o = (CanadianDraughtsState) other;
