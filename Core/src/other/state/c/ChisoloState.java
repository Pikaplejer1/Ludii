...
/** Auto-generated State subclass for Chisolo. */
public class ChisoloState extends State {
    ...
    public ChisoloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChisoloState(final ChisoloState other) {
        super(other);
    ...
    @Override public ChisoloState copy() { return new ChisoloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChisoloState o = (ChisoloState) other;
