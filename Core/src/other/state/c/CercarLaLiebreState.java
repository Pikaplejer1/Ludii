...
/** Auto-generated State subclass for CercarLaLiebre. */
public class CercarLaLiebreState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CercarLaLiebreState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CercarLaLiebreState(final CercarLaLiebreState other) {
        super(other);
    ...
    @Override public CercarLaLiebreState copy() { return new CercarLaLiebreState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CercarLaLiebreState o = (CercarLaLiebreState) other;
