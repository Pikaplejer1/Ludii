...
/** Auto-generated State subclass for Cumisitha. */
public class CumisithaState extends State {
    ...
    public CumisithaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public CumisithaState(final CumisithaState other) {
        super(other);
    ...
    @Override public CumisithaState copy() { return new CumisithaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CumisithaState o = (CumisithaState) other;
