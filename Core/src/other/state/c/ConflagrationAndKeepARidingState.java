...
/** Auto-generated State subclass for ConflagrationAndKeepARiding. */
public class ConflagrationAndKeepARidingState extends State {
    ...
    public ConflagrationAndKeepARidingState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ConflagrationAndKeepARidingState(final ConflagrationAndKeepARidingState other) {
        super(other);
    ...
    @Override public ConflagrationAndKeepARidingState copy() { return new ConflagrationAndKeepARidingState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ConflagrationAndKeepARidingState o = (ConflagrationAndKeepARidingState) other;
