...
/** Auto-generated State subclass for Crusade. */
public class CrusadeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public CrusadeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public CrusadeState(final CrusadeState other) {
        super(other);
    ...
    @Override public CrusadeState copy() { return new CrusadeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final CrusadeState o = (CrusadeState) other;
