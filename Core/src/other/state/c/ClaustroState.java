...
/** Auto-generated State subclass for Claustro. */
public class ClaustroState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ClaustroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ClaustroState(final ClaustroState other) {
        super(other);
    ...
    @Override public ClaustroState copy() { return new ClaustroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ClaustroState o = (ClaustroState) other;
