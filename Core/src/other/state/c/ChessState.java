...
/** Auto-generated State subclass for Chess. */
public class ChessState extends State {
    ...
    public ChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChessState(final ChessState other) {
        super(other);
    ...
    @Override public ChessState copy() { return new ChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChessState o = (ChessState) other;
