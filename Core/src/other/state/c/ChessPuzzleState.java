...
/** Auto-generated State subclass for ChessPuzzle. */
public class ChessPuzzleState extends State {
    ...
    public ChessPuzzleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ChessPuzzleState(final ChessPuzzleState other) {
        super(other);
    ...
    @Override public ChessPuzzleState copy() { return new ChessPuzzleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ChessPuzzleState o = (ChessPuzzleState) other;
