...
/** Auto-generated State subclass for ManipurCapturingGame. */
public class ManipurCapturingGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ManipurCapturingGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ManipurCapturingGameState(final ManipurCapturingGameState other) {
        super(other);
    ...
    @Override public ManipurCapturingGameState copy() { return new ManipurCapturingGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ManipurCapturingGameState o = (ManipurCapturingGameState) other;
