...
/** Auto-generated State subclass for MahbousehSubgame. */
public class MahbousehSubgameState extends State {
    ...
    public MahbousehSubgameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MahbousehSubgameState(final MahbousehSubgameState other) {
        super(other);
    ...
    @Override public MahbousehSubgameState copy() { return new MahbousehSubgameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MahbousehSubgameState o = (MahbousehSubgameState) other;
