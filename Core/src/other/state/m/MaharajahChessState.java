...
/** Auto-generated State subclass for MaharajahChess. */
public class MaharajahChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MaharajahChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MaharajahChessState(final MaharajahChessState other) {
        super(other);
    ...
    @Override public MaharajahChessState copy() { return new MaharajahChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MaharajahChessState o = (MaharajahChessState) other;
