...
/** Auto-generated State subclass for Malomjatek. */
public class MalomjatekState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MalomjatekState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MalomjatekState(final MalomjatekState other) {
        super(other);
    ...
    @Override public MalomjatekState copy() { return new MalomjatekState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MalomjatekState o = (MalomjatekState) other;
