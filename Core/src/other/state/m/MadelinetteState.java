...
/** Auto-generated State subclass for Madelinette. */
public class MadelinetteState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MadelinetteState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MadelinetteState(final MadelinetteState other) {
        super(other);
    ...
    @Override public MadelinetteState copy() { return new MadelinetteState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MadelinetteState o = (MadelinetteState) other;
