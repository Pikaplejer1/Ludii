...
/** Auto-generated State subclass for MughrabiehSubgame. */
public class MughrabiehSubgameState extends State {
    ...
    public MughrabiehSubgameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MughrabiehSubgameState(final MughrabiehSubgameState other) {
        super(other);
    ...
    @Override public MughrabiehSubgameState copy() { return new MughrabiehSubgameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MughrabiehSubgameState o = (MughrabiehSubgameState) other;
