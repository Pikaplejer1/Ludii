...
/** Auto-generated State subclass for MerimuengRimuengDo. */
public class MerimuengRimuengDoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MerimuengRimuengDoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MerimuengRimuengDoState(final MerimuengRimuengDoState other) {
        super(other);
    ...
    @Override public MerimuengRimuengDoState copy() { return new MerimuengRimuengDoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MerimuengRimuengDoState o = (MerimuengRimuengDoState) other;
