...
/** Auto-generated State subclass for MisoroTsoroAdditionalCapture. */
public class MisoroTsoroAdditionalCaptureState extends State {
    ...
    public MisoroTsoroAdditionalCaptureState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MisoroTsoroAdditionalCaptureState(final MisoroTsoroAdditionalCaptureState other) {
        super(other);
    ...
    @Override public MisoroTsoroAdditionalCaptureState copy() { return new MisoroTsoroAdditionalCaptureState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MisoroTsoroAdditionalCaptureState o = (MisoroTsoroAdditionalCaptureState) other;
