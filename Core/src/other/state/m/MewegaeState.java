...
/** Auto-generated State subclass for Mewegae. */
public class MewegaeState extends State {
    ...
    public MewegaeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MewegaeState(final MewegaeState other) {
        super(other);
    ...
    @Override public MewegaeState copy() { return new MewegaeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MewegaeState o = (MewegaeState) other;
