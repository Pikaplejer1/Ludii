...
/** Auto-generated State subclass for Mewelad. */
public class MeweladState extends State {
    ...
    public MeweladState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MeweladState(final MeweladState other) {
        super(other);
    ...
    @Override public MeweladState copy() { return new MeweladState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MeweladState o = (MeweladState) other;
