...
/** Auto-generated State subclass for MainChongkak. */
public class MainChongkakState extends State {
    ...
    public MainChongkakState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MainChongkakState(final MainChongkakState other) {
        super(other);
    ...
    @Override public MainChongkakState copy() { return new MainChongkakState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MainChongkakState o = (MainChongkakState) other;
