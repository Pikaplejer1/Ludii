...
/** Auto-generated State subclass for MurusGallicus. */
public class MurusGallicusState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MurusGallicusState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MurusGallicusState(final MurusGallicusState other) {
        super(other);
    ...
    @Override public MurusGallicusState copy() { return new MurusGallicusState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MurusGallicusState o = (MurusGallicusState) other;
