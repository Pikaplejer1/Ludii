...
/** Auto-generated State subclass for MisoroTsoro. */
public class MisoroTsoroState extends State {
    ...
    public MisoroTsoroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MisoroTsoroState(final MisoroTsoroState other) {
        super(other);
    ...
    @Override public MisoroTsoroState copy() { return new MisoroTsoroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MisoroTsoroState o = (MisoroTsoroState) other;
