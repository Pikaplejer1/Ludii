...
/** Auto-generated State subclass for Msuwa. */
public class MsuwaState extends State {
    ...
    public MsuwaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MsuwaState(final MsuwaState other) {
        super(other);
    ...
    @Override public MsuwaState copy() { return new MsuwaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MsuwaState o = (MsuwaState) other;
