...
/** Auto-generated State subclass for Mwendo. */
public class MwendoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MwendoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MwendoState(final MwendoState other) {
        super(other);
    ...
    @Override public MwendoState copy() { return new MwendoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MwendoState o = (MwendoState) other;
