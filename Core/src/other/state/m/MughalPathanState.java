...
/** Auto-generated State subclass for MughalPathan. */
public class MughalPathanState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MughalPathanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MughalPathanState(final MughalPathanState other) {
        super(other);
    ...
    @Override public MughalPathanState copy() { return new MughalPathanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MughalPathanState o = (MughalPathanState) other;
