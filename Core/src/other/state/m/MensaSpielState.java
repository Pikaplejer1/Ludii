...
/** Auto-generated State subclass for MensaSpiel. */
public class MensaSpielState extends State {
    ...
    public MensaSpielState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MensaSpielState(final MensaSpielState other) {
        super(other);
    ...
    @Override public MensaSpielState copy() { return new MensaSpielState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MensaSpielState o = (MensaSpielState) other;
