...
/** Auto-generated State subclass for MogulPuttHan. */
public class MogulPuttHanState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MogulPuttHanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MogulPuttHanState(final MogulPuttHanState other) {
        super(other);
    ...
    @Override public MogulPuttHanState copy() { return new MogulPuttHanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MogulPuttHanState o = (MogulPuttHanState) other;
