...
/** Auto-generated State subclass for MawkarKatiya. */
public class MawkarKatiyaState extends State {
    ...
    public MawkarKatiyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MawkarKatiyaState(final MawkarKatiyaState other) {
        super(other);
    ...
    @Override public MawkarKatiyaState copy() { return new MawkarKatiyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MawkarKatiyaState o = (MawkarKatiyaState) other;
