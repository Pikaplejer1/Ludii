...
/** Auto-generated State subclass for Mbelele. */
public class MbeleleState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public MbeleleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MbeleleState(final MbeleleState other) {
        super(other);
    ...
    @Override public MbeleleState copy() { return new MbeleleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MbeleleState o = (MbeleleState) other;
