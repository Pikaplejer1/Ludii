...
/** Auto-generated State subclass for MainChator. */
public class MainChatorState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public MainChatorState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MainChatorState(final MainChatorState other) {
        super(other);
    ...
    @Override public MainChatorState copy() { return new MainChatorState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MainChatorState o = (MainChatorState) other;
