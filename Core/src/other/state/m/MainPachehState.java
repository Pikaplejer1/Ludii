...
/** Auto-generated State subclass for MainPacheh. */
public class MainPachehState extends State {
    ...
    public MainPachehState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MainPachehState(final MainPachehState other) {
        super(other);
    ...
    @Override public MainPachehState copy() { return new MainPachehState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MainPachehState o = (MainPachehState) other;
