...
/** Auto-generated State subclass for Makonn. */
public class MakonnState extends State {
    ...
    public MakonnState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MakonnState(final MakonnState other) {
        super(other);
    ...
    @Override public MakonnState copy() { return new MakonnState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MakonnState o = (MakonnState) other;
