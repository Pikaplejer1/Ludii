...
/** Auto-generated State subclass for MusoroTsoro. */
public class MusoroTsoroState extends State {
    ...
    public MusoroTsoroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MusoroTsoroState(final MusoroTsoroState other) {
        super(other);
    ...
    @Override public MusoroTsoroState copy() { return new MusoroTsoroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MusoroTsoroState o = (MusoroTsoroState) other;
