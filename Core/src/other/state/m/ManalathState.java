...
/** Auto-generated State subclass for Manalath. */
public class ManalathState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public ManalathState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ManalathState(final ManalathState other) {
        super(other);
    ...
    @Override public ManalathState copy() { return new ManalathState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ManalathState o = (ManalathState) other;
