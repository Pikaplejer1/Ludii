...
/** Auto-generated State subclass for Myles. */
public class MylesState extends State {
    ...
    public MylesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MylesState(final MylesState other) {
        super(other);
    ...
    @Override public MylesState copy() { return new MylesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MylesState o = (MylesState) other;
