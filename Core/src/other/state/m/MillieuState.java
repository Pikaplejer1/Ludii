...
/** Auto-generated State subclass for Millieu. */
public class MillieuState extends State {
    ...
    public MillieuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MillieuState(final MillieuState other) {
        super(other);
    ...
    @Override public MillieuState copy() { return new MillieuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MillieuState o = (MillieuState) other;
