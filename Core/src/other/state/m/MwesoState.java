...
/** Auto-generated State subclass for Mweso. */
public class MwesoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public MwesoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MwesoState(final MwesoState other) {
        super(other);
    ...
    @Override public MwesoState copy() { return new MwesoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MwesoState o = (MwesoState) other;
