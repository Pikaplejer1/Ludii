...
/** Auto-generated State subclass for Mangola. */
public class MangolaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public MangolaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MangolaState(final MangolaState other) {
        super(other);
    ...
    @Override public MangolaState copy() { return new MangolaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MangolaState o = (MangolaState) other;
