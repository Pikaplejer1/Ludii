...
/** Auto-generated State subclass for Mefuvha. */
public class MefuvhaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public MefuvhaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MefuvhaState(final MefuvhaState other) {
        super(other);
    ...
    @Override public MefuvhaState copy() { return new MefuvhaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MefuvhaState o = (MefuvhaState) other;
