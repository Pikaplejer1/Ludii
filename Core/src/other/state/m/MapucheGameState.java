...
/** Auto-generated State subclass for MapucheGame. */
public class MapucheGameState extends State {
    ...
    public MapucheGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MapucheGameState(final MapucheGameState other) {
        super(other);
    ...
    @Override public MapucheGameState copy() { return new MapucheGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MapucheGameState o = (MapucheGameState) other;
