...
/** Auto-generated State subclass for Motiq. */
public class MotiqState extends State {
    ...
    public MotiqState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MotiqState(final MotiqState other) {
        super(other);
    ...
    @Override public MotiqState copy() { return new MotiqState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MotiqState o = (MotiqState) other;
