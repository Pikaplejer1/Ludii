...
/** Auto-generated State subclass for McCooeyChess. */
public class McCooeyChessState extends State {
    ...
    public McCooeyChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public McCooeyChessState(final McCooeyChessState other) {
        super(other);
    ...
    @Override public McCooeyChessState copy() { return new McCooeyChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final McCooeyChessState o = (McCooeyChessState) other;
