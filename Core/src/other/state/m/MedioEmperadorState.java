...
/** Auto-generated State subclass for MedioEmperador. */
public class MedioEmperadorState extends State {
    ...
    public MedioEmperadorState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MedioEmperadorState(final MedioEmperadorState other) {
        super(other);
    ...
    @Override public MedioEmperadorState copy() { return new MedioEmperadorState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MedioEmperadorState o = (MedioEmperadorState) other;
