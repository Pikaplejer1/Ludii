...
/** Auto-generated State subclass for MangalaBedouin. */
public class MangalaBedouinState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MangalaBedouinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MangalaBedouinState(final MangalaBedouinState other) {
        super(other);
    ...
    @Override public MangalaBedouinState copy() { return new MangalaBedouinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MangalaBedouinState o = (MangalaBedouinState) other;
