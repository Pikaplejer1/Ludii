...
/** Auto-generated State subclass for MedievalChess. */
public class MedievalChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MedievalChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MedievalChessState(final MedievalChessState other) {
        super(other);
    ...
    @Override public MedievalChessState copy() { return new MedievalChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MedievalChessState o = (MedievalChessState) other;
