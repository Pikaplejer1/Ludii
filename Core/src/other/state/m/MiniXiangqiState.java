...
/** Auto-generated State subclass for MiniXiangqi. */
public class MiniXiangqiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MiniXiangqiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MiniXiangqiState(final MiniXiangqiState other) {
        super(other);
    ...
    @Override public MiniXiangqiState copy() { return new MiniXiangqiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MiniXiangqiState o = (MiniXiangqiState) other;
