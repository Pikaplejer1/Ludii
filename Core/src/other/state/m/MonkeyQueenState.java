...
/** Auto-generated State subclass for MonkeyQueen. */
public class MonkeyQueenState extends State {
    ...
    public MonkeyQueenState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MonkeyQueenState(final MonkeyQueenState other) {
        super(other);
    ...
    @Override public MonkeyQueenState copy() { return new MonkeyQueenState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MonkeyQueenState o = (MonkeyQueenState) other;
