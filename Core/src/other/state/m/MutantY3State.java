...
/** Auto-generated State subclass for MutantY3. */
public class MutantY3State extends State {
    ...
    public MutantY3State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MutantY3State(final MutantY3State other) {
        super(other);
    ...
    @Override public MutantY3State copy() { return new MutantY3State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MutantY3State o = (MutantY3State) other;
