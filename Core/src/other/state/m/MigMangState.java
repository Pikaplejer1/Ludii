...
/** Auto-generated State subclass for MigMang. */
public class MigMangState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MigMangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MigMangState(final MigMangState other) {
        super(other);
    ...
    @Override public MigMangState copy() { return new MigMangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MigMangState o = (MigMangState) other;
