...
/** Auto-generated State subclass for Momentum. */
public class MomentumState extends State {
    ...
    public MomentumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public MomentumState(final MomentumState other) {
        super(other);
    ...
    @Override public MomentumState copy() { return new MomentumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MomentumState o = (MomentumState) other;
