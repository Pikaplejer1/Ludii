...
/** Auto-generated State subclass for Mehen. */
public class MehenState extends State {
    ...
    public MehenState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public MehenState(final MehenState other) {
        super(other);
    ...
    @Override public MehenState copy() { return new MehenState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MehenState o = (MehenState) other;
