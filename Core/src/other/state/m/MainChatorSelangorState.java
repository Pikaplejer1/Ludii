...
/** Auto-generated State subclass for MainChatorSelangor. */
public class MainChatorSelangorState extends State {
    ...
    public MainChatorSelangorState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MainChatorSelangorState(final MainChatorSelangorState other) {
        super(other);
    ...
    @Override public MainChatorSelangorState copy() { return new MainChatorSelangorState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MainChatorSelangorState o = (MainChatorSelangorState) other;
