...
/** Auto-generated State subclass for MysoreTigerGame. */
public class MysoreTigerGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MysoreTigerGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MysoreTigerGameState(final MysoreTigerGameState other) {
        super(other);
    ...
    @Override public MysoreTigerGameState copy() { return new MysoreTigerGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MysoreTigerGameState o = (MysoreTigerGameState) other;
