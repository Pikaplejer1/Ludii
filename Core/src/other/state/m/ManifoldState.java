...
/** Auto-generated State subclass for Manifold. */
public class ManifoldState extends State {
    ...
    public ManifoldState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ManifoldState(final ManifoldState other) {
        super(other);
    ...
    @Override public ManifoldState copy() { return new ManifoldState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ManifoldState o = (ManifoldState) other;
