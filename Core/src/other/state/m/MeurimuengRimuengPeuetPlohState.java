...
/** Auto-generated State subclass for MeurimuengRimuengPeuetPloh. */
public class MeurimuengRimuengPeuetPlohState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MeurimuengRimuengPeuetPlohState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MeurimuengRimuengPeuetPlohState(final MeurimuengRimuengPeuetPlohState other) {
        super(other);
    ...
    @Override public MeurimuengRimuengPeuetPlohState copy() { return new MeurimuengRimuengPeuetPlohState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MeurimuengRimuengPeuetPlohState o = (MeurimuengRimuengPeuetPlohState) other;
