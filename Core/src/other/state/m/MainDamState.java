...
/** Auto-generated State subclass for MainDam. */
public class MainDamState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MainDamState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MainDamState(final MainDamState other) {
        super(other);
    ...
    @Override public MainDamState copy() { return new MainDamState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MainDamState o = (MainDamState) other;
