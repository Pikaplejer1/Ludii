...
/** Auto-generated State subclass for Macheng. */
public class MachengState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MachengState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MachengState(final MachengState other) {
        super(other);
    ...
    @Override public MachengState copy() { return new MachengState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MachengState o = (MachengState) other;
