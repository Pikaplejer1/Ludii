...
/** Auto-generated State subclass for Minesweeper. */
public class MinesweeperState extends State {
    ...
    public MinesweeperState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MinesweeperState(final MinesweeperState other) {
        super(other);
    ...
    @Override public MinesweeperState copy() { return new MinesweeperState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MinesweeperState o = (MinesweeperState) other;
