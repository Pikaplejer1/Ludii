...
/** Auto-generated State subclass for Makvoer. */
public class MakvoerState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MakvoerState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MakvoerState(final MakvoerState other) {
        super(other);
    ...
    @Override public MakvoerState copy() { return new MakvoerState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MakvoerState o = (MakvoerState) other;
