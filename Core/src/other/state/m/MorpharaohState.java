...
/** Auto-generated State subclass for Morpharaoh. */
public class MorpharaohState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MorpharaohState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MorpharaohState(final MorpharaohState other) {
        super(other);
    ...
    @Override public MorpharaohState copy() { return new MorpharaohState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MorpharaohState o = (MorpharaohState) other;
