...
/** Auto-generated State subclass for Musinaykahwhanmetowaywin. */
public class MusinaykahwhanmetowaywinState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MusinaykahwhanmetowaywinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MusinaykahwhanmetowaywinState(final MusinaykahwhanmetowaywinState other) {
        super(other);
    ...
    @Override public MusinaykahwhanmetowaywinState copy() { return new MusinaykahwhanmetowaywinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MusinaykahwhanmetowaywinState o = (MusinaykahwhanmetowaywinState) other;
