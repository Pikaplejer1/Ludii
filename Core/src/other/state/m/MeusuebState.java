...
/** Auto-generated State subclass for Meusueb. */
public class MeusuebState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public MeusuebState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MeusuebState(final MeusuebState other) {
        super(other);
    ...
    @Override public MeusuebState copy() { return new MeusuebState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MeusuebState o = (MeusuebState) other;
