...
/** Auto-generated State subclass for Meridians. */
public class MeridiansState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MeridiansState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MeridiansState(final MeridiansState other) {
        super(other);
    ...
    @Override public MeridiansState copy() { return new MeridiansState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MeridiansState o = (MeridiansState) other;
