...
/** Auto-generated State subclass for MsuwaWaKunja. */
public class MsuwaWaKunjaState extends State {
    ...
    public MsuwaWaKunjaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MsuwaWaKunjaState(final MsuwaWaKunjaState other) {
        super(other);
    ...
    @Override public MsuwaWaKunjaState copy() { return new MsuwaWaKunjaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MsuwaWaKunjaState o = (MsuwaWaKunjaState) other;
