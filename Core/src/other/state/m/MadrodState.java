...
/** Auto-generated State subclass for Madrod. */
public class MadrodState extends State {
    ...
    public MadrodState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MadrodState(final MadrodState other) {
        super(other);
    ...
    @Override public MadrodState copy() { return new MadrodState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MadrodState o = (MadrodState) other;
