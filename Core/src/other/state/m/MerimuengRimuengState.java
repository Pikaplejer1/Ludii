...
/** Auto-generated State subclass for MerimuengRimueng. */
public class MerimuengRimuengState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MerimuengRimuengState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MerimuengRimuengState(final MerimuengRimuengState other) {
        super(other);
    ...
    @Override public MerimuengRimuengState copy() { return new MerimuengRimuengState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MerimuengRimuengState o = (MerimuengRimuengState) other;
