...
/** Auto-generated State subclass for MangalaSuez. */
public class MangalaSuezState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public MangalaSuezState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MangalaSuezState(final MangalaSuezState other) {
        super(other);
    ...
    @Override public MangalaSuezState copy() { return new MangalaSuezState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MangalaSuezState o = (MangalaSuezState) other;
