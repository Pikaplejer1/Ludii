...
/** Auto-generated State subclass for Moo. */
public class MooState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MooState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MooState(final MooState other) {
        super(other);
    ...
    @Override public MooState copy() { return new MooState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MooState o = (MooState) other;
