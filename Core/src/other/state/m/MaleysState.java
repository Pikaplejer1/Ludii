...
/** Auto-generated State subclass for Maleys. */
public class MaleysState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public MaleysState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public MaleysState(final MaleysState other) {
        super(other);
    ...
    @Override public MaleysState copy() { return new MaleysState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final MaleysState o = (MaleysState) other;
