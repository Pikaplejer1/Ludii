...
/** Auto-generated State subclass for Jimafesosh. */
public class JimafesoshState extends State {
    ...
    public JimafesoshState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JimafesoshState(final JimafesoshState other) {
        super(other);
    ...
    @Override public JimafesoshState copy() { return new JimafesoshState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JimafesoshState o = (JimafesoshState) other;
