...
/** Auto-generated State subclass for Jungle. */
public class JungleState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public JungleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JungleState(final JungleState other) {
        super(other);
    ...
    @Override public JungleState copy() { return new JungleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JungleState o = (JungleState) other;
