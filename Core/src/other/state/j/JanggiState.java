...
/** Auto-generated State subclass for Janggi. */
public class JanggiState extends State {
    ...
    public JanggiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JanggiState(final JanggiState other) {
        super(other);
    ...
    @Override public JanggiState copy() { return new JanggiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JanggiState o = (JanggiState) other;
