...
/** Auto-generated State subclass for JaJeonGeoGonu. */
public class JaJeonGeoGonuState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public JaJeonGeoGonuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JaJeonGeoGonuState(final JaJeonGeoGonuState other) {
        super(other);
    ...
    @Override public JaJeonGeoGonuState copy() { return new JaJeonGeoGonuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JaJeonGeoGonuState o = (JaJeonGeoGonuState) other;
