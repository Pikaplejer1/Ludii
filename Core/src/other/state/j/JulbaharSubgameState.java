...
/** Auto-generated State subclass for JulbaharSubgame. */
public class JulbaharSubgameState extends State {
    ...
    public JulbaharSubgameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public JulbaharSubgameState(final JulbaharSubgameState other) {
        super(other);
    ...
    @Override public JulbaharSubgameState copy() { return new JulbaharSubgameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JulbaharSubgameState o = (JulbaharSubgameState) other;
