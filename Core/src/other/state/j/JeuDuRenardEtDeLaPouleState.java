...
/** Auto-generated State subclass for JeuDuRenardEtDeLaPoule. */
public class JeuDuRenardEtDeLaPouleState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public JeuDuRenardEtDeLaPouleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JeuDuRenardEtDeLaPouleState(final JeuDuRenardEtDeLaPouleState other) {
        super(other);
    ...
    @Override public JeuDuRenardEtDeLaPouleState copy() { return new JeuDuRenardEtDeLaPouleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JeuDuRenardEtDeLaPouleState o = (JeuDuRenardEtDeLaPouleState) other;
