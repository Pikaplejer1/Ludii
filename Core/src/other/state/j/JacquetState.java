...
/** Auto-generated State subclass for Jacquet. */
public class JacquetState extends State {
    ...
    public JacquetState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public JacquetState(final JacquetState other) {
        super(other);
    ...
    @Override public JacquetState copy() { return new JacquetState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JacquetState o = (JacquetState) other;
