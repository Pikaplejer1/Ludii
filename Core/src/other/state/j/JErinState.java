...
/** Auto-generated State subclass for JErin. */
public class JErinState extends State {
    ...
    public JErinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JErinState(final JErinState other) {
        super(other);
    ...
    @Override public JErinState copy() { return new JErinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JErinState o = (JErinState) other;
