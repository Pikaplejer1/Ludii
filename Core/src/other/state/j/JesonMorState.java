...
/** Auto-generated State subclass for JesonMor. */
public class JesonMorState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public JesonMorState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JesonMorState(final JesonMorState other) {
        super(other);
    ...
    @Override public JesonMorState copy() { return new JesonMorState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JesonMorState o = (JesonMorState) other;
