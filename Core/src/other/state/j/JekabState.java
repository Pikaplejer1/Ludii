...
/** Auto-generated State subclass for Jekab. */
public class JekabState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public JekabState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public JekabState(final JekabState other) {
        super(other);
    ...
    @Override public JekabState copy() { return new JekabState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final JekabState o = (JekabState) other;
