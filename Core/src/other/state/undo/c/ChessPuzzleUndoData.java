...
/** Auto-generated UndoData subclass for ChessPuzzle. Prunable fields: pendingValues, sitesToRemove. */
public final class ChessPuzzleUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ChessPuzzleUndoData(final Context context, final int active, final int[] phases) {
