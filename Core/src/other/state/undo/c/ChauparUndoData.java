...
/** Auto-generated UndoData subclass for Chaupar. Prunable fields: onTrackIndices. */
public final class ChauparUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public ChauparUndoData(final Context context, final int active, final int[] phases) {
