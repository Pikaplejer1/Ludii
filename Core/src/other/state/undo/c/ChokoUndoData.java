...
/** Auto-generated UndoData subclass for Choko. Prunable fields: pendingValues. */
public final class ChokoUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public ChokoUndoData(final Context context, final int active, final int[] phases) {
