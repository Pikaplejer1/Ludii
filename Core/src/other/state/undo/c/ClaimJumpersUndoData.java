...
/** Auto-generated UndoData subclass for ClaimJumpers. Prunable fields: pendingValues, sitesToRemove. */
public final class ClaimJumpersUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ClaimJumpersUndoData(final Context context, final int active, final int[] phases) {
