...
/** Auto-generated UndoData subclass for Chuka. Prunable fields: pendingValues. */
public final class ChukaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public ChukaUndoData(final Context context, final int active, final int[] phases) {
