...
/** Auto-generated UndoData subclass for CylinderChess. Prunable fields: pendingValues, sitesToRemove. */
public final class CylinderChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public CylinderChessUndoData(final Context context, final int active, final int[] phases) {
