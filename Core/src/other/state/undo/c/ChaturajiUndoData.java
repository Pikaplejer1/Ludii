...
/** Auto-generated UndoData subclass for Chaturaji. Prunable fields: pendingValues, sitesToRemove. */
public final class ChaturajiUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ChaturajiUndoData(final Context context, final int active, final int[] phases) {
