...
/** Auto-generated UndoData subclass for Korkserschach. Prunable fields: pendingValues, sitesToRemove. */
public final class KorkserschachUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public KorkserschachUndoData(final Context context, final int active, final int[] phases) {
