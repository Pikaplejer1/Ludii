...
/** Auto-generated UndoData subclass for Kassle. Prunable fields: pendingValues, sitesToRemove. */
public final class KassleUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public KassleUndoData(final Context context, final int active, final int[] phases) {
