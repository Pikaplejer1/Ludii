...
/** Auto-generated UndoData subclass for KriegspielChess. Prunable fields: pendingValues, sitesToRemove. */
public final class KriegspielChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public KriegspielChessUndoData(final Context context, final int active, final int[] phases) {
