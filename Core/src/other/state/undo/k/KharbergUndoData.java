...
/** Auto-generated UndoData subclass for Kharberg. Prunable fields: pendingValues, sitesToRemove. */
public final class KharbergUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public KharbergUndoData(final Context context, final int active, final int[] phases) {
