...
/** Auto-generated UndoData subclass for KatroBevohoka. Prunable fields: pendingValues. */
public final class KatroBevohokaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public KatroBevohokaUndoData(final Context context, final int active, final int[] phases) {
