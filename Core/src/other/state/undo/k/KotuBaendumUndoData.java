...
/** Auto-generated UndoData subclass for KotuBaendum. Prunable fields: pendingValues. */
public final class KotuBaendumUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public KotuBaendumUndoData(final Context context, final int active, final int[] phases) {
