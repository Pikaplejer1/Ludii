...
/** Auto-generated UndoData subclass for Kensington. Prunable fields: pendingValues. */
public final class KensingtonUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public KensingtonUndoData(final Context context, final int active, final int[] phases) {
