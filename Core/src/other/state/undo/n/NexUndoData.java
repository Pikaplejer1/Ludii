...
/** Auto-generated UndoData subclass for Nex. Prunable fields: pendingValues, sitesToRemove. */
public final class NexUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public NexUndoData(final Context context, final int active, final int[] phases) {
