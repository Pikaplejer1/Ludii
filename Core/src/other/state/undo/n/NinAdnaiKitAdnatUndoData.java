...
/** Auto-generated UndoData subclass for NinAdnaiKitAdnat. Prunable fields: pendingValues, sitesToRemove. */
public final class NinAdnaiKitAdnatUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public NinAdnaiKitAdnatUndoData(final Context context, final int active, final int[] phases) {
