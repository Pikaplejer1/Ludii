...
/** Auto-generated UndoData subclass for GabataWuqro. Prunable fields: pendingValues. */
public final class GabataWuqroUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public GabataWuqroUndoData(final Context context, final int active, final int[] phases) {
