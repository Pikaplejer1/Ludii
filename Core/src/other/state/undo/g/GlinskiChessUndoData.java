...
/** Auto-generated UndoData subclass for GlinskiChess. Prunable fields: pendingValues, sitesToRemove. */
public final class GlinskiChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public GlinskiChessUndoData(final Context context, final int active, final int[] phases) {
