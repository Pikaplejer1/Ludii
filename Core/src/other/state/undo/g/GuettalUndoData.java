...
/** Auto-generated UndoData subclass for Guettal. Prunable fields: pendingValues, sitesToRemove. */
public final class GuettalUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public GuettalUndoData(final Context context, final int active, final int[] phases) {
