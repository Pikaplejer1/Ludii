...
/** Auto-generated UndoData subclass for Galatjang. Prunable fields: pendingValues. */
public final class GalatjangUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public GalatjangUndoData(final Context context, final int active, final int[] phases) {
