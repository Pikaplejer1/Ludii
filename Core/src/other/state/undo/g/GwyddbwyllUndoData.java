...
/** Auto-generated UndoData subclass for Gwyddbwyll. Prunable fields: pendingValues, sitesToRemove. */
public final class GwyddbwyllUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public GwyddbwyllUndoData(final Context context, final int active, final int[] phases) {
