...
/** Auto-generated UndoData subclass for GabataShoaAndAdegrat. Prunable fields: pendingValues. */
public final class GabataShoaAndAdegratUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public GabataShoaAndAdegratUndoData(final Context context, final int active, final int[] phases) {
