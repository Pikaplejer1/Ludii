...
/** Auto-generated UndoData subclass for Vela. Prunable fields: visited, sitesToRemove. */
public final class VelaUndoData extends UndoData {

    private final java.util.BitSet visited;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public VelaUndoData(final Context context, final int active, final int[] phases) {
