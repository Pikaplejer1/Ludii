...
/** Auto-generated UndoData subclass for McCooeyChess. Prunable fields: pendingValues, sitesToRemove. */
public final class McCooeyChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public McCooeyChessUndoData(final Context context, final int active, final int[] phases) {
