...
/** Auto-generated UndoData subclass for MainChatorSelangor. Prunable fields: pendingValues, sitesToRemove. */
public final class MainChatorSelangorUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public MainChatorSelangorUndoData(final Context context, final int active, final int[] phases) {
