...
/** Auto-generated UndoData subclass for Mewegae. Prunable fields: pendingValues. */
public final class MewegaeUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public MewegaeUndoData(final Context context, final int active, final int[] phases) {
