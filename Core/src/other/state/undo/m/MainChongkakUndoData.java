...
/** Auto-generated UndoData subclass for MainChongkak. Prunable fields: pendingValues. */
public final class MainChongkakUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public MainChongkakUndoData(final Context context, final int active, final int[] phases) {
