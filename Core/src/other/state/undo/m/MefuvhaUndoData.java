...
/** Auto-generated UndoData subclass for Mefuvha. Prunable fields: pendingValues. */
public final class MefuvhaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public MefuvhaUndoData(final Context context, final int active, final int[] phases) {
