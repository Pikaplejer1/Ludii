...
/** Auto-generated UndoData subclass for Millieu. Prunable fields: pendingValues, sitesToRemove. */
public final class MillieuUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public MillieuUndoData(final Context context, final int active, final int[] phases) {
