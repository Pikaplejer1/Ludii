...
/** Auto-generated UndoData subclass for BruskyChess. Prunable fields: pendingValues, sitesToRemove. */
public final class BruskyChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public BruskyChessUndoData(final Context context, final int active, final int[] phases) {
