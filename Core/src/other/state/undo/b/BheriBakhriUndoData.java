...
/** Auto-generated UndoData subclass for BheriBakhri. Prunable fields: onTrackIndices, sitesToRemove. */
public final class BheriBakhriUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public BheriBakhriUndoData(final Context context, final int active, final int[] phases) {
