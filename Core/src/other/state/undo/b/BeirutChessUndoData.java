...
/** Auto-generated UndoData subclass for BeirutChess. Prunable fields: pendingValues, sitesToRemove. */
public final class BeirutChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public BeirutChessUndoData(final Context context, final int active, final int[] phases) {
