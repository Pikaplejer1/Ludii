...
/** Auto-generated UndoData subclass for Salta. Prunable fields: visited, sitesToRemove. */
public final class SaltaUndoData extends UndoData {

    private final java.util.BitSet visited;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SaltaUndoData(final Context context, final int active, final int[] phases) {
