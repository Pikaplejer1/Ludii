...
/** Auto-generated UndoData subclass for SocialDistanceChess. Prunable fields: pendingValues, sitesToRemove. */
public final class SocialDistanceChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SocialDistanceChessUndoData(final Context context, final int active, final int[] phases) {
