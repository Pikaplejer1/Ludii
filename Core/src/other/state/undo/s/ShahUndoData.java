...
/** Auto-generated UndoData subclass for Shah. Prunable fields: pendingValues, sitesToRemove. */
public final class ShahUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ShahUndoData(final Context context, final int active, final int[] phases) {
