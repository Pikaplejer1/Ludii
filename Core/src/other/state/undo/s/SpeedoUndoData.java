...
/** Auto-generated UndoData subclass for Speedo. Prunable fields: pendingValues. */
public final class SpeedoUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public SpeedoUndoData(final Context context, final int active, final int[] phases) {
