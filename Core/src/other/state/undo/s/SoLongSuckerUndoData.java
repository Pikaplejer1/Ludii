...
/** Auto-generated UndoData subclass for SoLongSucker. Prunable fields: pendingValues, sitesToRemove. */
public final class SoLongSuckerUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SoLongSuckerUndoData(final Context context, final int active, final int[] phases) {
