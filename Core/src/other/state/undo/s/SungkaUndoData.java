...
/** Auto-generated UndoData subclass for Sungka. Prunable fields: pendingValues. */
public final class SungkaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public SungkaUndoData(final Context context, final int active, final int[] phases) {
