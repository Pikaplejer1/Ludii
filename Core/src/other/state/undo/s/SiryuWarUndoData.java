...
/** Auto-generated UndoData subclass for SiryuWar. Prunable fields: onTrackIndices, sitesToRemove. */
public final class SiryuWarUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SiryuWarUndoData(final Context context, final int active, final int[] phases) {
