...
/** Auto-generated UndoData subclass for Stratomic. Prunable fields: pendingValues, sitesToRemove. */
public final class StratomicUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public StratomicUndoData(final Context context, final int active, final int[] phases) {
