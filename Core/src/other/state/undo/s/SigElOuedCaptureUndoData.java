...
/** Auto-generated UndoData subclass for SigElOuedCapture. Prunable fields: onTrackIndices, sitesToRemove. */
public final class SigElOuedCaptureUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SigElOuedCaptureUndoData(final Context context, final int active, final int[] phases) {
