...
/** Auto-generated UndoData subclass for Shakhmaty. Prunable fields: pendingValues, sitesToRemove. */
public final class ShakhmatyUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ShakhmatyUndoData(final Context context, final int active, final int[] phases) {
