...
/** Auto-generated UndoData subclass for ShafranChess. Prunable fields: pendingValues, sitesToRemove. */
public final class ShafranChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ShafranChessUndoData(final Context context, final int active, final int[] phases) {
