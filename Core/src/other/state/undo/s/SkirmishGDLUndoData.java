...
/** Auto-generated UndoData subclass for SkirmishGDL. Prunable fields: pendingValues, sitesToRemove. */
public final class SkirmishGDLUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SkirmishGDLUndoData(final Context context, final int active, final int[] phases) {
