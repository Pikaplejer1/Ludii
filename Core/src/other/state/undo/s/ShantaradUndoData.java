...
/** Auto-generated UndoData subclass for Shantarad. Prunable fields: pendingValues, sitesToRemove. */
public final class ShantaradUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ShantaradUndoData(final Context context, final int active, final int[] phases) {
