...
/** Auto-generated UndoData subclass for SatGol. Prunable fields: pendingValues. */
public final class SatGolUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public SatGolUndoData(final Context context, final int active, final int[] phases) {
