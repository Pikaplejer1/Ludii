...
/** Auto-generated UndoData subclass for Skak. Prunable fields: pendingValues, sitesToRemove. */
public final class SkakUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SkakUndoData(final Context context, final int active, final int[] phases) {
