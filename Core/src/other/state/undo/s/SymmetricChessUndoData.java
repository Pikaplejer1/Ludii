...
/** Auto-generated UndoData subclass for SymmetricChess. Prunable fields: pendingValues, sitesToRemove. */
public final class SymmetricChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SymmetricChessUndoData(final Context context, final int active, final int[] phases) {
