...
/** Auto-generated UndoData subclass for Starchess. Prunable fields: pendingValues, sitesToRemove. */
public final class StarchessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public StarchessUndoData(final Context context, final int active, final int[] phases) {
