...
/** Auto-generated UndoData subclass for SafePassage. Prunable fields: pendingValues, sitesToRemove. */
public final class SafePassageUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SafePassageUndoData(final Context context, final int active, final int[] phases) {
