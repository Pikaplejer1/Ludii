...
/** Auto-generated UndoData subclass for Sahkku. Prunable fields: onTrackIndices, sitesToRemove. */
public final class SahkkuUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SahkkuUndoData(final Context context, final int active, final int[] phases) {
