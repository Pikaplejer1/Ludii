...
/** Auto-generated UndoData subclass for SproutROut. Prunable fields: pendingValues, sitesToRemove. */
public final class SproutROutUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public SproutROutUndoData(final Context context, final int active, final int[] phases) {
