...
/** Auto-generated UndoData subclass for UltimateChess. Prunable fields: pendingValues, sitesToRemove. */
public final class UltimateChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public UltimateChessUndoData(final Context context, final int active, final int[] phases) {
