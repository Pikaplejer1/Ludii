...
/** Auto-generated UndoData subclass for FischerRandomChess. Prunable fields: pendingValues, sitesToRemove. */
public final class FischerRandomChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public FischerRandomChessUndoData(final Context context, final int active, final int[] phases) {
