...
/** Auto-generated UndoData subclass for FourPlayerChess. Prunable fields: pendingValues, sitesToRemove. */
public final class FourPlayerChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public FourPlayerChessUndoData(final Context context, final int active, final int[] phases) {
