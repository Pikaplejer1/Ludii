...
/** Auto-generated UndoData subclass for FootballChess. Prunable fields: pendingValues. */
public final class FootballChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public FootballChessUndoData(final Context context, final int active, final int[] phases) {
