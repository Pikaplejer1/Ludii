...
/** Auto-generated UndoData subclass for Zamma. Prunable fields: pendingValues, sitesToRemove. */
public final class ZammaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ZammaUndoData(final Context context, final int active, final int[] phases) {
