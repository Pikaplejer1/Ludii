...
/** Auto-generated UndoData subclass for TsunKI. Prunable fields: onTrackIndices, sitesToRemove. */
public final class TsunKIUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public TsunKIUndoData(final Context context, final int active, final int[] phases) {
