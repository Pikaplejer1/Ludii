...
/** Auto-generated UndoData subclass for Thaayam. Prunable fields: pendingValues, sitesToRemove. */
public final class ThaayamUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ThaayamUndoData(final Context context, final int active, final int[] phases) {
