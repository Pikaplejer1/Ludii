...
/** Auto-generated UndoData subclass for TheConcentrationGame. Prunable fields: onTrackIndices. */
public final class TheConcentrationGameUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public TheConcentrationGameUndoData(final Context context, final int active, final int[] phases) {
