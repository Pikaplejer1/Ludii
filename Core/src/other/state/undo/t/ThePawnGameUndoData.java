...
/** Auto-generated UndoData subclass for ThePawnGame. Prunable fields: pendingValues, sitesToRemove. */
public final class ThePawnGameUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ThePawnGameUndoData(final Context context, final int active, final int[] phases) {
