...
/** Auto-generated UndoData subclass for Tab. Prunable fields: onTrackIndices, sitesToRemove. */
public final class TabUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public TabUndoData(final Context context, final int active, final int[] phases) {
