...
/** Auto-generated UndoData subclass for TugiEpfe. Prunable fields: onTrackIndices, sitesToRemove. */
public final class TugiEpfeUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public TugiEpfeUndoData(final Context context, final int active, final int[] phases) {
