...
/** Auto-generated UndoData subclass for Issiren. Prunable fields: onTrackIndices, sitesToRemove. */
public final class IssirenUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public IssirenUndoData(final Context context, final int active, final int[] phases) {
