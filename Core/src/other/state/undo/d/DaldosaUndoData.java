...
/** Auto-generated UndoData subclass for Daldosa. Prunable fields: onTrackIndices, sitesToRemove. */
public final class DaldosaUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DaldosaUndoData(final Context context, final int active, final int[] phases) {
