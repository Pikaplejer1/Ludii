...
/** Auto-generated UndoData subclass for Daldos. Prunable fields: onTrackIndices, sitesToRemove. */
public final class DaldosUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DaldosUndoData(final Context context, final int active, final int[] phases) {
