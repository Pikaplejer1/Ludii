...
/** Auto-generated UndoData subclass for Dragonchess. Prunable fields: pendingValues, sitesToRemove. */
public final class DragonchessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DragonchessUndoData(final Context context, final int active, final int[] phases) {
