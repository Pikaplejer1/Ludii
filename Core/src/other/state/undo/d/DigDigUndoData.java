...
/** Auto-generated UndoData subclass for DigDig. Prunable fields: pendingValues, sitesToRemove. */
public final class DigDigUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DigDigUndoData(final Context context, final int active, final int[] phases) {
