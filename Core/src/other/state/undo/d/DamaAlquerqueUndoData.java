...
/** Auto-generated UndoData subclass for DamaAlquerque. Prunable fields: pendingValues, sitesToRemove. */
public final class DamaAlquerqueUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DamaAlquerqueUndoData(final Context context, final int active, final int[] phases) {
