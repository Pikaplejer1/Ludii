...
/** Auto-generated UndoData subclass for Deleb. Prunable fields: onTrackIndices, sitesToRemove. */
public final class DelebUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DelebUndoData(final Context context, final int active, final int[] phases) {
