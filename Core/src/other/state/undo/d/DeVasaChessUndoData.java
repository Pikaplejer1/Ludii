...
/** Auto-generated UndoData subclass for DeVasaChess. Prunable fields: pendingValues, sitesToRemove. */
public final class DeVasaChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DeVasaChessUndoData(final Context context, final int active, final int[] phases) {
