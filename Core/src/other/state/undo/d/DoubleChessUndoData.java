...
/** Auto-generated UndoData subclass for DoubleChess. Prunable fields: pendingValues, sitesToRemove. */
public final class DoubleChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DoubleChessUndoData(final Context context, final int active, final int[] phases) {
