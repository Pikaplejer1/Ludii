...
/** Auto-generated UndoData subclass for Daramuti. Prunable fields: pendingValues. */
public final class DaramutiUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public DaramutiUndoData(final Context context, final int active, final int[] phases) {
