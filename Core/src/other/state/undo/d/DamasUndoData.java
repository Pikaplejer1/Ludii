...
/** Auto-generated UndoData subclass for Damas. Prunable fields: pendingValues, sitesToRemove. */
public final class DamasUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public DamasUndoData(final Context context, final int active, final int[] phases) {
