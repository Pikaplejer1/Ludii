...
/** Auto-generated UndoData subclass for LiBAlAqil. Prunable fields: pendingValues. */
public final class LiBAlAqilUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public LiBAlAqilUndoData(final Context context, final int active, final int[] phases) {
