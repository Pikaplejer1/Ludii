...
/** Auto-generated UndoData subclass for LosPalos. Prunable fields: onTrackIndices, sitesToRemove. */
public final class LosPalosUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public LosPalosUndoData(final Context context, final int active, final int[] phases) {
