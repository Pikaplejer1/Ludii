...
/** Auto-generated UndoData subclass for LudusAnglicorum. Prunable fields: onTrackIndices. */
public final class LudusAnglicorumUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public LudusAnglicorumUndoData(final Context context, final int active, final int[] phases) {
