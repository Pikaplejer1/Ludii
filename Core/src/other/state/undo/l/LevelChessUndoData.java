...
/** Auto-generated UndoData subclass for LevelChess. Prunable fields: pendingValues, sitesToRemove. */
public final class LevelChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public LevelChessUndoData(final Context context, final int active, final int[] phases) {
