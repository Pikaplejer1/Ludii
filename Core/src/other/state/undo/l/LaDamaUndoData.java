...
/** Auto-generated UndoData subclass for LaDama. Prunable fields: pendingValues, sitesToRemove. */
public final class LaDamaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public LaDamaUndoData(final Context context, final int active, final int[] phases) {
