...
/** Auto-generated UndoData subclass for LamWaladach. Prunable fields: pendingValues. */
public final class LamWaladachUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public LamWaladachUndoData(final Context context, final int active, final int[] phases) {
