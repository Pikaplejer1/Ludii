...
/** Auto-generated UndoData subclass for Andarraya. Prunable fields: pendingValues, sitesToRemove. */
public final class AndarrayaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AndarrayaUndoData(final Context context, final int active, final int[] phases) {
