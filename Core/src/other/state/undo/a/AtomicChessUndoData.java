...
/** Auto-generated UndoData subclass for AtomicChess. Prunable fields: pendingValues, sitesToRemove. */
public final class AtomicChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AtomicChessUndoData(final Context context, final int active, final int[] phases) {
