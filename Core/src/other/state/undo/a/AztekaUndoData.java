...
/** Auto-generated UndoData subclass for Azteka. Prunable fields: pendingValues, sitesToRemove. */
public final class AztekaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AztekaUndoData(final Context context, final int active, final int[] phases) {
