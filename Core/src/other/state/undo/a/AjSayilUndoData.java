...
/** Auto-generated UndoData subclass for AjSayil. Prunable fields: pendingValues, sitesToRemove. */
public final class AjSayilUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AjSayilUndoData(final Context context, final int active, final int[] phases) {
