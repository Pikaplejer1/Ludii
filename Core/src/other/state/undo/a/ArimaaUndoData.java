...
/** Auto-generated UndoData subclass for Arimaa. Prunable fields: pendingValues, sitesToRemove. */
public final class ArimaaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ArimaaUndoData(final Context context, final int active, final int[] phases) {
