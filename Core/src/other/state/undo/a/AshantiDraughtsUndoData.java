...
/** Auto-generated UndoData subclass for AshantiDraughts. Prunable fields: pendingValues, sitesToRemove. */
public final class AshantiDraughtsUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AshantiDraughtsUndoData(final Context context, final int active, final int[] phases) {
