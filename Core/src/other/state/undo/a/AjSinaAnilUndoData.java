...
/** Auto-generated UndoData subclass for AjSinaAnil. Prunable fields: pendingValues, sitesToRemove. */
public final class AjSinaAnilUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AjSinaAnilUndoData(final Context context, final int active, final int[] phases) {
