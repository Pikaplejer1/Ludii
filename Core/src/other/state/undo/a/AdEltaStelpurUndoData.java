...
/** Auto-generated UndoData subclass for AdEltaStelpur. Prunable fields: pendingValues, sitesToRemove. */
public final class AdEltaStelpurUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AdEltaStelpurUndoData(final Context context, final int active, final int[] phases) {
