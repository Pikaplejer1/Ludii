...
/** Auto-generated UndoData subclass for AKAakIl. Prunable fields: pendingValues, sitesToRemove. */
public final class AKAakIlUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AKAakIlUndoData(final Context context, final int active, final int[] phases) {
