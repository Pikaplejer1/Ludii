...
/** Auto-generated UndoData subclass for AjSakakil. Prunable fields: pendingValues, sitesToRemove. */
public final class AjSakakilUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AjSakakilUndoData(final Context context, final int active, final int[] phases) {
