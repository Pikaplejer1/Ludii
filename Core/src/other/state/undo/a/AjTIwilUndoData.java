...
/** Auto-generated UndoData subclass for AjTIwil. Prunable fields: pendingValues, sitesToRemove. */
public final class AjTIwilUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public AjTIwilUndoData(final Context context, final int active, final int[] phases) {
