...
/** Auto-generated UndoData subclass for RenardEtLesPoules. Prunable fields: pendingValues, sitesToRemove. */
public final class RenardEtLesPoulesUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public RenardEtLesPoulesUndoData(final Context context, final int active, final int[] phases) {
