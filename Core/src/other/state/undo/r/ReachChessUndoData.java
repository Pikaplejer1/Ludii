...
/** Auto-generated UndoData subclass for ReachChess. Prunable fields: pendingValues, sitesToRemove. */
public final class ReachChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public ReachChessUndoData(final Context context, final int active, final int[] phases) {
