...
/** Auto-generated UndoData subclass for Riga. Prunable fields: pendingValues, sitesToRemove. */
public final class RigaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public RigaUndoData(final Context context, final int active, final int[] phases) {
