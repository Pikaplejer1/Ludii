...
/** Auto-generated UndoData subclass for PagadeKayiAtaSixteenHanded. Prunable fields: pendingValues, onTrackIndices. */
public final class PagadeKayiAtaSixteenHandedUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final other.state.track.OnTrackIndices onTrackIndices;

    public PagadeKayiAtaSixteenHandedUndoData(final Context context, final int active, final int[] phases) {
