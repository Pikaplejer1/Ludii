...
/** Auto-generated UndoData subclass for Pachesi. Prunable fields: onTrackIndices. */
public final class PachesiUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public PachesiUndoData(final Context context, final int active, final int[] phases) {
