...
/** Auto-generated UndoData subclass for PromotionChess. Prunable fields: pendingValues, sitesToRemove. */
public final class PromotionChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public PromotionChessUndoData(final Context context, final int active, final int[] phases) {
