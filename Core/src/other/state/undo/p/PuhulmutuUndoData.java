...
/** Auto-generated UndoData subclass for Puhulmutu. Prunable fields: pendingValues. */
public final class PuhulmutuUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public PuhulmutuUndoData(final Context context, final int active, final int[] phases) {
