...
/** Auto-generated UndoData subclass for Panchi. Prunable fields: onTrackIndices. */
public final class PanchiUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public PanchiUndoData(final Context context, final int active, final int[] phases) {
