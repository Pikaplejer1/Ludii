...
/** Auto-generated UndoData subclass for PhaseChess. Prunable fields: pendingValues, sitesToRemove. */
public final class PhaseChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public PhaseChessUndoData(final Context context, final int active, final int[] phases) {
