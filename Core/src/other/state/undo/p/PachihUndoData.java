...
/** Auto-generated UndoData subclass for Pachih. Prunable fields: onTrackIndices. */
public final class PachihUndoData extends UndoData {

    private final other.state.track.OnTrackIndices onTrackIndices;

    public PachihUndoData(final Context context, final int active, final int[] phases) {
