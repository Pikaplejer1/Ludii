...
/** Auto-generated UndoData subclass for Pachgarhwa. Prunable fields: pendingValues. */
public final class PachgarhwaUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public PachgarhwaUndoData(final Context context, final int active, final int[] phases) {
