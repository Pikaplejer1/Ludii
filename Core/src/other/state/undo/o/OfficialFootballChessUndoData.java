...
/** Auto-generated UndoData subclass for OfficialFootballChess. Prunable fields: pendingValues, sitesToRemove. */
public final class OfficialFootballChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public OfficialFootballChessUndoData(final Context context, final int active, final int[] phases) {
