...
/** Auto-generated UndoData subclass for Ovalhu. Prunable fields: pendingValues. */
public final class OvalhuUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public OvalhuUndoData(final Context context, final int active, final int[] phases) {
