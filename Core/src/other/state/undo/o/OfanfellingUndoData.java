...
/** Auto-generated UndoData subclass for Ofanfelling. Prunable fields: pendingValues. */
public final class OfanfellingUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;

    public OfanfellingUndoData(final Context context, final int active, final int[] phases) {
