...
/** Auto-generated UndoData subclass for OmegaChess. Prunable fields: pendingValues, sitesToRemove. */
public final class OmegaChessUndoData extends UndoData {

    private final gnu.trove.set.hash.TIntHashSet pendingValues;
    private final gnu.trove.list.array.TIntArrayList sitesToRemove;

    public OmegaChessUndoData(final Context context, final int active, final int[] phases) {
