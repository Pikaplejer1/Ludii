...
/** Auto-generated State subclass for Knightthrough. */
public class KnightthroughState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public KnightthroughState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KnightthroughState(final KnightthroughState other) {
        super(other);
    ...
    @Override public KnightthroughState copy() { return new KnightthroughState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KnightthroughState o = (KnightthroughState) other;
