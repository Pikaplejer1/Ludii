...
/** Auto-generated State subclass for Kiuthi. */
public class KiuthiState extends State {
    ...
    public KiuthiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KiuthiState(final KiuthiState other) {
        super(other);
    ...
    @Override public KiuthiState copy() { return new KiuthiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KiuthiState o = (KiuthiState) other;
