...
/** Auto-generated State subclass for Kisolo. */
public class KisoloState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public KisoloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KisoloState(final KisoloState other) {
        super(other);
    ...
    @Override public KisoloState copy() { return new KisoloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KisoloState o = (KisoloState) other;
