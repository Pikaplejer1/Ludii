...
/** Auto-generated State subclass for Katrayo. */
public class KatrayoState extends State {
    ...
    public KatrayoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KatrayoState(final KatrayoState other) {
        super(other);
    ...
    @Override public KatrayoState copy() { return new KatrayoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KatrayoState o = (KatrayoState) other;
