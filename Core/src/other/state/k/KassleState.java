...
/** Auto-generated State subclass for Kassle. */
public class KassleState extends State {
    ...
    public KassleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KassleState(final KassleState other) {
        super(other);
    ...
    @Override public KassleState copy() { return new KassleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KassleState o = (KassleState) other;
