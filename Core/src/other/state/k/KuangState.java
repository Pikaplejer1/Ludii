...
/** Auto-generated State subclass for Kuang. */
public class KuangState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public KuangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KuangState(final KuangState other) {
        super(other);
    ...
    @Override public KuangState copy() { return new KuangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KuangState o = (KuangState) other;
