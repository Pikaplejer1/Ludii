...
/** Auto-generated State subclass for KolicaAtarakua. */
public class KolicaAtarakuaState extends State {
    ...
    public KolicaAtarakuaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KolicaAtarakuaState(final KolicaAtarakuaState other) {
        super(other);
    ...
    @Override public KolicaAtarakuaState copy() { return new KolicaAtarakuaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KolicaAtarakuaState o = (KolicaAtarakuaState) other;
