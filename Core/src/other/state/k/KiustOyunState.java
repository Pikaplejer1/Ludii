...
/** Auto-generated State subclass for KiustOyun. */
public class KiustOyunState extends State {
    ...
    public KiustOyunState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KiustOyunState(final KiustOyunState other) {
        super(other);
    ...
    @Override public KiustOyunState copy() { return new KiustOyunState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KiustOyunState o = (KiustOyunState) other;
