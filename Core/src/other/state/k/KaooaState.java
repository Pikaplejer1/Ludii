...
/** Auto-generated State subclass for Kaooa. */
public class KaooaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public KaooaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KaooaState(final KaooaState other) {
        super(other);
    ...
    @Override public KaooaState copy() { return new KaooaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KaooaState o = (KaooaState) other;
