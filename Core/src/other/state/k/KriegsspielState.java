...
/** Auto-generated State subclass for Kriegsspiel. */
public class KriegsspielState extends State {
    ...
    public KriegsspielState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KriegsspielState(final KriegsspielState other) {
        super(other);
    ...
    @Override public KriegsspielState copy() { return new KriegsspielState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KriegsspielState o = (KriegsspielState) other;
