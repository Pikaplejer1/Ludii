...
/** Auto-generated State subclass for Katra. */
public class KatraState extends State {
    ...
    public KatraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KatraState(final KatraState other) {
        super(other);
    ...
    @Override public KatraState copy() { return new KatraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KatraState o = (KatraState) other;
