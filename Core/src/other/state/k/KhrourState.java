...
/** Auto-generated State subclass for Khrour. */
public class KhrourState extends State {
    ...
    public KhrourState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KhrourState(final KhrourState other) {
        super(other);
    ...
    @Override public KhrourState copy() { return new KhrourState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KhrourState o = (KhrourState) other;
