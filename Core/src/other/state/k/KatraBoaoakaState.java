...
/** Auto-generated State subclass for KatraBoaoaka. */
public class KatraBoaoakaState extends State {
    ...
    public KatraBoaoakaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KatraBoaoakaState(final KatraBoaoakaState other) {
        super(other);
    ...
    @Override public KatraBoaoakaState copy() { return new KatraBoaoakaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KatraBoaoakaState o = (KatraBoaoakaState) other;
