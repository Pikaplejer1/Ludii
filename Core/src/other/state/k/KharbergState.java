...
/** Auto-generated State subclass for Kharberg. */
public class KharbergState extends State {
    ...
    public KharbergState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KharbergState(final KharbergState other) {
        super(other);
    ...
    @Override public KharbergState copy() { return new KharbergState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KharbergState o = (KharbergState) other;
