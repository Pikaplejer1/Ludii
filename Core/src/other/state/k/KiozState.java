...
/** Auto-generated State subclass for Kioz. */
public class KiozState extends State {
    ...
    public KiozState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KiozState(final KiozState other) {
        super(other);
    ...
    @Override public KiozState copy() { return new KiozState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KiozState o = (KiozState) other;
