...
/** Auto-generated State subclass for KnossosGame. */
public class KnossosGameState extends State {
    ...
    public KnossosGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KnossosGameState(final KnossosGameState other) {
        super(other);
    ...
    @Override public KnossosGameState copy() { return new KnossosGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KnossosGameState o = (KnossosGameState) other;
