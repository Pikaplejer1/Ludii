...
/** Auto-generated State subclass for KetchDolt. */
public class KetchDoltState extends State {
    ...
    public KetchDoltState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KetchDoltState(final KetchDoltState other) {
        super(other);
    ...
    @Override public KetchDoltState copy() { return new KetchDoltState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KetchDoltState o = (KetchDoltState) other;
