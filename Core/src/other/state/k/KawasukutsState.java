...
/** Auto-generated State subclass for Kawasukuts. */
public class KawasukutsState extends State {
    ...
    public KawasukutsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KawasukutsState(final KawasukutsState other) {
        super(other);
    ...
    @Override public KawasukutsState copy() { return new KawasukutsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KawasukutsState o = (KawasukutsState) other;
