...
/** Auto-generated State subclass for KizTavlasi. */
public class KizTavlasiState extends State {
    ...
    public KizTavlasiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KizTavlasiState(final KizTavlasiState other) {
        super(other);
    ...
    @Override public KizTavlasiState copy() { return new KizTavlasiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KizTavlasiState o = (KizTavlasiState) other;
