...
/** Auto-generated State subclass for Koruboddo. */
public class KoruboddoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public KoruboddoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KoruboddoState(final KoruboddoState other) {
        super(other);
    ...
    @Override public KoruboddoState copy() { return new KoruboddoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KoruboddoState o = (KoruboddoState) other;
