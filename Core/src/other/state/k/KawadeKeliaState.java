...
/** Auto-generated State subclass for KawadeKelia. */
public class KawadeKeliaState extends State {
    ...
    public KawadeKeliaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KawadeKeliaState(final KawadeKeliaState other) {
        super(other);
    ...
    @Override public KawadeKeliaState copy() { return new KawadeKeliaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KawadeKeliaState o = (KawadeKeliaState) other;
