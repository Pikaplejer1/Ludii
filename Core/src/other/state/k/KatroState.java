...
/** Auto-generated State subclass for Katro. */
public class KatroState extends State {
    ...
    public KatroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KatroState(final KatroState other) {
        super(other);
    ...
    @Override public KatroState copy() { return new KatroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KatroState o = (KatroState) other;
