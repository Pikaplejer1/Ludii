...
/** Auto-generated State subclass for KhutkaBoia. */
public class KhutkaBoiaState extends State {
    ...
    public KhutkaBoiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KhutkaBoiaState(final KhutkaBoiaState other) {
        super(other);
    ...
    @Override public KhutkaBoiaState copy() { return new KhutkaBoiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KhutkaBoiaState o = (KhutkaBoiaState) other;
