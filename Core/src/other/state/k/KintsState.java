...
/** Auto-generated State subclass for Kints. */
public class KintsState extends State {
    ...
    public KintsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KintsState(final KintsState other) {
        super(other);
    ...
    @Override public KintsState copy() { return new KintsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KintsState o = (KintsState) other;
