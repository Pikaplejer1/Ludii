...
/** Auto-generated State subclass for KriegspielChess. */
public class KriegspielChessState extends State {
    ...
    public KriegspielChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public KriegspielChessState(final KriegspielChessState other) {
        super(other);
    ...
    @Override public KriegspielChessState copy() { return new KriegspielChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KriegspielChessState o = (KriegspielChessState) other;
