...
/** Auto-generated State subclass for KotuBaendum. */
public class KotuBaendumState extends State {
    ...
    public KotuBaendumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KotuBaendumState(final KotuBaendumState other) {
        super(other);
    ...
    @Override public KotuBaendumState copy() { return new KotuBaendumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KotuBaendumState o = (KotuBaendumState) other;
