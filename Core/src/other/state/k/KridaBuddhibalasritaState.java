...
/** Auto-generated State subclass for KridaBuddhibalasrita. */
public class KridaBuddhibalasritaState extends State {
    ...
    public KridaBuddhibalasritaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KridaBuddhibalasritaState(final KridaBuddhibalasritaState other) {
        super(other);
    ...
    @Override public KridaBuddhibalasritaState copy() { return new KridaBuddhibalasritaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KridaBuddhibalasritaState o = (KridaBuddhibalasritaState) other;
