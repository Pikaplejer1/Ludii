...
/** Auto-generated State subclass for Komikan. */
public class KomikanState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public KomikanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KomikanState(final KomikanState other) {
        super(other);
    ...
    @Override public KomikanState copy() { return new KomikanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KomikanState o = (KomikanState) other;
