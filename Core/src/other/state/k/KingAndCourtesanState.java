...
/** Auto-generated State subclass for KingAndCourtesan. */
public class KingAndCourtesanState extends State {
    ...
    public KingAndCourtesanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public KingAndCourtesanState(final KingAndCourtesanState other) {
        super(other);
    ...
    @Override public KingAndCourtesanState copy() { return new KingAndCourtesanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KingAndCourtesanState o = (KingAndCourtesanState) other;
