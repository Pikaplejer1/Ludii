...
/** Auto-generated State subclass for Kotra. */
public class KotraState extends State {
    ...
    public KotraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public KotraState(final KotraState other) {
        super(other);
    ...
    @Override public KotraState copy() { return new KotraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final KotraState o = (KotraState) other;
