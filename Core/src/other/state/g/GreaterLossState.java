...
/** Auto-generated State subclass for GreaterLoss. */
public class GreaterLossState extends State {
    ...
    public GreaterLossState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GreaterLossState(final GreaterLossState other) {
        super(other);
    ...
    @Override public GreaterLossState copy() { return new GreaterLossState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GreaterLossState o = (GreaterLossState) other;
