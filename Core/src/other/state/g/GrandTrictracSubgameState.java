...
/** Auto-generated State subclass for GrandTrictracSubgame. */
public class GrandTrictracSubgameState extends State {
    ...
    public GrandTrictracSubgameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GrandTrictracSubgameState(final GrandTrictracSubgameState other) {
        super(other);
    ...
    @Override public GrandTrictracSubgameState copy() { return new GrandTrictracSubgameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GrandTrictracSubgameState o = (GrandTrictracSubgameState) other;
