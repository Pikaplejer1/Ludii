...
/** Auto-generated State subclass for GabataShoaI. */
public class GabataShoaIState extends State {
    ...
    public GabataShoaIState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataShoaIState(final GabataShoaIState other) {
        super(other);
    ...
    @Override public GabataShoaIState copy() { return new GabataShoaIState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataShoaIState o = (GabataShoaIState) other;
