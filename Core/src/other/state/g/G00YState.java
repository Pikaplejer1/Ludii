...
/** Auto-generated State subclass for G00Y. */
public class G00YState extends State {
    ...
    public G00YState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public G00YState(final G00YState other) {
        super(other);
    ...
    @Override public G00YState copy() { return new G00YState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final G00YState o = (G00YState) other;
