...
/** Auto-generated State subclass for GuerrillaCheckers. */
public class GuerrillaCheckersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GuerrillaCheckersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GuerrillaCheckersState(final GuerrillaCheckersState other) {
        super(other);
    ...
    @Override public GuerrillaCheckersState copy() { return new GuerrillaCheckersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GuerrillaCheckersState o = (GuerrillaCheckersState) other;
