...
/** Auto-generated State subclass for GoWithTheFloe. */
public class GoWithTheFloeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GoWithTheFloeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GoWithTheFloeState(final GoWithTheFloeState other) {
        super(other);
    ...
    @Override public GoWithTheFloeState copy() { return new GoWithTheFloeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GoWithTheFloeState o = (GoWithTheFloeState) other;
