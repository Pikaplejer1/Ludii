...
/** Auto-generated State subclass for GabataShoaAndAdegrat. */
public class GabataShoaAndAdegratState extends State {
    ...
    public GabataShoaAndAdegratState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataShoaAndAdegratState(final GabataShoaAndAdegratState other) {
        super(other);
    ...
    @Override public GabataShoaAndAdegratState copy() { return new GabataShoaAndAdegratState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataShoaAndAdegratState o = (GabataShoaAndAdegratState) other;
