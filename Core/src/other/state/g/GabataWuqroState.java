...
/** Auto-generated State subclass for GabataWuqro. */
public class GabataWuqroState extends State {
    ...
    public GabataWuqroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataWuqroState(final GabataWuqroState other) {
        super(other);
    ...
    @Override public GabataWuqroState copy() { return new GabataWuqroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataWuqroState o = (GabataWuqroState) other;
