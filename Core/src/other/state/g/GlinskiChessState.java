...
/** Auto-generated State subclass for GlinskiChess. */
public class GlinskiChessState extends State {
    ...
    public GlinskiChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GlinskiChessState(final GlinskiChessState other) {
        super(other);
    ...
    @Override public GlinskiChessState copy() { return new GlinskiChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GlinskiChessState o = (GlinskiChessState) other;
