...
/** Auto-generated State subclass for G20Squares. */
public class G20SquaresState extends State {
    ...
    public G20SquaresState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public G20SquaresState(final G20SquaresState other) {
        super(other);
    ...
    @Override public G20SquaresState copy() { return new G20SquaresState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final G20SquaresState o = (G20SquaresState) other;
