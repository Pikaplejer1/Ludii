...
/** Auto-generated State subclass for Garanguet. */
public class GaranguetState extends State {
    ...
    public GaranguetState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GaranguetState(final GaranguetState other) {
        super(other);
    ...
    @Override public GaranguetState copy() { return new GaranguetState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GaranguetState o = (GaranguetState) other;
