...
/** Auto-generated State subclass for Gundru. */
public class GundruState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GundruState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GundruState(final GundruState other) {
        super(other);
    ...
    @Override public GundruState copy() { return new GundruState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GundruState o = (GundruState) other;
