...
/** Auto-generated State subclass for Galatjang. */
public class GalatjangState extends State {
    ...
    public GalatjangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GalatjangState(final GalatjangState other) {
        super(other);
    ...
    @Override public GalatjangState copy() { return new GalatjangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GalatjangState o = (GalatjangState) other;
