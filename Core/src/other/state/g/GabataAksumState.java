...
/** Auto-generated State subclass for GabataAksum. */
public class GabataAksumState extends State {
    ...
    public GabataAksumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataAksumState(final GabataAksumState other) {
        super(other);
    ...
    @Override public GabataAksumState copy() { return new GabataAksumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataAksumState o = (GabataAksumState) other;
