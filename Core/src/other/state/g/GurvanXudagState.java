...
/** Auto-generated State subclass for GurvanXudag. */
public class GurvanXudagState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GurvanXudagState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GurvanXudagState(final GurvanXudagState other) {
        super(other);
    ...
    @Override public GurvanXudagState copy() { return new GurvanXudagState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GurvanXudagState o = (GurvanXudagState) other;
