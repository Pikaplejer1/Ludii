...
/** Auto-generated State subclass for Garrisons. */
public class GarrisonsState extends State {
    ...
    public GarrisonsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GarrisonsState(final GarrisonsState other) {
        super(other);
    ...
    @Override public GarrisonsState copy() { return new GarrisonsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GarrisonsState o = (GarrisonsState) other;
