...
/** Auto-generated State subclass for Gadis. */
public class GadisState extends State {
    ...
    public GadisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GadisState(final GadisState other) {
        super(other);
    ...
    @Override public GadisState copy() { return new GadisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GadisState o = (GadisState) other;
