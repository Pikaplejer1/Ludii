...
/** Auto-generated State subclass for Gauntlet. */
public class GauntletState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GauntletState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GauntletState(final GauntletState other) {
        super(other);
    ...
    @Override public GauntletState copy() { return new GauntletState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GauntletState o = (GauntletState) other;
