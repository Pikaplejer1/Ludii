...
/** Auto-generated State subclass for GiocoDellOrso. */
public class GiocoDellOrsoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GiocoDellOrsoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GiocoDellOrsoState(final GiocoDellOrsoState other) {
        super(other);
    ...
    @Override public GiocoDellOrsoState copy() { return new GiocoDellOrsoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GiocoDellOrsoState o = (GiocoDellOrsoState) other;
