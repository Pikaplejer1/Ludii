...
/** Auto-generated State subclass for GabataAdegrat. */
public class GabataAdegratState extends State {
    ...
    public GabataAdegratState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataAdegratState(final GabataAdegratState other) {
        super(other);
    ...
    @Override public GabataAdegratState copy() { return new GabataAdegratState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataAdegratState o = (GabataAdegratState) other;
