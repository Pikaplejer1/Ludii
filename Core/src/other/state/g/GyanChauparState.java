...
/** Auto-generated State subclass for GyanChaupar. */
public class GyanChauparState extends State {
    ...
    public GyanChauparState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GyanChauparState(final GyanChauparState other) {
        super(other);
    ...
    @Override public GyanChauparState copy() { return new GyanChauparState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GyanChauparState o = (GyanChauparState) other;
