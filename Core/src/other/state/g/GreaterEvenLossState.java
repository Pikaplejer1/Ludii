...
/** Auto-generated State subclass for GreaterEvenLoss. */
public class GreaterEvenLossState extends State {
    ...
    public GreaterEvenLossState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GreaterEvenLossState(final GreaterEvenLossState other) {
        super(other);
    ...
    @Override public GreaterEvenLossState copy() { return new GreaterEvenLossState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GreaterEvenLossState o = (GreaterEvenLossState) other;
