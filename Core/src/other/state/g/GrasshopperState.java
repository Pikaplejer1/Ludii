...
/** Auto-generated State subclass for Grasshopper. */
public class GrasshopperState extends State {

    private static final long serialVersionUID = 1L;

    private java.util.BitSet visited = new java.util.BitSet();

    public GrasshopperState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public GrasshopperState(final GrasshopperState other) {
        super(other);
        visited = (other.visited != null) ? (java.util.BitSet) other.visited.clone() : new java.util.BitSet();
    }

    @Override public GrasshopperState copy() { return new GrasshopperState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GrasshopperState o = (GrasshopperState) other;
