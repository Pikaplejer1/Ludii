...
/** Auto-generated State subclass for GabataAdowa. */
public class GabataAdowaState extends State {
    ...
    public GabataAdowaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataAdowaState(final GabataAdowaState other) {
        super(other);
    ...
    @Override public GabataAdowaState copy() { return new GabataAdowaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataAdowaState o = (GabataAdowaState) other;
