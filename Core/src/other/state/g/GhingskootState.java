...
/** Auto-generated State subclass for Ghingskoot. */
public class GhingskootState extends State {
    ...
    public GhingskootState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GhingskootState(final GhingskootState other) {
        super(other);
    ...
    @Override public GhingskootState copy() { return new GhingskootState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GhingskootState o = (GhingskootState) other;
