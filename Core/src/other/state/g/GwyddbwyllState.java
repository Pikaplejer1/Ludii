...
/** Auto-generated State subclass for Gwyddbwyll. */
public class GwyddbwyllState extends State {
    ...
    public GwyddbwyllState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GwyddbwyllState(final GwyddbwyllState other) {
        super(other);
    ...
    @Override public GwyddbwyllState copy() { return new GwyddbwyllState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GwyddbwyllState o = (GwyddbwyllState) other;
