...
/** Auto-generated State subclass for Gavalata. */
public class GavalataState extends State {
    ...
    public GavalataState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GavalataState(final GavalataState other) {
        super(other);
    ...
    @Override public GavalataState copy() { return new GavalataState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GavalataState o = (GavalataState) other;
