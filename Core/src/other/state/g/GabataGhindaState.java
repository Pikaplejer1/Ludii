...
/** Auto-generated State subclass for GabataGhinda. */
public class GabataGhindaState extends State {
    ...
    public GabataGhindaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GabataGhindaState(final GabataGhindaState other) {
        super(other);
    ...
    @Override public GabataGhindaState copy() { return new GabataGhindaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GabataGhindaState o = (GabataGhindaState) other;
