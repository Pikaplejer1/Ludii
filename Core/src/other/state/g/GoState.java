...
/** Auto-generated State subclass for Go. */
public class GoState extends State {
    ...
    public GoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GoState(final GoState other) {
        super(other);
    ...
    @Override public GoState copy() { return new GoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GoState o = (GoState) other;
