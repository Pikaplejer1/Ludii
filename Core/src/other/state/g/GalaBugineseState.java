...
/** Auto-generated State subclass for GalaBuginese. */
public class GalaBugineseState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GalaBugineseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GalaBugineseState(final GalaBugineseState other) {
        super(other);
    ...
    @Override public GalaBugineseState copy() { return new GalaBugineseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GalaBugineseState o = (GalaBugineseState) other;
