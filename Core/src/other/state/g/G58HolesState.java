...
/** Auto-generated State subclass for G58Holes. */
public class G58HolesState extends State {
    ...
    public G58HolesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public G58HolesState(final G58HolesState other) {
        super(other);
    ...
    @Override public G58HolesState copy() { return new G58HolesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final G58HolesState o = (G58HolesState) other;
