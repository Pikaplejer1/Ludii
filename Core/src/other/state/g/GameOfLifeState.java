...
/** Auto-generated State subclass for GameOfLife. */
public class GameOfLifeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public GameOfLifeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GameOfLifeState(final GameOfLifeState other) {
        super(other);
    ...
    @Override public GameOfLifeState copy() { return new GameOfLifeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GameOfLifeState o = (GameOfLifeState) other;
