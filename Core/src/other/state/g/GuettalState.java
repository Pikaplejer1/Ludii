...
/** Auto-generated State subclass for Guettal. */
public class GuettalState extends State {
    ...
    public GuettalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GuettalState(final GuettalState other) {
        super(other);
    ...
    @Override public GuettalState copy() { return new GuettalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GuettalState o = (GuettalState) other;
