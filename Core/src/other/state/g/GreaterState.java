...
/** Auto-generated State subclass for Greater. */
public class GreaterState extends State {
    ...
    public GreaterState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public GreaterState(final GreaterState other) {
        super(other);
    ...
    @Override public GreaterState copy() { return new GreaterState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GreaterState o = (GreaterState) other;
