...
/** Auto-generated State subclass for GrandeAcedrex. */
public class GrandeAcedrexState extends State {
    ...
    public GrandeAcedrexState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public GrandeAcedrexState(final GrandeAcedrexState other) {
        super(other);
    ...
    @Override public GrandeAcedrexState copy() { return new GrandeAcedrexState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final GrandeAcedrexState o = (GrandeAcedrexState) other;
