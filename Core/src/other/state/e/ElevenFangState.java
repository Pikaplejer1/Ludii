...
/** Auto-generated State subclass for ElevenFang. */
public class ElevenFangState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ElevenFangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ElevenFangState(final ElevenFangState other) {
        super(other);
    ...
    @Override public ElevenFangState copy() { return new ElevenFangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ElevenFangState o = (ElevenFangState) other;
