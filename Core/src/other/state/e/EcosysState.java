...
/** Auto-generated State subclass for Ecosys. */
public class EcosysState extends State {
    ...
    public EcosysState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public EcosysState(final EcosysState other) {
        super(other);
    ...
    @Override public EcosysState copy() { return new EcosysState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EcosysState o = (EcosysState) other;
