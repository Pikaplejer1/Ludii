...
/** Auto-generated State subclass for Emperador. */
public class EmperadorState extends State {
    ...
    public EmperadorState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public EmperadorState(final EmperadorState other) {
        super(other);
    ...
    @Override public EmperadorState copy() { return new EmperadorState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EmperadorState o = (EmperadorState) other;
