...
/** Auto-generated State subclass for ElMundo. */
public class ElMundoState extends State {
    ...
    public ElMundoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ElMundoState(final ElMundoState other) {
        super(other);
    ...
    @Override public ElMundoState copy() { return new ElMundoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ElMundoState o = (ElMundoState) other;
