...
/** Auto-generated State subclass for Epoxy. */
public class EpoxyState extends State {
    ...
    public EpoxyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public EpoxyState(final EpoxyState other) {
        super(other);
    ...
    @Override public EpoxyState copy() { return new EpoxyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EpoxyState o = (EpoxyState) other;
