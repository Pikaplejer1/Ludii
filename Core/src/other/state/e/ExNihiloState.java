...
/** Auto-generated State subclass for ExNihilo. */
public class ExNihiloState extends State {
    ...
    public ExNihiloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ExNihiloState(final ExNihiloState other) {
        super(other);
    ...
    @Override public ExNihiloState copy() { return new ExNihiloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ExNihiloState o = (ExNihiloState) other;
