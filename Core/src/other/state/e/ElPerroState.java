...
/** Auto-generated State subclass for ElPerro. */
public class ElPerroState extends State {
    ...
    public ElPerroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ElPerroState(final ElPerroState other) {
        super(other);
    ...
    @Override public ElPerroState copy() { return new ElPerroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ElPerroState o = (ElPerroState) other;
