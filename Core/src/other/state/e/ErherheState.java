...
/** Auto-generated State subclass for Erherhe. */
public class ErherheState extends State {
    ...
    public ErherheState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ErherheState(final ErherheState other) {
        super(other);
    ...
    @Override public ErherheState copy() { return new ErherheState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ErherheState o = (ErherheState) other;
