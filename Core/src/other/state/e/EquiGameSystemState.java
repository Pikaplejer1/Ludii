...
/** Auto-generated State subclass for EquiGameSystem. */
public class EquiGameSystemState extends State {
    ...
    public EquiGameSystemState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public EquiGameSystemState(final EquiGameSystemState other) {
        super(other);
    ...
    @Override public EquiGameSystemState copy() { return new EquiGameSystemState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EquiGameSystemState o = (EquiGameSystemState) other;
