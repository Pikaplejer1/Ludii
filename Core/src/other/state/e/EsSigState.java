...
/** Auto-generated State subclass for EsSig. */
public class EsSigState extends State {
    ...
    public EsSigState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public EsSigState(final EsSigState other) {
        super(other);
    ...
    @Override public EsSigState copy() { return new EsSigState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EsSigState o = (EsSigState) other;
