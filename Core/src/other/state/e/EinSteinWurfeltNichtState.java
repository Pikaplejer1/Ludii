...
/** Auto-generated State subclass for EinSteinWurfeltNicht. */
public class EinSteinWurfeltNichtState extends State {
    ...
    public EinSteinWurfeltNichtState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public EinSteinWurfeltNichtState(final EinSteinWurfeltNichtState other) {
        super(other);
    ...
    @Override public EinSteinWurfeltNichtState copy() { return new EinSteinWurfeltNichtState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final EinSteinWurfeltNichtState o = (EinSteinWurfeltNichtState) other;
