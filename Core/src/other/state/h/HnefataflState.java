...
/** Auto-generated State subclass for Hnefatafl. */
public class HnefataflState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HnefataflState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HnefataflState(final HnefataflState other) {
        super(other);
    ...
    @Override public HnefataflState copy() { return new HnefataflState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HnefataflState o = (HnefataflState) other;
