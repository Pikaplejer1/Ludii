...
/** Auto-generated State subclass for HordeChess. */
public class HordeChessState extends State {
    ...
    public HordeChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HordeChessState(final HordeChessState other) {
        super(other);
    ...
    @Override public HordeChessState copy() { return new HordeChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HordeChessState o = (HordeChessState) other;
