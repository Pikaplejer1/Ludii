...
/** Auto-generated State subclass for HasamiShogi. */
public class HasamiShogiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HasamiShogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HasamiShogiState(final HasamiShogiState other) {
        super(other);
    ...
    @Override public HasamiShogiState copy() { return new HasamiShogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HasamiShogiState o = (HasamiShogiState) other;
