...
/** Auto-generated State subclass for HexTrike. */
public class HexTrikeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public HexTrikeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HexTrikeState(final HexTrikeState other) {
        super(other);
    ...
    @Override public HexTrikeState copy() { return new HexTrikeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HexTrikeState o = (HexTrikeState) other;
