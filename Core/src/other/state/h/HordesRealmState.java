...
/** Auto-generated State subclass for HordesRealm. */
public class HordesRealmState extends State {
    ...
    public HordesRealmState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HordesRealmState(final HordesRealmState other) {
        super(other);
    ...
    @Override public HordesRealmState copy() { return new HordesRealmState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HordesRealmState o = (HordesRealmState) other;
