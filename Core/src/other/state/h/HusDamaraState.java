...
/** Auto-generated State subclass for HusDamara. */
public class HusDamaraState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public HusDamaraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HusDamaraState(final HusDamaraState other) {
        super(other);
    ...
    @Override public HusDamaraState copy() { return new HusDamaraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HusDamaraState o = (HusDamaraState) other;
