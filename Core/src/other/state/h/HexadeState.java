...
/** Auto-generated State subclass for Hexade. */
public class HexadeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HexadeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HexadeState(final HexadeState other) {
        super(other);
    ...
    @Override public HexadeState copy() { return new HexadeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HexadeState o = (HexadeState) other;
