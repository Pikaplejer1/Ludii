...
/** Auto-generated State subclass for HaretavlHorsens. */
public class HaretavlHorsensState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HaretavlHorsensState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HaretavlHorsensState(final HaretavlHorsensState other) {
        super(other);
    ...
    @Override public HaretavlHorsensState copy() { return new HaretavlHorsensState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HaretavlHorsensState o = (HaretavlHorsensState) other;
