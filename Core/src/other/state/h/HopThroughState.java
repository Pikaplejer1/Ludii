...
/** Auto-generated State subclass for HopThrough. */
public class HopThroughState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HopThroughState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HopThroughState(final HopThroughState other) {
        super(other);
    ...
    @Override public HopThroughState copy() { return new HopThroughState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HopThroughState o = (HopThroughState) other;
