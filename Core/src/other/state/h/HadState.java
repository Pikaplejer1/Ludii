...
/** Auto-generated State subclass for Had. */
public class HadState extends State {
    ...
    public HadState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public HadState(final HadState other) {
        super(other);
    ...
    @Override public HadState copy() { return new HadState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HadState o = (HadState) other;
