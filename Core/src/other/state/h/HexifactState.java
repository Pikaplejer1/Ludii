...
/** Auto-generated State subclass for Hexifact. */
public class HexifactState extends State {
    ...
    public HexifactState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HexifactState(final HexifactState other) {
        super(other);
    ...
    @Override public HexifactState copy() { return new HexifactState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HexifactState o = (HexifactState) other;
