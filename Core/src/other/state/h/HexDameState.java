...
/** Auto-generated State subclass for HexDame. */
public class HexDameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HexDameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HexDameState(final HexDameState other) {
        super(other);
    ...
    @Override public HexDameState copy() { return new HexDameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HexDameState o = (HexDameState) other;
