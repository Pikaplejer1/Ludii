...
/** Auto-generated State subclass for Hufesay. */
public class HufesayState extends State {
    ...
    public HufesayState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HufesayState(final HufesayState other) {
        super(other);
    ...
    @Override public HufesayState copy() { return new HufesayState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HufesayState o = (HufesayState) other;
