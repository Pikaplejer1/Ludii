...
/** Auto-generated State subclass for HeXentafl. */
public class HeXentaflState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HeXentaflState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HeXentaflState(final HeXentaflState other) {
        super(other);
    ...
    @Override public HeXentaflState copy() { return new HeXentaflState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HeXentaflState o = (HeXentaflState) other;
