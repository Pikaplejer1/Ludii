...
/** Auto-generated State subclass for HusNama. */
public class HusNamaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public HusNamaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HusNamaState(final HusNamaState other) {
        super(other);
    ...
    @Override public HusNamaState copy() { return new HusNamaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HusNamaState o = (HusNamaState) other;
