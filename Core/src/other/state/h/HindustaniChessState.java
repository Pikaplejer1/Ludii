...
/** Auto-generated State subclass for HindustaniChess. */
public class HindustaniChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HindustaniChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HindustaniChessState(final HindustaniChessState other) {
        super(other);
    ...
    @Override public HindustaniChessState copy() { return new HindustaniChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HindustaniChessState o = (HindustaniChessState) other;
