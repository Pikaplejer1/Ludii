...
/** Auto-generated State subclass for Hexshogi. */
public class HexshogiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public HexshogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public HexshogiState(final HexshogiState other) {
        super(other);
    ...
    @Override public HexshogiState copy() { return new HexshogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final HexshogiState o = (HexshogiState) other;
