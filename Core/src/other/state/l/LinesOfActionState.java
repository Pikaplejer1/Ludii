...
/** Auto-generated State subclass for LinesOfAction. */
public class LinesOfActionState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LinesOfActionState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LinesOfActionState(final LinesOfActionState other) {
        super(other);
    ...
    @Override public LinesOfActionState copy() { return new LinesOfActionState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LinesOfActionState o = (LinesOfActionState) other;
