...
/** Auto-generated State subclass for LamWaladach. */
public class LamWaladachState extends State {
    ...
    public LamWaladachState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LamWaladachState(final LamWaladachState other) {
        super(other);
    ...
    @Override public LamWaladachState copy() { return new LamWaladachState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LamWaladachState o = (LamWaladachState) other;
