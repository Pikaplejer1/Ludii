...
/** Auto-generated State subclass for LuQi. */
public class LuQiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LuQiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LuQiState(final LuQiState other) {
        super(other);
    ...
    @Override public LuQiState copy() { return new LuQiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LuQiState o = (LuQiState) other;
