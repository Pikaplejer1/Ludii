...
/** Auto-generated State subclass for LetSCatchTheLion. */
public class LetSCatchTheLionState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LetSCatchTheLionState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LetSCatchTheLionState(final LetSCatchTheLionState other) {
        super(other);
    ...
    @Override public LetSCatchTheLionState copy() { return new LetSCatchTheLionState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LetSCatchTheLionState o = (LetSCatchTheLionState) other;
