...
/** Auto-generated State subclass for LudusLombardorum. */
public class LudusLombardorumState extends State {
    ...
    public LudusLombardorumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LudusLombardorumState(final LudusLombardorumState other) {
        super(other);
    ...
    @Override public LudusLombardorumState copy() { return new LudusLombardorumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LudusLombardorumState o = (LudusLombardorumState) other;
