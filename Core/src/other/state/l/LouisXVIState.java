...
/** Auto-generated State subclass for LouisXVI. */
public class LouisXVIState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LouisXVIState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LouisXVIState(final LouisXVIState other) {
        super(other);
    ...
    @Override public LouisXVIState copy() { return new LouisXVIState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LouisXVIState o = (LouisXVIState) other;
