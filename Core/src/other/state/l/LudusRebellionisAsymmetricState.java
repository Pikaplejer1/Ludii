...
/** Auto-generated State subclass for LudusRebellionisAsymmetric. */
public class LudusRebellionisAsymmetricState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LudusRebellionisAsymmetricState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LudusRebellionisAsymmetricState(final LudusRebellionisAsymmetricState other) {
        super(other);
    ...
    @Override public LudusRebellionisAsymmetricState copy() { return new LudusRebellionisAsymmetricState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LudusRebellionisAsymmetricState o = (LudusRebellionisAsymmetricState) other;
