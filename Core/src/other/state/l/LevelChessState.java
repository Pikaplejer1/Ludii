...
/** Auto-generated State subclass for LevelChess. */
public class LevelChessState extends State {
    ...
    public LevelChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LevelChessState(final LevelChessState other) {
        super(other);
    ...
    @Override public LevelChessState copy() { return new LevelChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LevelChessState o = (LevelChessState) other;
