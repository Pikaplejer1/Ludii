...
/** Auto-generated State subclass for LudusAnglicorum. */
public class LudusAnglicorumState extends State {
    ...
    public LudusAnglicorumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LudusAnglicorumState(final LudusAnglicorumState other) {
        super(other);
    ...
    @Override public LudusAnglicorumState copy() { return new LudusAnglicorumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LudusAnglicorumState o = (LudusAnglicorumState) other;
