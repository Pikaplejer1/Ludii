...
/** Auto-generated State subclass for LenDoat. */
public class LenDoatState extends State {
    ...
    public LenDoatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LenDoatState(final LenDoatState other) {
        super(other);
    ...
    @Override public LenDoatState copy() { return new LenDoatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LenDoatState o = (LenDoatState) other;
