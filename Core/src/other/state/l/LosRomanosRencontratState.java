...
/** Auto-generated State subclass for LosRomanosRencontrat. */
public class LosRomanosRencontratState extends State {
    ...
    public LosRomanosRencontratState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LosRomanosRencontratState(final LosRomanosRencontratState other) {
        super(other);
    ...
    @Override public LosRomanosRencontratState copy() { return new LosRomanosRencontratState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LosRomanosRencontratState o = (LosRomanosRencontratState) other;
