...
/** Auto-generated State subclass for Laquet. */
public class LaquetState extends State {
    ...
    public LaquetState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LaquetState(final LaquetState other) {
        super(other);
    ...
    @Override public LaquetState copy() { return new LaquetState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LaquetState o = (LaquetState) other;
