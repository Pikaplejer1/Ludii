...
/** Auto-generated State subclass for LoopChess. */
public class LoopChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public LoopChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LoopChessState(final LoopChessState other) {
        super(other);
    ...
    @Override public LoopChessState copy() { return new LoopChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LoopChessState o = (LoopChessState) other;
