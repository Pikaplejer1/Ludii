...
/** Auto-generated State subclass for Lotus. */
public class LotusState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LotusState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LotusState(final LotusState other) {
        super(other);
    ...
    @Override public LotusState copy() { return new LotusState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LotusState o = (LotusState) other;
