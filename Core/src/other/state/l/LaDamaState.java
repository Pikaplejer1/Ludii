...
/** Auto-generated State subclass for LaDama. */
public class LaDamaState extends State {
    ...
    public LaDamaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LaDamaState(final LaDamaState other) {
        super(other);
    ...
    @Override public LaDamaState copy() { return new LaDamaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LaDamaState o = (LaDamaState) other;
