...
/** Auto-generated State subclass for Lisolo. */
public class LisoloState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LisoloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LisoloState(final LisoloState other) {
        super(other);
    ...
    @Override public LisoloState copy() { return new LisoloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LisoloState o = (LisoloState) other;
