...
/** Auto-generated State subclass for LontuHolo. */
public class LontuHoloState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public LontuHoloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LontuHoloState(final LontuHoloState other) {
        super(other);
    ...
    @Override public LontuHoloState copy() { return new LontuHoloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LontuHoloState o = (LontuHoloState) other;
