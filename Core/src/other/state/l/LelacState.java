...
/** Auto-generated State subclass for Lelac. */
public class LelacState extends State {
    ...
    public LelacState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LelacState(final LelacState other) {
        super(other);
    ...
    @Override public LelacState copy() { return new LelacState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LelacState o = (LelacState) other;
