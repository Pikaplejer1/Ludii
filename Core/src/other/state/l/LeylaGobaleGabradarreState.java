...
/** Auto-generated State subclass for LeylaGobaleGabradarre. */
public class LeylaGobaleGabradarreState extends State {
    ...
    public LeylaGobaleGabradarreState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LeylaGobaleGabradarreState(final LeylaGobaleGabradarreState other) {
        super(other);
    ...
    @Override public LeylaGobaleGabradarreState copy() { return new LeylaGobaleGabradarreState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LeylaGobaleGabradarreState o = (LeylaGobaleGabradarreState) other;
