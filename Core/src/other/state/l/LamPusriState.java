...
/** Auto-generated State subclass for LamPusri. */
public class LamPusriState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LamPusriState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LamPusriState(final LamPusriState other) {
        super(other);
    ...
    @Override public LamPusriState copy() { return new LamPusriState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LamPusriState o = (LamPusriState) other;
