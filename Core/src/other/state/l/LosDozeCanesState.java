...
/** Auto-generated State subclass for LosDozeCanes. */
public class LosDozeCanesState extends State {
    ...
    public LosDozeCanesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LosDozeCanesState(final LosDozeCanesState other) {
        super(other);
    ...
    @Override public LosDozeCanesState copy() { return new LosDozeCanesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LosDozeCanesState o = (LosDozeCanesState) other;
