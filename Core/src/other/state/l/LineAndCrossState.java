...
/** Auto-generated State subclass for LineAndCross. */
public class LineAndCrossState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LineAndCrossState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LineAndCrossState(final LineAndCrossState other) {
        super(other);
    ...
    @Override public LineAndCrossState copy() { return new LineAndCrossState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LineAndCrossState o = (LineAndCrossState) other;
