...
/** Auto-generated State subclass for LAttaque. */
public class LAttaqueState extends State {
    ...
    public LAttaqueState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public LAttaqueState(final LAttaqueState other) {
        super(other);
    ...
    @Override public LAttaqueState copy() { return new LAttaqueState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LAttaqueState o = (LAttaqueState) other;
