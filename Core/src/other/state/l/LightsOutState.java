...
/** Auto-generated State subclass for LightsOut. */
public class LightsOutState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LightsOutState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LightsOutState(final LightsOutState other) {
        super(other);
    ...
    @Override public LightsOutState copy() { return new LightsOutState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LightsOutState o = (LightsOutState) other;
