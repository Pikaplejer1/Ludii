...
/** Auto-generated State subclass for LombardChess. */
public class LombardChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LombardChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LombardChessState(final LombardChessState other) {
        super(other);
    ...
    @Override public LombardChessState copy() { return new LombardChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LombardChessState o = (LombardChessState) other;
