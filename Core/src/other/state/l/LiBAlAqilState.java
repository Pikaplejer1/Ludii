...
/** Auto-generated State subclass for LiBAlAqil. */
public class LiBAlAqilState extends State {
    ...
    public LiBAlAqilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LiBAlAqilState(final LiBAlAqilState other) {
        super(other);
    ...
    @Override public LiBAlAqilState copy() { return new LiBAlAqilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LiBAlAqilState o = (LiBAlAqilState) other;
