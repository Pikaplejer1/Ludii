...
/** Auto-generated State subclass for LudusLatrunculorum. */
public class LudusLatrunculorumState extends State {
    ...
    public LudusLatrunculorumState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public LudusLatrunculorumState(final LudusLatrunculorumState other) {
        super(other);
    ...
    @Override public LudusLatrunculorumState copy() { return new LudusLatrunculorumState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LudusLatrunculorumState o = (LudusLatrunculorumState) other;
