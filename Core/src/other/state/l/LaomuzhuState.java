...
/** Auto-generated State subclass for Laomuzhu. */
public class LaomuzhuState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public LaomuzhuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LaomuzhuState(final LaomuzhuState other) {
        super(other);
    ...
    @Override public LaomuzhuState copy() { return new LaomuzhuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LaomuzhuState o = (LaomuzhuState) other;
