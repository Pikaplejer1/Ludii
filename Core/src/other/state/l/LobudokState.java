...
/** Auto-generated State subclass for Lobudok. */
public class LobudokState extends State {
    ...
    public LobudokState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LobudokState(final LobudokState other) {
        super(other);
    ...
    @Override public LobudokState copy() { return new LobudokState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LobudokState o = (LobudokState) other;
