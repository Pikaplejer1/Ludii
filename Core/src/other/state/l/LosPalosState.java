...
/** Auto-generated State subclass for LosPalos. */
public class LosPalosState extends State {
    ...
    public LosPalosState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LosPalosState(final LosPalosState other) {
        super(other);
    ...
    @Override public LosPalosState copy() { return new LosPalosState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LosPalosState o = (LosPalosState) other;
