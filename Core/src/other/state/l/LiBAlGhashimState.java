...
/** Auto-generated State subclass for LiBAlGhashim. */
public class LiBAlGhashimState extends State {
    ...
    public LiBAlGhashimState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LiBAlGhashimState(final LiBAlGhashimState other) {
        super(other);
    ...
    @Override public LiBAlGhashimState copy() { return new LiBAlGhashimState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LiBAlGhashimState o = (LiBAlGhashimState) other;
