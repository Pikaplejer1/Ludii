...
/** Auto-generated State subclass for LayGwetKyah. */
public class LayGwetKyahState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LayGwetKyahState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LayGwetKyahState(final LayGwetKyahState other) {
        super(other);
    ...
    @Override public LayGwetKyahState copy() { return new LayGwetKyahState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LayGwetKyahState o = (LayGwetKyahState) other;
