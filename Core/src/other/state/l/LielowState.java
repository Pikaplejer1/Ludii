...
/** Auto-generated State subclass for Lielow. */
public class LielowState extends State {
    ...
    public LielowState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LielowState(final LielowState other) {
        super(other);
    ...
    @Override public LielowState copy() { return new LielowState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LielowState o = (LielowState) other;
