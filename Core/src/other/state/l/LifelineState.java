...
/** Auto-generated State subclass for Lifeline. */
public class LifelineState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LifelineState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LifelineState(final LifelineState other) {
        super(other);
    ...
    @Override public LifelineState copy() { return new LifelineState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LifelineState o = (LifelineState) other;
