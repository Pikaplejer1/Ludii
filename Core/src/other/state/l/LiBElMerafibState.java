...
/** Auto-generated State subclass for LiBElMerafib. */
public class LiBElMerafibState extends State {
    ...
    public LiBElMerafibState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LiBElMerafibState(final LiBElMerafibState other) {
        super(other);
    ...
    @Override public LiBElMerafibState copy() { return new LiBElMerafibState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LiBElMerafibState o = (LiBElMerafibState) other;
