...
/** Auto-generated State subclass for LastEdge. */
public class LastEdgeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LastEdgeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LastEdgeState(final LastEdgeState other) {
        super(other);
    ...
    @Override public LastEdgeState copy() { return new LastEdgeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LastEdgeState o = (LastEdgeState) other;
