...
/** Auto-generated State subclass for LeylaGobaleSomaliland. */
public class LeylaGobaleSomalilandState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public LeylaGobaleSomalilandState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LeylaGobaleSomalilandState(final LeylaGobaleSomalilandState other) {
        super(other);
    ...
    @Override public LeylaGobaleSomalilandState copy() { return new LeylaGobaleSomalilandState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LeylaGobaleSomalilandState o = (LeylaGobaleSomalilandState) other;
