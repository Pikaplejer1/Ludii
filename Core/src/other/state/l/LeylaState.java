...
/** Auto-generated State subclass for Leyla. */
public class LeylaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public LeylaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LeylaState(final LeylaState other) {
        super(other);
    ...
    @Override public LeylaState copy() { return new LeylaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LeylaState o = (LeylaState) other;
