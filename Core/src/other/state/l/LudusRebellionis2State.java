...
/** Auto-generated State subclass for LudusRebellionis2. */
public class LudusRebellionis2State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LudusRebellionis2State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LudusRebellionis2State(final LudusRebellionis2State other) {
        super(other);
    ...
    @Override public LudusRebellionis2State copy() { return new LudusRebellionis2State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LudusRebellionis2State o = (LudusRebellionis2State) other;
