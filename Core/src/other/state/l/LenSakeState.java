...
/** Auto-generated State subclass for LenSake. */
public class LenSakeState extends State {
    ...
    public LenSakeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LenSakeState(final LenSakeState other) {
        super(other);
    ...
    @Override public LenSakeState copy() { return new LenSakeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LenSakeState o = (LenSakeState) other;
