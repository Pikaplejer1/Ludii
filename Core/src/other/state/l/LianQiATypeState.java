...
/** Auto-generated State subclass for LianQiAType. */
public class LianQiATypeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LianQiATypeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LianQiATypeState(final LianQiATypeState other) {
        super(other);
    ...
    @Override public LianQiATypeState copy() { return new LianQiATypeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LianQiATypeState o = (LianQiATypeState) other;
