...
/** Auto-generated State subclass for Lamosh. */
public class LamoshState extends State {
    ...
    public LamoshState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LamoshState(final LamoshState other) {
        super(other);
    ...
    @Override public LamoshState copy() { return new LamoshState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LamoshState o = (LamoshState) other;
