...
/** Auto-generated State subclass for LangePuff. */
public class LangePuffState extends State {
    ...
    public LangePuffState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public LangePuffState(final LangePuffState other) {
        super(other);
    ...
    @Override public LangePuffState copy() { return new LangePuffState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LangePuffState o = (LangePuffState) other;
