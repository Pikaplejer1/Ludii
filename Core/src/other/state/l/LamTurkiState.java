...
/** Auto-generated State subclass for LamTurki. */
public class LamTurkiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LamTurkiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LamTurkiState(final LamTurkiState other) {
        super(other);
    ...
    @Override public LamTurkiState copy() { return new LamTurkiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LamTurkiState o = (LamTurkiState) other;
