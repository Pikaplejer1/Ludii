...
/** Auto-generated State subclass for LenCuaKinNgoa. */
public class LenCuaKinNgoaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public LenCuaKinNgoaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public LenCuaKinNgoaState(final LenCuaKinNgoaState other) {
        super(other);
    ...
    @Override public LenCuaKinNgoaState copy() { return new LenCuaKinNgoaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final LenCuaKinNgoaState o = (LenCuaKinNgoaState) other;
