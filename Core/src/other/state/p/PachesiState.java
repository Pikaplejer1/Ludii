...
/** Auto-generated State subclass for Pachesi. */
public class PachesiState extends State {
    ...
    public PachesiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PachesiState(final PachesiState other) {
        super(other);
    ...
    @Override public PachesiState copy() { return new PachesiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PachesiState o = (PachesiState) other;
