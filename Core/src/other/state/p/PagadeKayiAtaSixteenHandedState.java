...
/** Auto-generated State subclass for PagadeKayiAtaSixteenHanded. */
public class PagadeKayiAtaSixteenHandedState extends State {
    ...
    public PagadeKayiAtaSixteenHandedState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PagadeKayiAtaSixteenHandedState(final PagadeKayiAtaSixteenHandedState other) {
        super(other);
    ...
    @Override public PagadeKayiAtaSixteenHandedState copy() { return new PagadeKayiAtaSixteenHandedState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PagadeKayiAtaSixteenHandedState o = (PagadeKayiAtaSixteenHandedState) other;
