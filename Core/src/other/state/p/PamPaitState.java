...
/** Auto-generated State subclass for PamPait. */
public class PamPaitState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PamPaitState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PamPaitState(final PamPaitState other) {
        super(other);
    ...
    @Override public PamPaitState copy() { return new PamPaitState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PamPaitState o = (PamPaitState) other;
