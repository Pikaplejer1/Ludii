...
/** Auto-generated State subclass for Pasa. */
public class PasaState extends State {
    ...
    public PasaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasaState(final PasaState other) {
        super(other);
    ...
    @Override public PasaState copy() { return new PasaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasaState o = (PasaState) other;
