...
/** Auto-generated State subclass for Polypods. */
public class PolypodsState extends State {
    ...
    public PolypodsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PolypodsState(final PolypodsState other) {
        super(other);
    ...
    @Override public PolypodsState copy() { return new PolypodsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PolypodsState o = (PolypodsState) other;
