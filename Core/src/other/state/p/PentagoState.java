...
/** Auto-generated State subclass for Pentago. */
public class PentagoState extends State {
    ...
    public PentagoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PentagoState(final PentagoState other) {
        super(other);
    ...
    @Override public PentagoState copy() { return new PentagoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PentagoState o = (PentagoState) other;
