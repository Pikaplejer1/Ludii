...
/** Auto-generated State subclass for Patol. */
public class PatolState extends State {
    ...
    public PatolState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PatolState(final PatolState other) {
        super(other);
    ...
    @Override public PatolState copy() { return new PatolState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PatolState o = (PatolState) other;
