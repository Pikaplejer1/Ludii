...
/** Auto-generated State subclass for Puhulmutu. */
public class PuhulmutuState extends State {
    ...
    public PuhulmutuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PuhulmutuState(final PuhulmutuState other) {
        super(other);
    ...
    @Override public PuhulmutuState copy() { return new PuhulmutuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PuhulmutuState o = (PuhulmutuState) other;
