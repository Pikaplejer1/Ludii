...
/** Auto-generated State subclass for PasakakridaType5. */
public class PasakakridaType5State extends State {
    ...
    public PasakakridaType5State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType5State(final PasakakridaType5State other) {
        super(other);
    ...
    @Override public PasakakridaType5State copy() { return new PasakakridaType5State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType5State o = (PasakakridaType5State) other;
