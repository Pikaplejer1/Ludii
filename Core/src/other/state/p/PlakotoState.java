...
/** Auto-generated State subclass for Plakoto. */
public class PlakotoState extends State {
    ...
    public PlakotoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PlakotoState(final PlakotoState other) {
        super(other);
    ...
    @Override public PlakotoState copy() { return new PlakotoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PlakotoState o = (PlakotoState) other;
