...
/** Auto-generated State subclass for Provincial. */
public class ProvincialState extends State {
    ...
    public ProvincialState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ProvincialState(final ProvincialState other) {
        super(other);
    ...
    @Override public ProvincialState copy() { return new ProvincialState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ProvincialState o = (ProvincialState) other;
