...
/** Auto-generated State subclass for Pretwa. */
public class PretwaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PretwaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PretwaState(final PretwaState other) {
        super(other);
    ...
    @Override public PretwaState copy() { return new PretwaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PretwaState o = (PretwaState) other;
