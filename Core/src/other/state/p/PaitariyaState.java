...
/** Auto-generated State subclass for Paitariya. */
public class PaitariyaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PaitariyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PaitariyaState(final PaitariyaState other) {
        super(other);
    ...
    @Override public PaitariyaState copy() { return new PaitariyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PaitariyaState o = (PaitariyaState) other;
