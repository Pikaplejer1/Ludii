...
/** Auto-generated State subclass for Patok. */
public class PatokState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PatokState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PatokState(final PatokState other) {
        super(other);
    ...
    @Override public PatokState copy() { return new PatokState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PatokState o = (PatokState) other;
