...
/** Auto-generated State subclass for Pallankuli. */
public class PallankuliState extends State {
    ...
    public PallankuliState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PallankuliState(final PallankuliState other) {
        super(other);
    ...
    @Override public PallankuliState copy() { return new PallankuliState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PallankuliState o = (PallankuliState) other;
