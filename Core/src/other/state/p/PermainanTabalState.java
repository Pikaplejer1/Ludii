...
/** Auto-generated State subclass for PermainanTabal. */
public class PermainanTabalState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PermainanTabalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PermainanTabalState(final PermainanTabalState other) {
        super(other);
    ...
    @Override public PermainanTabalState copy() { return new PermainanTabalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PermainanTabalState o = (PermainanTabalState) other;
