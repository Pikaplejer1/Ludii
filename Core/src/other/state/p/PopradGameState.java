...
/** Auto-generated State subclass for PopradGame. */
public class PopradGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PopradGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PopradGameState(final PopradGameState other) {
        super(other);
    ...
    @Override public PopradGameState copy() { return new PopradGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PopradGameState o = (PopradGameState) other;
