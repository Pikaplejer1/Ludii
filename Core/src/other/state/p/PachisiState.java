...
/** Auto-generated State subclass for Pachisi. */
public class PachisiState extends State {
    ...
    public PachisiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PachisiState(final PachisiState other) {
        super(other);
    ...
    @Override public PachisiState copy() { return new PachisiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PachisiState o = (PachisiState) other;
