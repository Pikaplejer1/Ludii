...
/** Auto-generated State subclass for PasakakridaType1. */
public class PasakakridaType1State extends State {
    ...
    public PasakakridaType1State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType1State(final PasakakridaType1State other) {
        super(other);
    ...
    @Override public PasakakridaType1State copy() { return new PasakakridaType1State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType1State o = (PasakakridaType1State) other;
