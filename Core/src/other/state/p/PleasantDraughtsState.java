...
/** Auto-generated State subclass for PleasantDraughts. */
public class PleasantDraughtsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PleasantDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PleasantDraughtsState(final PleasantDraughtsState other) {
        super(other);
    ...
    @Override public PleasantDraughtsState copy() { return new PleasantDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PleasantDraughtsState o = (PleasantDraughtsState) other;
