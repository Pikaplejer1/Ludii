...
/** Auto-generated State subclass for PasakakridaType3. */
public class PasakakridaType3State extends State {
    ...
    public PasakakridaType3State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType3State(final PasakakridaType3State other) {
        super(other);
    ...
    @Override public PasakakridaType3State copy() { return new PasakakridaType3State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType3State o = (PasakakridaType3State) other;
