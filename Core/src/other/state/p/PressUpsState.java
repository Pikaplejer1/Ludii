...
/** Auto-generated State subclass for PressUps. */
public class PressUpsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PressUpsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PressUpsState(final PressUpsState other) {
        super(other);
    ...
    @Override public PressUpsState copy() { return new PressUpsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PressUpsState o = (PressUpsState) other;
