...
/** Auto-generated State subclass for PanchaKeliya. */
public class PanchaKeliyaState extends State {
    ...
    public PanchaKeliyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PanchaKeliyaState(final PanchaKeliyaState other) {
        super(other);
    ...
    @Override public PanchaKeliyaState copy() { return new PanchaKeliyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PanchaKeliyaState o = (PanchaKeliyaState) other;
