...
/** Auto-generated State subclass for Pachih. */
public class PachihState extends State {
    ...
    public PachihState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PachihState(final PachihState other) {
        super(other);
    ...
    @Override public PachihState copy() { return new PachihState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PachihState o = (PachihState) other;
