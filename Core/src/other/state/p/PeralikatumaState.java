...
/** Auto-generated State subclass for Peralikatuma. */
public class PeralikatumaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PeralikatumaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PeralikatumaState(final PeralikatumaState other) {
        super(other);
    ...
    @Override public PeralikatumaState copy() { return new PeralikatumaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PeralikatumaState o = (PeralikatumaState) other;
