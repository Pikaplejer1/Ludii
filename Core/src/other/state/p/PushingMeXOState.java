...
/** Auto-generated State subclass for PushingMeXO. */
public class PushingMeXOState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PushingMeXOState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PushingMeXOState(final PushingMeXOState other) {
        super(other);
    ...
    @Override public PushingMeXOState copy() { return new PushingMeXOState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PushingMeXOState o = (PushingMeXOState) other;
