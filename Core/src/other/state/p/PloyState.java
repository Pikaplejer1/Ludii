...
/** Auto-generated State subclass for Ploy. */
public class PloyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PloyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PloyState(final PloyState other) {
        super(other);
    ...
    @Override public PloyState copy() { return new PloyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PloyState o = (PloyState) other;
