...
/** Auto-generated State subclass for Panchi. */
public class PanchiState extends State {
    ...
    public PanchiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PanchiState(final PanchiState other) {
        super(other);
    ...
    @Override public PanchiState copy() { return new PanchiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PanchiState o = (PanchiState) other;
