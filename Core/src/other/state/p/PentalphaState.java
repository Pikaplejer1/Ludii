...
/** Auto-generated State subclass for Pentalpha. */
public class PentalphaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PentalphaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PentalphaState(final PentalphaState other) {
        super(other);
    ...
    @Override public PentalphaState copy() { return new PentalphaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PentalphaState o = (PentalphaState) other;
