...
/** Auto-generated State subclass for ParsiChess. */
public class ParsiChessState extends State {
    ...
    public ParsiChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ParsiChessState(final ParsiChessState other) {
        super(other);
    ...
    @Override public ParsiChessState copy() { return new ParsiChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ParsiChessState o = (ParsiChessState) other;
