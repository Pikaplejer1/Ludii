...
/** Auto-generated State subclass for PasakakridaType4. */
public class PasakakridaType4State extends State {
    ...
    public PasakakridaType4State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType4State(final PasakakridaType4State other) {
        super(other);
    ...
    @Override public PasakakridaType4State copy() { return new PasakakridaType4State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType4State o = (PasakakridaType4State) other;
