...
/** Auto-generated State subclass for Pyrga. */
public class PyrgaState extends State {
    ...
    public PyrgaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PyrgaState(final PyrgaState other) {
        super(other);
    ...
    @Override public PyrgaState copy() { return new PyrgaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PyrgaState o = (PyrgaState) other;
