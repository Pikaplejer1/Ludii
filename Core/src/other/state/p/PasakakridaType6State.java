...
/** Auto-generated State subclass for PasakakridaType6. */
public class PasakakridaType6State extends State {
    ...
    public PasakakridaType6State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType6State(final PasakakridaType6State other) {
        super(other);
    ...
    @Override public PasakakridaType6State copy() { return new PasakakridaType6State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType6State o = (PasakakridaType6State) other;
