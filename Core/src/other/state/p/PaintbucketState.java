...
/** Auto-generated State subclass for Paintbucket. */
public class PaintbucketState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PaintbucketState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PaintbucketState(final PaintbucketState other) {
        super(other);
    ...
    @Override public PaintbucketState copy() { return new PaintbucketState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PaintbucketState o = (PaintbucketState) other;
