...
/** Auto-generated State subclass for Paradis. */
public class ParadisState extends State {
    ...
    public ParadisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ParadisState(final ParadisState other) {
        super(other);
    ...
    @Override public ParadisState copy() { return new ParadisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ParadisState o = (ParadisState) other;
