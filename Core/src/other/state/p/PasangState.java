...
/** Auto-generated State subclass for Pasang. */
public class PasangState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PasangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PasangState(final PasangState other) {
        super(other);
    ...
    @Override public PasangState copy() { return new PasangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasangState o = (PasangState) other;
