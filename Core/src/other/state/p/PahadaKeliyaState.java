...
/** Auto-generated State subclass for PahadaKeliya. */
public class PahadaKeliyaState extends State {
    ...
    public PahadaKeliyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PahadaKeliyaState(final PahadaKeliyaState other) {
        super(other);
    ...
    @Override public PahadaKeliyaState copy() { return new PahadaKeliyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PahadaKeliyaState o = (PahadaKeliyaState) other;
