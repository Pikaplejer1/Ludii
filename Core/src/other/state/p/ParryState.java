...
/** Auto-generated State subclass for Parry. */
public class ParryState extends State {
    ...
    public ParryState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ParryState(final ParryState other) {
        super(other);
    ...
    @Override public ParryState copy() { return new ParryState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ParryState o = (ParryState) other;
