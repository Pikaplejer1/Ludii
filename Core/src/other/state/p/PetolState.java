...
/** Auto-generated State subclass for Petol. */
public class PetolState extends State {
    ...
    public PetolState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PetolState(final PetolState other) {
        super(other);
    ...
    @Override public PetolState copy() { return new PetolState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PetolState o = (PetolState) other;
