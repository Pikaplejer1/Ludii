...
/** Auto-generated State subclass for Puma. */
public class PumaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public PumaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PumaState(final PumaState other) {
        super(other);
    ...
    @Override public PumaState copy() { return new PumaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PumaState o = (PumaState) other;
