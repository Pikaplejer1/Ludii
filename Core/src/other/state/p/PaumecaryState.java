...
/** Auto-generated State subclass for Paumecary. */
public class PaumecaryState extends State {
    ...
    public PaumecaryState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PaumecaryState(final PaumecaryState other) {
        super(other);
    ...
    @Override public PaumecaryState copy() { return new PaumecaryState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PaumecaryState o = (PaumecaryState) other;
