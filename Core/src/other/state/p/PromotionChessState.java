...
/** Auto-generated State subclass for PromotionChess. */
public class PromotionChessState extends State {
    ...
    public PromotionChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PromotionChessState(final PromotionChessState other) {
        super(other);
    ...
    @Override public PromotionChessState copy() { return new PromotionChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PromotionChessState o = (PromotionChessState) other;
