...
/** Auto-generated State subclass for Piprjall. */
public class PiprjallState extends State {
    ...
    public PiprjallState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PiprjallState(final PiprjallState other) {
        super(other);
    ...
    @Override public PiprjallState copy() { return new PiprjallState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PiprjallState o = (PiprjallState) other;
