...
/** Auto-generated State subclass for PapanDakon. */
public class PapanDakonState extends State {
    ...
    public PapanDakonState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PapanDakonState(final PapanDakonState other) {
        super(other);
    ...
    @Override public PapanDakonState copy() { return new PapanDakonState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PapanDakonState o = (PapanDakonState) other;
