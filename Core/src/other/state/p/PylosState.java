...
/** Auto-generated State subclass for Pylos. */
public class PylosState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public PylosState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PylosState(final PylosState other) {
        super(other);
    ...
    @Override public PylosState copy() { return new PylosState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PylosState o = (PylosState) other;
