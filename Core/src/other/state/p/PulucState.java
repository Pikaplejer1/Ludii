...
/** Auto-generated State subclass for Puluc. */
public class PulucState extends State {
    ...
    public PulucState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PulucState(final PulucState other) {
        super(other);
    ...
    @Override public PulucState copy() { return new PulucState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PulucState o = (PulucState) other;
