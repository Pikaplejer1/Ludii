...
/** Auto-generated State subclass for PippinzipZiplineVariant. */
public class PippinzipZiplineVariantState extends State {
    ...
    public PippinzipZiplineVariantState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public PippinzipZiplineVariantState(final PippinzipZiplineVariantState other) {
        super(other);
    ...
    @Override public PippinzipZiplineVariantState copy() { return new PippinzipZiplineVariantState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PippinzipZiplineVariantState o = (PippinzipZiplineVariantState) other;
