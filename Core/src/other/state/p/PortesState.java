...
/** Auto-generated State subclass for Portes. */
public class PortesState extends State {
    ...
    public PortesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PortesState(final PortesState other) {
        super(other);
    ...
    @Override public PortesState copy() { return new PortesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PortesState o = (PortesState) other;
