...
/** Auto-generated State subclass for Pereauni. */
public class PereauniState extends State {
    ...
    public PereauniState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PereauniState(final PereauniState other) {
        super(other);
    ...
    @Override public PereauniState copy() { return new PereauniState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PereauniState o = (PereauniState) other;
