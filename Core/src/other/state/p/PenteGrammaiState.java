...
/** Auto-generated State subclass for PenteGrammai. */
public class PenteGrammaiState extends State {
    ...
    public PenteGrammaiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PenteGrammaiState(final PenteGrammaiState other) {
        super(other);
    ...
    @Override public PenteGrammaiState copy() { return new PenteGrammaiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PenteGrammaiState o = (PenteGrammaiState) other;
