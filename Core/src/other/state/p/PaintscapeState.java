...
/** Auto-generated State subclass for Paintscape. */
public class PaintscapeState extends State {
    ...
    public PaintscapeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PaintscapeState(final PaintscapeState other) {
        super(other);
    ...
    @Override public PaintscapeState copy() { return new PaintscapeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PaintscapeState o = (PaintscapeState) other;
