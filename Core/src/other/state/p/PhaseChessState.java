...
/** Auto-generated State subclass for PhaseChess. */
public class PhaseChessState extends State {
    ...
    public PhaseChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public PhaseChessState(final PhaseChessState other) {
        super(other);
    ...
    @Override public PhaseChessState copy() { return new PhaseChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PhaseChessState o = (PhaseChessState) other;
