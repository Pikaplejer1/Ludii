...
/** Auto-generated State subclass for PasakakridaType2. */
public class PasakakridaType2State extends State {
    ...
    public PasakakridaType2State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public PasakakridaType2State(final PasakakridaType2State other) {
        super(other);
    ...
    @Override public PasakakridaType2State copy() { return new PasakakridaType2State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final PasakakridaType2State o = (PasakakridaType2State) other;
