...
/** Auto-generated State subclass for Dimraw. */
public class DimrawState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DimrawState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DimrawState(final DimrawState other) {
        super(other);
    ...
    @Override public DimrawState copy() { return new DimrawState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DimrawState o = (DimrawState) other;
