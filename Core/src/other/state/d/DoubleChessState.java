...
/** Auto-generated State subclass for DoubleChess. */
public class DoubleChessState extends State {
    ...
    public DoubleChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DoubleChessState(final DoubleChessState other) {
        super(other);
    ...
    @Override public DoubleChessState copy() { return new DoubleChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DoubleChessState o = (DoubleChessState) other;
