...
/** Auto-generated State subclass for Damat. */
public class DamatState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamatState(final DamatState other) {
        super(other);
    ...
    @Override public DamatState copy() { return new DamatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamatState o = (DamatState) other;
