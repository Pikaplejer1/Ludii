...
/** Auto-generated State subclass for DablotPrejjesne. */
public class DablotPrejjesneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DablotPrejjesneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DablotPrejjesneState(final DablotPrejjesneState other) {
        super(other);
    ...
    @Override public DablotPrejjesneState copy() { return new DablotPrejjesneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DablotPrejjesneState o = (DablotPrejjesneState) other;
