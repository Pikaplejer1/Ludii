...
/** Auto-generated State subclass for Dama. */
public class DamaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamaState(final DamaState other) {
        super(other);
    ...
    @Override public DamaState copy() { return new DamaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamaState o = (DamaState) other;
