...
/** Auto-generated State subclass for Dam. */
public class DamState extends State {
    ...
    public DamState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamState(final DamState other) {
        super(other);
    ...
    @Override public DamState copy() { return new DamState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamState o = (DamState) other;
