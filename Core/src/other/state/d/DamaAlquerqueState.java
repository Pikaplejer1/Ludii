...
/** Auto-generated State subclass for DamaAlquerque. */
public class DamaAlquerqueState extends State {
    ...
    public DamaAlquerqueState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamaAlquerqueState(final DamaAlquerqueState other) {
        super(other);
    ...
    @Override public DamaAlquerqueState copy() { return new DamaAlquerqueState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamaAlquerqueState o = (DamaAlquerqueState) other;
