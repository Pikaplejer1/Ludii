...
/** Auto-generated State subclass for DoubleRunStone. */
public class DoubleRunStoneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DoubleRunStoneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DoubleRunStoneState(final DoubleRunStoneState other) {
        super(other);
    ...
    @Override public DoubleRunStoneState copy() { return new DoubleRunStoneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DoubleRunStoneState o = (DoubleRunStoneState) other;
