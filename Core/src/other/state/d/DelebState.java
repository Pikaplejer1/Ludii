...
/** Auto-generated State subclass for Deleb. */
public class DelebState extends State {
    ...
    public DelebState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DelebState(final DelebState other) {
        super(other);
    ...
    @Override public DelebState copy() { return new DelebState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DelebState o = (DelebState) other;
