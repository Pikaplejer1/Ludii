...
/** Auto-generated State subclass for DefectorY. */
public class DefectorYState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DefectorYState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DefectorYState(final DefectorYState other) {
        super(other);
    ...
    @Override public DefectorYState copy() { return new DefectorYState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DefectorYState o = (DefectorYState) other;
