...
/** Auto-generated State subclass for Dragonchess. */
public class DragonchessState extends State {
    ...
    public DragonchessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DragonchessState(final DragonchessState other) {
        super(other);
    ...
    @Override public DragonchessState copy() { return new DragonchessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DragonchessState o = (DragonchessState) other;
