...
/** Auto-generated State subclass for DiceShogi. */
public class DiceShogiState extends State {
    ...
    public DiceShogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DiceShogiState(final DiceShogiState other) {
        super(other);
    ...
    @Override public DiceShogiState copy() { return new DiceShogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DiceShogiState o = (DiceShogiState) other;
