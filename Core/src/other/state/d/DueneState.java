...
/** Auto-generated State subclass for Duene. */
public class DueneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DueneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DueneState(final DueneState other) {
        super(other);
    ...
    @Override public DueneState copy() { return new DueneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DueneState o = (DueneState) other;
