...
/** Auto-generated State subclass for DamHariman. */
public class DamHarimanState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamHarimanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamHarimanState(final DamHarimanState other) {
        super(other);
    ...
    @Override public DamHarimanState copy() { return new DamHarimanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamHarimanState o = (DamHarimanState) other;
