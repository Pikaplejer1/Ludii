...
/** Auto-generated State subclass for DogtownClans. */
public class DogtownClansState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DogtownClansState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DogtownClansState(final DogtownClansState other) {
        super(other);
    ...
    @Override public DogtownClansState copy() { return new DogtownClansState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DogtownClansState o = (DogtownClansState) other;
