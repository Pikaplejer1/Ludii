...
/** Auto-generated State subclass for DiagonalDraughts. */
public class DiagonalDraughtsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DiagonalDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DiagonalDraughtsState(final DiagonalDraughtsState other) {
        super(other);
    ...
    @Override public DiagonalDraughtsState copy() { return new DiagonalDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DiagonalDraughtsState o = (DiagonalDraughtsState) other;
