...
/** Auto-generated State subclass for DamaComoros. */
public class DamaComorosState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamaComorosState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamaComorosState(final DamaComorosState other) {
        super(other);
    ...
    @Override public DamaComorosState copy() { return new DamaComorosState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamaComorosState o = (DamaComorosState) other;
