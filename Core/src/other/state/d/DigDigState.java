...
/** Auto-generated State subclass for DigDig. */
public class DigDigState extends State {
    ...
    public DigDigState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DigDigState(final DigDigState other) {
        super(other);
    ...
    @Override public DigDigState copy() { return new DigDigState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DigDigState o = (DigDigState) other;
