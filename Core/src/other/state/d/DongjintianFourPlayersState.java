...
/** Auto-generated State subclass for DongjintianFourPlayers. */
public class DongjintianFourPlayersState extends State {
    ...
    public DongjintianFourPlayersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DongjintianFourPlayersState(final DongjintianFourPlayersState other) {
        super(other);
    ...
    @Override public DongjintianFourPlayersState copy() { return new DongjintianFourPlayersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DongjintianFourPlayersState o = (DongjintianFourPlayersState) other;
