...
/** Auto-generated State subclass for Doblet. */
public class DobletState extends State {
    ...
    public DobletState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DobletState(final DobletState other) {
        super(other);
    ...
    @Override public DobletState copy() { return new DobletState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DobletState o = (DobletState) other;
