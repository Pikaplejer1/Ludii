...
/** Auto-generated State subclass for Dame. */
public class DameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DameState(final DameState other) {
        super(other);
    ...
    @Override public DameState copy() { return new DameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DameState o = (DameState) other;
