...
/** Auto-generated State subclass for DonTMoseyAndTheLastScavenger. */
public class DonTMoseyAndTheLastScavengerState extends State {
    ...
    public DonTMoseyAndTheLastScavengerState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DonTMoseyAndTheLastScavengerState(final DonTMoseyAndTheLastScavengerState other) {
        super(other);
    ...
    @Override public DonTMoseyAndTheLastScavengerState copy() { return new DonTMoseyAndTheLastScavengerState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DonTMoseyAndTheLastScavengerState o = (DonTMoseyAndTheLastScavengerState) other;
