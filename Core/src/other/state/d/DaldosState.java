...
/** Auto-generated State subclass for Daldos. */
public class DaldosState extends State {
    ...
    public DaldosState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DaldosState(final DaldosState other) {
        super(other);
    ...
    @Override public DaldosState copy() { return new DaldosState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DaldosState o = (DaldosState) other;
