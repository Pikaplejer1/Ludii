...
/** Auto-generated State subclass for Duqurjin. */
public class DuqurjinState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DuqurjinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DuqurjinState(final DuqurjinState other) {
        super(other);
    ...
    @Override public DuqurjinState copy() { return new DuqurjinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DuqurjinState o = (DuqurjinState) other;
