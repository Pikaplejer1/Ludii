...
/** Auto-generated State subclass for DeVasaChess. */
public class DeVasaChessState extends State {
    ...
    public DeVasaChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DeVasaChessState(final DeVasaChessState other) {
        super(other);
    ...
    @Override public DeVasaChessState copy() { return new DeVasaChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DeVasaChessState o = (DeVasaChessState) other;
