...
/** Auto-generated State subclass for DorvonCag. */
public class DorvonCagState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DorvonCagState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DorvonCagState(final DorvonCagState other) {
        super(other);
    ...
    @Override public DorvonCagState copy() { return new DorvonCagState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DorvonCagState o = (DorvonCagState) other;
