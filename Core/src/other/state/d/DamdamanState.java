...
/** Auto-generated State subclass for Damdaman. */
public class DamdamanState extends State {
    ...
    public DamdamanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DamdamanState(final DamdamanState other) {
        super(other);
    ...
    @Override public DamdamanState copy() { return new DamdamanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamdamanState o = (DamdamanState) other;
