...
/** Auto-generated State subclass for Daldosa. */
public class DaldosaState extends State {
    ...
    public DaldosaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DaldosaState(final DaldosaState other) {
        super(other);
    ...
    @Override public DaldosaState copy() { return new DaldosaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DaldosaState o = (DaldosaState) other;
