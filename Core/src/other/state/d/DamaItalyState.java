...
/** Auto-generated State subclass for DamaItaly. */
public class DamaItalyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamaItalyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamaItalyState(final DamaItalyState other) {
        super(other);
    ...
    @Override public DamaItalyState copy() { return new DamaItalyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamaItalyState o = (DamaItalyState) other;
