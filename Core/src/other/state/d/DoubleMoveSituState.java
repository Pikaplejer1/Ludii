...
/** Auto-generated State subclass for DoubleMoveSitu. */
public class DoubleMoveSituState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DoubleMoveSituState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DoubleMoveSituState(final DoubleMoveSituState other) {
        super(other);
    ...
    @Override public DoubleMoveSituState copy() { return new DoubleMoveSituState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DoubleMoveSituState o = (DoubleMoveSituState) other;
