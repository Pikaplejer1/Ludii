...
/** Auto-generated State subclass for Dubblets. */
public class DubbletsState extends State {
    ...
    public DubbletsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DubbletsState(final DubbletsState other) {
        super(other);
    ...
    @Override public DubbletsState copy() { return new DubbletsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DubbletsState o = (DubbletsState) other;
