...
/** Auto-generated State subclass for DumBlas. */
public class DumBlasState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DumBlasState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DumBlasState(final DumBlasState other) {
        super(other);
    ...
    @Override public DumBlasState copy() { return new DumBlasState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DumBlasState o = (DumBlasState) other;
