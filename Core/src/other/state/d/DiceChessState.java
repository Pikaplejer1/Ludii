...
/** Auto-generated State subclass for DiceChess. */
public class DiceChessState extends State {
    ...
    public DiceChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public DiceChessState(final DiceChessState other) {
        super(other);
    ...
    @Override public DiceChessState copy() { return new DiceChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DiceChessState o = (DiceChessState) other;
