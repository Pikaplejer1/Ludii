...
/** Auto-generated State subclass for Diaballik. */
public class DiaballikState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DiaballikState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DiaballikState(final DiaballikState other) {
        super(other);
    ...
    @Override public DiaballikState copy() { return new DiaballikState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DiaballikState o = (DiaballikState) other;
