...
/** Auto-generated State subclass for DamaKenya. */
public class DamaKenyaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DamaKenyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DamaKenyaState(final DamaKenyaState other) {
        super(other);
    ...
    @Override public DamaKenyaState copy() { return new DamaKenyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DamaKenyaState o = (DamaKenyaState) other;
