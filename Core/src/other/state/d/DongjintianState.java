...
/** Auto-generated State subclass for Dongjintian. */
public class DongjintianState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DongjintianState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DongjintianState(final DongjintianState other) {
        super(other);
    ...
    @Override public DongjintianState copy() { return new DongjintianState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DongjintianState o = (DongjintianState) other;
