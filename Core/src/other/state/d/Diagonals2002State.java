...
/** Auto-generated State subclass for Diagonals2002. */
public class Diagonals2002State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public Diagonals2002State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public Diagonals2002State(final Diagonals2002State other) {
        super(other);
    ...
    @Override public Diagonals2002State copy() { return new Diagonals2002State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final Diagonals2002State o = (Diagonals2002State) other;
