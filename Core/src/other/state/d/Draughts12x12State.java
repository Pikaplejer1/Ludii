...
/** Auto-generated State subclass for Draughts12x12. */
public class Draughts12x12State extends State {
    ...
    public Draughts12x12State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public Draughts12x12State(final Draughts12x12State other) {
        super(other);
    ...
    @Override public Draughts12x12State copy() { return new Draughts12x12State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final Draughts12x12State o = (Draughts12x12State) other;
