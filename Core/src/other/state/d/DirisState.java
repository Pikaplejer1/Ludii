...
/** Auto-generated State subclass for Diris. */
public class DirisState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DirisState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DirisState(final DirisState other) {
        super(other);
    ...
    @Override public DirisState copy() { return new DirisState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DirisState o = (DirisState) other;
