...
/** Auto-generated State subclass for DaiHasamiShogi. */
public class DaiHasamiShogiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DaiHasamiShogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DaiHasamiShogiState(final DaiHasamiShogiState other) {
        super(other);
    ...
    @Override public DaiHasamiShogiState copy() { return new DaiHasamiShogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DaiHasamiShogiState o = (DaiHasamiShogiState) other;
