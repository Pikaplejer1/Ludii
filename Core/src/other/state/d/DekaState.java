...
/** Auto-generated State subclass for Deka. */
public class DekaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public DekaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DekaState(final DekaState other) {
        super(other);
    ...
    @Override public DekaState copy() { return new DekaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DekaState o = (DekaState) other;
