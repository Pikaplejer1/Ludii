...
/** Auto-generated State subclass for Daramuti. */
public class DaramutiState extends State {
    ...
    public DaramutiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DaramutiState(final DaramutiState other) {
        super(other);
    ...
    @Override public DaramutiState copy() { return new DaramutiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DaramutiState o = (DaramutiState) other;
