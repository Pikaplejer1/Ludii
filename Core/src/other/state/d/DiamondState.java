...
/** Auto-generated State subclass for Diamond. */
public class DiamondState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public DiamondState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public DiamondState(final DiamondState other) {
        super(other);
    ...
    @Override public DiamondState copy() { return new DiamondState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final DiamondState o = (DiamondState) other;
