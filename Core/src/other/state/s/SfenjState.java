...
/** Auto-generated State subclass for Sfenj. */
public class SfenjState extends State {
    ...
    public SfenjState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SfenjState(final SfenjState other) {
        super(other);
    ...
    @Override public SfenjState copy() { return new SfenjState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SfenjState o = (SfenjState) other;
