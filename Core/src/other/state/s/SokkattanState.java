...
/** Auto-generated State subclass for Sokkattan. */
public class SokkattanState extends State {
    ...
    public SokkattanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SokkattanState(final SokkattanState other) {
        super(other);
    ...
    @Override public SokkattanState copy() { return new SokkattanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SokkattanState o = (SokkattanState) other;
