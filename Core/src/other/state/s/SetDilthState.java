...
/** Auto-generated State subclass for SetDilth. */
public class SetDilthState extends State {
    ...
    public SetDilthState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SetDilthState(final SetDilthState other) {
        super(other);
    ...
    @Override public SetDilthState copy() { return new SetDilthState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SetDilthState o = (SetDilthState) other;
