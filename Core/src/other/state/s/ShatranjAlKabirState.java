...
/** Auto-generated State subclass for ShatranjAlKabir. */
public class ShatranjAlKabirState extends State {
    ...
    public ShatranjAlKabirState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAlKabirState(final ShatranjAlKabirState other) {
        super(other);
    ...
    @Override public ShatranjAlKabirState copy() { return new ShatranjAlKabirState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlKabirState o = (ShatranjAlKabirState) other;
