...
/** Auto-generated State subclass for SigElOuedCapture. */
public class SigElOuedCaptureState extends State {
    ...
    public SigElOuedCaptureState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigElOuedCaptureState(final SigElOuedCaptureState other) {
        super(other);
    ...
    @Override public SigElOuedCaptureState copy() { return new SigElOuedCaptureState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigElOuedCaptureState o = (SigElOuedCaptureState) other;
