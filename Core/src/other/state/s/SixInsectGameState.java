...
/** Auto-generated State subclass for SixInsectGame. */
public class SixInsectGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SixInsectGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SixInsectGameState(final SixInsectGameState other) {
        super(other);
    ...
    @Override public SixInsectGameState copy() { return new SixInsectGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SixInsectGameState o = (SixInsectGameState) other;
