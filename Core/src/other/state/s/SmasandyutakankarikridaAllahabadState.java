...
/** Auto-generated State subclass for SmasandyutakankarikridaAllahabad. */
public class SmasandyutakankarikridaAllahabadState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SmasandyutakankarikridaAllahabadState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SmasandyutakankarikridaAllahabadState(final SmasandyutakankarikridaAllahabadState other) {
        super(other);
    ...
    @Override public SmasandyutakankarikridaAllahabadState copy() { return new SmasandyutakankarikridaAllahabadState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SmasandyutakankarikridaAllahabadState o = (SmasandyutakankarikridaAllahabadState) other;
