...
/** Auto-generated State subclass for SweepBurrow. */
public class SweepBurrowState extends State {
    ...
    public SweepBurrowState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SweepBurrowState(final SweepBurrowState other) {
        super(other);
    ...
    @Override public SweepBurrowState copy() { return new SweepBurrowState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SweepBurrowState o = (SweepBurrowState) other;
