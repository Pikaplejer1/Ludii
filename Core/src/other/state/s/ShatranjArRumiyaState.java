...
/** Auto-generated State subclass for ShatranjArRumiya. */
public class ShatranjArRumiyaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjArRumiyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjArRumiyaState(final ShatranjArRumiyaState other) {
        super(other);
    ...
    @Override public ShatranjArRumiyaState copy() { return new ShatranjArRumiyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjArRumiyaState o = (ShatranjArRumiyaState) other;
