...
/** Auto-generated State subclass for ShakhmatyEarlyModern. */
public class ShakhmatyEarlyModernState extends State {
    ...
    public ShakhmatyEarlyModernState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShakhmatyEarlyModernState(final ShakhmatyEarlyModernState other) {
        super(other);
    ...
    @Override public ShakhmatyEarlyModernState copy() { return new ShakhmatyEarlyModernState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShakhmatyEarlyModernState o = (ShakhmatyEarlyModernState) other;
