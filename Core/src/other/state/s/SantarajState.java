...
/** Auto-generated State subclass for Santaraj. */
public class SantarajState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SantarajState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SantarajState(final SantarajState other) {
        super(other);
    ...
    @Override public SantarajState copy() { return new SantarajState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SantarajState o = (SantarajState) other;
