...
/** Auto-generated State subclass for SnipSnip. */
public class SnipSnipState extends State {
    ...
    public SnipSnipState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SnipSnipState(final SnipSnipState other) {
        super(other);
    ...
    @Override public SnipSnipState copy() { return new SnipSnipState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SnipSnipState o = (SnipSnipState) other;
