...
/** Auto-generated State subclass for SahkkuLujavvR. */
public class SahkkuLujavvRState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SahkkuLujavvRState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SahkkuLujavvRState(final SahkkuLujavvRState other) {
        super(other);
    ...
    @Override public SahkkuLujavvRState copy() { return new SahkkuLujavvRState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SahkkuLujavvRState o = (SahkkuLujavvRState) other;
