...
/** Auto-generated State subclass for SeysDosYAs. */
public class SeysDosYAsState extends State {
    ...
    public SeysDosYAsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SeysDosYAsState(final SeysDosYAsState other) {
        super(other);
    ...
    @Override public SeysDosYAsState copy() { return new SeysDosYAsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SeysDosYAsState o = (SeysDosYAsState) other;
