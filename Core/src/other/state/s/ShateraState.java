...
/** Auto-generated State subclass for Shatera. */
public class ShateraState extends State {
    ...
    public ShateraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShateraState(final ShateraState other) {
        super(other);
    ...
    @Override public ShateraState copy() { return new ShateraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShateraState o = (ShateraState) other;
