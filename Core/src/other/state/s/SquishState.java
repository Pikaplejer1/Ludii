...
/** Auto-generated State subclass for Squish. */
public class SquishState extends State {
    ...
    public SquishState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SquishState(final SquishState other) {
        super(other);
    ...
    @Override public SquishState copy() { return new SquishState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SquishState o = (SquishState) other;
