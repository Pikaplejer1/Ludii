...
/** Auto-generated State subclass for SigTidikelt. */
public class SigTidikeltState extends State {
    ...
    public SigTidikeltState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigTidikeltState(final SigTidikeltState other) {
        super(other);
    ...
    @Override public SigTidikeltState copy() { return new SigTidikeltState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigTidikeltState o = (SigTidikeltState) other;
