...
/** Auto-generated State subclass for Spoing. */
public class SpoingState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SpoingState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SpoingState(final SpoingState other) {
        super(other);
    ...
    @Override public SpoingState copy() { return new SpoingState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SpoingState o = (SpoingState) other;
