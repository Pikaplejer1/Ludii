...
/** Auto-generated State subclass for Splastwo. */
public class SplastwoState extends State {
    ...
    public SplastwoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SplastwoState(final SplastwoState other) {
        super(other);
    ...
    @Override public SplastwoState copy() { return new SplastwoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SplastwoState o = (SplastwoState) other;
