...
/** Auto-generated State subclass for Skak. */
public class SkakState extends State {
    ...
    public SkakState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SkakState(final SkakState other) {
        super(other);
    ...
    @Override public SkakState copy() { return new SkakState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SkakState o = (SkakState) other;
