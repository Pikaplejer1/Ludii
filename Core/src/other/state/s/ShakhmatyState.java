...
/** Auto-generated State subclass for Shakhmaty. */
public class ShakhmatyState extends State {
    ...
    public ShakhmatyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShakhmatyState(final ShakhmatyState other) {
        super(other);
    ...
    @Override public ShakhmatyState copy() { return new ShakhmatyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShakhmatyState o = (ShakhmatyState) other;
