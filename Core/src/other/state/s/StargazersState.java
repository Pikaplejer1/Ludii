...
/** Auto-generated State subclass for Stargazers. */
public class StargazersState extends State {
    ...
    public StargazersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public StargazersState(final StargazersState other) {
        super(other);
    ...
    @Override public StargazersState copy() { return new StargazersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final StargazersState o = (StargazersState) other;
