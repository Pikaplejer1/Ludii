...
/** Auto-generated State subclass for Shatranj. */
public class ShatranjState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjState(final ShatranjState other) {
        super(other);
    ...
    @Override public ShatranjState copy() { return new ShatranjState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjState o = (ShatranjState) other;
