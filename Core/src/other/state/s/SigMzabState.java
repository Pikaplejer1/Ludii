...
/** Auto-generated State subclass for SigMzab. */
public class SigMzabState extends State {
    ...
    public SigMzabState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigMzabState(final SigMzabState other) {
        super(other);
    ...
    @Override public SigMzabState copy() { return new SigMzabState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigMzabState o = (SigMzabState) other;
