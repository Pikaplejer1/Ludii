...
/** Auto-generated State subclass for Schuster. */
public class SchusterState extends State {
    ...
    public SchusterState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SchusterState(final SchusterState other) {
        super(other);
    ...
    @Override public SchusterState copy() { return new SchusterState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SchusterState o = (SchusterState) other;
