...
/** Auto-generated State subclass for Senet. */
public class SenetState extends State {
    ...
    public SenetState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SenetState(final SenetState other) {
        super(other);
    ...
    @Override public SenetState copy() { return new SenetState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SenetState o = (SenetState) other;
