...
/** Auto-generated State subclass for Sik. */
public class SikState extends State {
    ...
    public SikState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SikState(final SikState other) {
        super(other);
    ...
    @Override public SikState copy() { return new SikState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SikState o = (SikState) other;
