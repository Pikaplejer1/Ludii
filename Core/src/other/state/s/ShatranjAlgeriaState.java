...
/** Auto-generated State subclass for ShatranjAlgeria. */
public class ShatranjAlgeriaState extends State {
    ...
    public ShatranjAlgeriaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAlgeriaState(final ShatranjAlgeriaState other) {
        super(other);
    ...
    @Override public ShatranjAlgeriaState copy() { return new ShatranjAlgeriaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlgeriaState o = (ShatranjAlgeriaState) other;
