...
/** Auto-generated State subclass for Starchess. */
public class StarchessState extends State {
    ...
    public StarchessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public StarchessState(final StarchessState other) {
        super(other);
    ...
    @Override public StarchessState copy() { return new StarchessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final StarchessState o = (StarchessState) other;
