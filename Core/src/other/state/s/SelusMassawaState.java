...
/** Auto-generated State subclass for SelusMassawa. */
public class SelusMassawaState extends State {
    ...
    public SelusMassawaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SelusMassawaState(final SelusMassawaState other) {
        super(other);
    ...
    @Override public SelusMassawaState copy() { return new SelusMassawaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SelusMassawaState o = (SelusMassawaState) other;
