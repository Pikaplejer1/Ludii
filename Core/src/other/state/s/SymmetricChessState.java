...
/** Auto-generated State subclass for SymmetricChess. */
public class SymmetricChessState extends State {
    ...
    public SymmetricChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SymmetricChessState(final SymmetricChessState other) {
        super(other);
    ...
    @Override public SymmetricChessState copy() { return new SymmetricChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SymmetricChessState o = (SymmetricChessState) other;
