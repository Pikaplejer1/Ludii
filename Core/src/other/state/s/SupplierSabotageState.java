...
/** Auto-generated State subclass for SupplierSabotage. */
public class SupplierSabotageState extends State {
    ...
    public SupplierSabotageState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SupplierSabotageState(final SupplierSabotageState other) {
        super(other);
    ...
    @Override public SupplierSabotageState copy() { return new SupplierSabotageState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SupplierSabotageState o = (SupplierSabotageState) other;
