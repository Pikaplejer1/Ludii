...
/** Auto-generated State subclass for SupplyChains. */
public class SupplyChainsState extends State {
    ...
    public SupplyChainsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SupplyChainsState(final SupplyChainsState other) {
        super(other);
    ...
    @Override public SupplyChainsState copy() { return new SupplyChainsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SupplyChainsState o = (SupplyChainsState) other;
