...
/** Auto-generated State subclass for SherBakar. */
public class SherBakarState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SherBakarState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SherBakarState(final SherBakarState other) {
        super(other);
    ...
    @Override public SherBakarState copy() { return new SherBakarState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SherBakarState o = (SherBakarState) other;
