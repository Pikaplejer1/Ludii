...
/** Auto-generated State subclass for SigaSriLanka. */
public class SigaSriLankaState extends State {
    ...
    public SigaSriLankaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigaSriLankaState(final SigaSriLankaState other) {
        super(other);
    ...
    @Override public SigaSriLankaState copy() { return new SigaSriLankaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigaSriLankaState o = (SigaSriLankaState) other;
