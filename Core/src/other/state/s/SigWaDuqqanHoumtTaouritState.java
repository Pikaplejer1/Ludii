...
/** Auto-generated State subclass for SigWaDuqqanHoumtTaourit. */
public class SigWaDuqqanHoumtTaouritState extends State {
    ...
    public SigWaDuqqanHoumtTaouritState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigWaDuqqanHoumtTaouritState(final SigWaDuqqanHoumtTaouritState other) {
        super(other);
    ...
    @Override public SigWaDuqqanHoumtTaouritState copy() { return new SigWaDuqqanHoumtTaouritState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigWaDuqqanHoumtTaouritState o = (SigWaDuqqanHoumtTaouritState) other;
