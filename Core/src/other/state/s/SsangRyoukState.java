...
/** Auto-generated State subclass for SsangRyouk. */
public class SsangRyoukState extends State {
    ...
    public SsangRyoukState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SsangRyoukState(final SsangRyoukState other) {
        super(other);
    ...
    @Override public SsangRyoukState copy() { return new SsangRyoukState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SsangRyoukState o = (SsangRyoukState) other;
