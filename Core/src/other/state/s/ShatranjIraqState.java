...
/** Auto-generated State subclass for ShatranjIraq. */
public class ShatranjIraqState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjIraqState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjIraqState(final ShatranjIraqState other) {
        super(other);
    ...
    @Override public ShatranjIraqState copy() { return new ShatranjIraqState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjIraqState o = (ShatranjIraqState) other;
