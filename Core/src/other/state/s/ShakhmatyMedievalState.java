...
/** Auto-generated State subclass for ShakhmatyMedieval. */
public class ShakhmatyMedievalState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShakhmatyMedievalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShakhmatyMedievalState(final ShakhmatyMedievalState other) {
        super(other);
    ...
    @Override public ShakhmatyMedievalState copy() { return new ShakhmatyMedievalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShakhmatyMedievalState o = (ShakhmatyMedievalState) other;
