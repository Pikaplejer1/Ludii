...
/** Auto-generated State subclass for Smasandyutakankarikrida. */
public class SmasandyutakankarikridaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SmasandyutakankarikridaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SmasandyutakankarikridaState(final SmasandyutakankarikridaState other) {
        super(other);
    ...
    @Override public SmasandyutakankarikridaState copy() { return new SmasandyutakankarikridaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SmasandyutakankarikridaState o = (SmasandyutakankarikridaState) other;
