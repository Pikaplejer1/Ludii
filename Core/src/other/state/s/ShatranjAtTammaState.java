...
/** Auto-generated State subclass for ShatranjAtTamma. */
public class ShatranjAtTammaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjAtTammaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAtTammaState(final ShatranjAtTammaState other) {
        super(other);
    ...
    @Override public ShatranjAtTammaState copy() { return new ShatranjAtTammaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAtTammaState o = (ShatranjAtTammaState) other;
