...
/** Auto-generated State subclass for ShatranjAlJawarhiya. */
public class ShatranjAlJawarhiyaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjAlJawarhiyaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAlJawarhiyaState(final ShatranjAlJawarhiyaState other) {
        super(other);
    ...
    @Override public ShatranjAlJawarhiyaState copy() { return new ShatranjAlJawarhiyaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlJawarhiyaState o = (ShatranjAlJawarhiyaState) other;
