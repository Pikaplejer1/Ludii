...
/** Auto-generated State subclass for Shogun. */
public class ShogunState extends State {
    ...
    public ShogunState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShogunState(final ShogunState other) {
        super(other);
    ...
    @Override public ShogunState copy() { return new ShogunState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShogunState o = (ShogunState) other;
