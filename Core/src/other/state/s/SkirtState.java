...
/** Auto-generated State subclass for Skirt. */
public class SkirtState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public SkirtState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SkirtState(final SkirtState other) {
        super(other);
    ...
    @Override public SkirtState copy() { return new SkirtState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SkirtState o = (SkirtState) other;
