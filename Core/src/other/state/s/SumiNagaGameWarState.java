...
/** Auto-generated State subclass for SumiNagaGameWar. */
public class SumiNagaGameWarState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SumiNagaGameWarState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SumiNagaGameWarState(final SumiNagaGameWarState other) {
        super(other);
    ...
    @Override public SumiNagaGameWarState copy() { return new SumiNagaGameWarState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SumiNagaGameWarState o = (SumiNagaGameWarState) other;
