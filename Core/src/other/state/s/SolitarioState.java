...
/** Auto-generated State subclass for Solitario. */
public class SolitarioState extends State {
    ...
    public SolitarioState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SolitarioState(final SolitarioState other) {
        super(other);
    ...
    @Override public SolitarioState copy() { return new SolitarioState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SolitarioState o = (SolitarioState) other;
