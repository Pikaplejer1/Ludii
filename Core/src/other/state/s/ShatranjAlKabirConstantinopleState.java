...
/** Auto-generated State subclass for ShatranjAlKabirConstantinople. */
public class ShatranjAlKabirConstantinopleState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjAlKabirConstantinopleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAlKabirConstantinopleState(final ShatranjAlKabirConstantinopleState other) {
        super(other);
    ...
    @Override public ShatranjAlKabirConstantinopleState copy() { return new ShatranjAlKabirConstantinopleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlKabirConstantinopleState o = (ShatranjAlKabirConstantinopleState) other;
