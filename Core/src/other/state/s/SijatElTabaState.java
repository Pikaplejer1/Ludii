...
/** Auto-generated State subclass for SijatElTaba. */
public class SijatElTabaState extends State {
    ...
    public SijatElTabaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SijatElTabaState(final SijatElTabaState other) {
        super(other);
    ...
    @Override public SijatElTabaState copy() { return new SijatElTabaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SijatElTabaState o = (SijatElTabaState) other;
