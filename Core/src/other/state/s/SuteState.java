...
/** Auto-generated State subclass for Sute. */
public class SuteState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SuteState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SuteState(final SuteState other) {
        super(other);
    ...
    @Override public SuteState copy() { return new SuteState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SuteState o = (SuteState) other;
