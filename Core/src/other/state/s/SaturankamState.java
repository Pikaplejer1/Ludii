...
/** Auto-generated State subclass for Saturankam. */
public class SaturankamState extends State {
    ...
    public SaturankamState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SaturankamState(final SaturankamState other) {
        super(other);
    ...
    @Override public SaturankamState copy() { return new SaturankamState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SaturankamState o = (SaturankamState) other;
