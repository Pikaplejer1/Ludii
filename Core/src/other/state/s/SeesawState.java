...
/** Auto-generated State subclass for Seesaw. */
public class SeesawState extends State {
    ...
    public SeesawState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SeesawState(final SeesawState other) {
        super(other);
    ...
    @Override public SeesawState copy() { return new SeesawState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SeesawState o = (SeesawState) other;
