...
/** Auto-generated State subclass for Squadro. */
public class SquadroState extends State {
    ...
    public SquadroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SquadroState(final SquadroState other) {
        super(other);
    ...
    @Override public SquadroState copy() { return new SquadroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SquadroState o = (SquadroState) other;
