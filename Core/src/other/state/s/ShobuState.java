...
/** Auto-generated State subclass for Shobu. */
public class ShobuState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShobuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShobuState(final ShobuState other) {
        super(other);
    ...
    @Override public ShobuState copy() { return new ShobuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShobuState o = (ShobuState) other;
