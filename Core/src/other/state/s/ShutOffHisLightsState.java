...
/** Auto-generated State subclass for ShutOffHisLights. */
public class ShutOffHisLightsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShutOffHisLightsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShutOffHisLightsState(final ShutOffHisLightsState other) {
        super(other);
    ...
    @Override public ShutOffHisLightsState copy() { return new ShutOffHisLightsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShutOffHisLightsState o = (ShutOffHisLightsState) other;
