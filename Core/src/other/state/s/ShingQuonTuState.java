...
/** Auto-generated State subclass for ShingQuonTu. */
public class ShingQuonTuState extends State {
    ...
    public ShingQuonTuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ShingQuonTuState(final ShingQuonTuState other) {
        super(other);
    ...
    @Override public ShingQuonTuState copy() { return new ShingQuonTuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShingQuonTuState o = (ShingQuonTuState) other;
