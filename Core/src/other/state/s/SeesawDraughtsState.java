...
/** Auto-generated State subclass for SeesawDraughts. */
public class SeesawDraughtsState extends State {
    ...
    public SeesawDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SeesawDraughtsState(final SeesawDraughtsState other) {
        super(other);
    ...
    @Override public SeesawDraughtsState copy() { return new SeesawDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SeesawDraughtsState o = (SeesawDraughtsState) other;
