...
/** Auto-generated State subclass for Speedo. */
public class SpeedoState extends State {
    ...
    public SpeedoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SpeedoState(final SpeedoState other) {
        super(other);
    ...
    @Override public SpeedoState copy() { return new SpeedoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SpeedoState o = (SpeedoState) other;
