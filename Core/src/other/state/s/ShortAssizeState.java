...
/** Auto-generated State subclass for ShortAssize. */
public class ShortAssizeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShortAssizeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShortAssizeState(final ShortAssizeState other) {
        super(other);
    ...
    @Override public ShortAssizeState copy() { return new ShortAssizeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShortAssizeState o = (ShortAssizeState) other;
