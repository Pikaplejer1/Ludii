...
/** Auto-generated State subclass for SherBakr. */
public class SherBakrState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SherBakrState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SherBakrState(final SherBakrState other) {
        super(other);
    ...
    @Override public SherBakrState copy() { return new SherBakrState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SherBakrState o = (SherBakrState) other;
