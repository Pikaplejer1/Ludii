...
/** Auto-generated State subclass for SamKI. */
public class SamKIState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SamKIState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SamKIState(final SamKIState other) {
        super(other);
    ...
    @Override public SamKIState copy() { return new SamKIState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SamKIState o = (SamKIState) other;
