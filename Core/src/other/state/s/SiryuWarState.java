...
/** Auto-generated State subclass for SiryuWar. */
public class SiryuWarState extends State {
    ...
    public SiryuWarState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SiryuWarState(final SiryuWarState other) {
        super(other);
    ...
    @Override public SiryuWarState copy() { return new SiryuWarState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SiryuWarState o = (SiryuWarState) other;
