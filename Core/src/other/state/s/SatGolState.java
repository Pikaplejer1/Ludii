...
/** Auto-generated State subclass for SatGol. */
public class SatGolState extends State {
    ...
    public SatGolState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SatGolState(final SatGolState other) {
        super(other);
    ...
    @Override public SatGolState copy() { return new SatGolState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SatGolState o = (SatGolState) other;
