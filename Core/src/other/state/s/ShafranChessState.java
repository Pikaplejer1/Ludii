...
/** Auto-generated State subclass for ShafranChess. */
public class ShafranChessState extends State {
    ...
    public ShafranChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShafranChessState(final ShafranChessState other) {
        super(other);
    ...
    @Override public ShafranChessState copy() { return new ShafranChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShafranChessState o = (ShafranChessState) other;
