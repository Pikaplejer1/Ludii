...
/** Auto-generated State subclass for Shashki. */
public class ShashkiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShashkiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShashkiState(final ShashkiState other) {
        super(other);
    ...
    @Override public ShashkiState copy() { return new ShashkiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShashkiState o = (ShashkiState) other;
