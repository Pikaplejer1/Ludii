...
/** Auto-generated State subclass for SkirmishGDL. */
public class SkirmishGDLState extends State {
    ...
    public SkirmishGDLState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SkirmishGDLState(final SkirmishGDLState other) {
        super(other);
    ...
    @Override public SkirmishGDLState copy() { return new SkirmishGDLState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SkirmishGDLState o = (SkirmishGDLState) other;
