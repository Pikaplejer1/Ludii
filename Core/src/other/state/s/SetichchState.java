...
/** Auto-generated State subclass for Setichch. */
public class SetichchState extends State {
    ...
    public SetichchState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SetichchState(final SetichchState other) {
        super(other);
    ...
    @Override public SetichchState copy() { return new SetichchState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SetichchState o = (SetichchState) other;
