...
/** Auto-generated State subclass for Symple. */
public class SympleState extends State {
    ...
    public SympleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SympleState(final SympleState other) {
        super(other);
    ...
    @Override public SympleState copy() { return new SympleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SympleState o = (SympleState) other;
