...
/** Auto-generated State subclass for Sarvatobhadra. */
public class SarvatobhadraState extends State {
    ...
    public SarvatobhadraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SarvatobhadraState(final SarvatobhadraState other) {
        super(other);
    ...
    @Override public SarvatobhadraState copy() { return new SarvatobhadraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SarvatobhadraState o = (SarvatobhadraState) other;
