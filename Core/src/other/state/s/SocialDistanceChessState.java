...
/** Auto-generated State subclass for SocialDistanceChess. */
public class SocialDistanceChessState extends State {
    ...
    public SocialDistanceChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SocialDistanceChessState(final SocialDistanceChessState other) {
        super(other);
    ...
    @Override public SocialDistanceChessState copy() { return new SocialDistanceChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SocialDistanceChessState o = (SocialDistanceChessState) other;
