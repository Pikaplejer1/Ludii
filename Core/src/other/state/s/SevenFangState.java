...
/** Auto-generated State subclass for SevenFang. */
public class SevenFangState extends State {
    ...
    public SevenFangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SevenFangState(final SevenFangState other) {
        super(other);
    ...
    @Override public SevenFangState copy() { return new SevenFangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SevenFangState o = (SevenFangState) other;
