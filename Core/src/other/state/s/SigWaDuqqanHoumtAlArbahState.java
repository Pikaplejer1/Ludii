...
/** Auto-generated State subclass for SigWaDuqqanHoumtAlArbah. */
public class SigWaDuqqanHoumtAlArbahState extends State {
    ...
    public SigWaDuqqanHoumtAlArbahState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigWaDuqqanHoumtAlArbahState(final SigWaDuqqanHoumtAlArbahState other) {
        super(other);
    ...
    @Override public SigWaDuqqanHoumtAlArbahState copy() { return new SigWaDuqqanHoumtAlArbahState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigWaDuqqanHoumtAlArbahState o = (SigWaDuqqanHoumtAlArbahState) other;
