...
/** Auto-generated State subclass for Shodra. */
public class ShodraState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShodraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShodraState(final ShodraState other) {
        super(other);
    ...
    @Override public ShodraState copy() { return new ShodraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShodraState o = (ShodraState) other;
