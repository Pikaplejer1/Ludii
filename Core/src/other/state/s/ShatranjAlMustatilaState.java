...
/** Auto-generated State subclass for ShatranjAlMustatila. */
public class ShatranjAlMustatilaState extends State {
    ...
    public ShatranjAlMustatilaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ShatranjAlMustatilaState(final ShatranjAlMustatilaState other) {
        super(other);
    ...
    @Override public ShatranjAlMustatilaState copy() { return new ShatranjAlMustatilaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlMustatilaState o = (ShatranjAlMustatilaState) other;
