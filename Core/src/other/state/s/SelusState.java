...
/** Auto-generated State subclass for Selus. */
public class SelusState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public SelusState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SelusState(final SelusState other) {
        super(other);
    ...
    @Override public SelusState copy() { return new SelusState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SelusState o = (SelusState) other;
