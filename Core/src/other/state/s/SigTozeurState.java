...
/** Auto-generated State subclass for SigTozeur. */
public class SigTozeurState extends State {
    ...
    public SigTozeurState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigTozeurState(final SigTozeurState other) {
        super(other);
    ...
    @Override public SigTozeurState copy() { return new SigTozeurState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigTozeurState o = (SigTozeurState) other;
