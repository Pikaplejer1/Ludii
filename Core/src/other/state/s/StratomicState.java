...
/** Auto-generated State subclass for Stratomic. */
public class StratomicState extends State {
    ...
    public StratomicState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public StratomicState(final StratomicState other) {
        super(other);
    ...
    @Override public StratomicState copy() { return new StratomicState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final StratomicState o = (StratomicState) other;
