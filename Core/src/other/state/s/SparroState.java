...
/** Auto-generated State subclass for Sparro. */
public class SparroState extends State {
    ...
    public SparroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SparroState(final SparroState other) {
        super(other);
    ...
    @Override public SparroState copy() { return new SparroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SparroState o = (SparroState) other;
