...
/** Auto-generated State subclass for Sungka. */
public class SungkaState extends State {
    ...
    public SungkaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SungkaState(final SungkaState other) {
        super(other);
    ...
    @Override public SungkaState copy() { return new SungkaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SungkaState o = (SungkaState) other;
