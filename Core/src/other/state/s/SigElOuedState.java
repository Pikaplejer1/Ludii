...
/** Auto-generated State subclass for SigElOued. */
public class SigElOuedState extends State {
    ...
    public SigElOuedState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigElOuedState(final SigElOuedState other) {
        super(other);
    ...
    @Override public SigElOuedState copy() { return new SigElOuedState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigElOuedState o = (SigElOuedState) other;
