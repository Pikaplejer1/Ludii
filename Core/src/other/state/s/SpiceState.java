...
/** Auto-generated State subclass for Spice. */
public class SpiceState extends State {
    ...
    public SpiceState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SpiceState(final SpiceState other) {
        super(other);
    ...
    @Override public SpiceState copy() { return new SpiceState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SpiceState o = (SpiceState) other;
