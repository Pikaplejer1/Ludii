...
/** Auto-generated State subclass for Shiva. */
public class ShivaState extends State {
    ...
    public ShivaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShivaState(final ShivaState other) {
        super(other);
    ...
    @Override public ShivaState copy() { return new ShivaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShivaState o = (ShivaState) other;
