...
/** Auto-generated State subclass for ShatranjTurkey. */
public class ShatranjTurkeyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjTurkeyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjTurkeyState(final ShatranjTurkeyState other) {
        super(other);
    ...
    @Override public ShatranjTurkeyState copy() { return new ShatranjTurkeyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjTurkeyState o = (ShatranjTurkeyState) other;
