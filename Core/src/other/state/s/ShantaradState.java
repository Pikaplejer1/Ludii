...
/** Auto-generated State subclass for Shantarad. */
public class ShantaradState extends State {
    ...
    public ShantaradState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShantaradState(final ShantaradState other) {
        super(other);
    ...
    @Override public ShantaradState copy() { return new ShantaradState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShantaradState o = (ShantaradState) other;
