...
/** Auto-generated State subclass for Sahkku. */
public class SahkkuState extends State {
    ...
    public SahkkuState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SahkkuState(final SahkkuState other) {
        super(other);
    ...
    @Override public SahkkuState copy() { return new SahkkuState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SahkkuState o = (SahkkuState) other;
