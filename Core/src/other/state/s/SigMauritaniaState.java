...
/** Auto-generated State subclass for SigMauritania. */
public class SigMauritaniaState extends State {
    ...
    public SigMauritaniaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SigMauritaniaState(final SigMauritaniaState other) {
        super(other);
    ...
    @Override public SigMauritaniaState copy() { return new SigMauritaniaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SigMauritaniaState o = (SigMauritaniaState) other;
