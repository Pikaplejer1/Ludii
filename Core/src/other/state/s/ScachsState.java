...
/** Auto-generated State subclass for Scachs. */
public class ScachsState extends State {
    ...
    public ScachsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ScachsState(final ScachsState other) {
        super(other);
    ...
    @Override public ScachsState copy() { return new ScachsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ScachsState o = (ScachsState) other;
