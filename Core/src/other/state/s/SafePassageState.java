...
/** Auto-generated State subclass for SafePassage. */
public class SafePassageState extends State {
    ...
    public SafePassageState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SafePassageState(final SafePassageState other) {
        super(other);
    ...
    @Override public SafePassageState copy() { return new SafePassageState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SafePassageState o = (SafePassageState) other;
