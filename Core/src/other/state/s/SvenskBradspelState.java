...
/** Auto-generated State subclass for SvenskBradspel. */
public class SvenskBradspelState extends State {
    ...
    public SvenskBradspelState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SvenskBradspelState(final SvenskBradspelState other) {
        super(other);
    ...
    @Override public SvenskBradspelState copy() { return new SvenskBradspelState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SvenskBradspelState o = (SvenskBradspelState) other;
