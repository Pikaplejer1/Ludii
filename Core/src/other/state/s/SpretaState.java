...
/** Auto-generated State subclass for Spreta. */
public class SpretaState extends State {
    ...
    public SpretaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SpretaState(final SpretaState other) {
        super(other);
    ...
    @Override public SpretaState copy() { return new SpretaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SpretaState o = (SpretaState) other;
