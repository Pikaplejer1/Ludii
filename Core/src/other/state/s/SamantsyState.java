...
/** Auto-generated State subclass for Samantsy. */
public class SamantsyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SamantsyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SamantsyState(final SamantsyState other) {
        super(other);
    ...
    @Override public SamantsyState copy() { return new SamantsyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SamantsyState o = (SamantsyState) other;
