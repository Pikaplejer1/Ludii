...
/** Auto-generated State subclass for SproutROut. */
public class SproutROutState extends State {
    ...
    public SproutROutState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SproutROutState(final SproutROutState other) {
        super(other);
    ...
    @Override public SproutROutState copy() { return new SproutROutState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SproutROutState o = (SproutROutState) other;
