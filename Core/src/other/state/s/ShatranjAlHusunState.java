...
/** Auto-generated State subclass for ShatranjAlHusun. */
public class ShatranjAlHusunState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShatranjAlHusunState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShatranjAlHusunState(final ShatranjAlHusunState other) {
        super(other);
    ...
    @Override public ShatranjAlHusunState copy() { return new ShatranjAlHusunState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShatranjAlHusunState o = (ShatranjAlHusunState) other;
