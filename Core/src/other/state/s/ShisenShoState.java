...
/** Auto-generated State subclass for ShisenSho. */
public class ShisenShoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ShisenShoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ShisenShoState(final ShisenShoState other) {
        super(other);
    ...
    @Override public ShisenShoState copy() { return new ShisenShoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ShisenShoState o = (ShisenShoState) other;
