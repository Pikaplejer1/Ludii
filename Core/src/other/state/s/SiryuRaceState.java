...
/** Auto-generated State subclass for SiryuRace. */
public class SiryuRaceState extends State {
    ...
    public SiryuRaceState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public SiryuRaceState(final SiryuRaceState other) {
        super(other);
    ...
    @Override public SiryuRaceState copy() { return new SiryuRaceState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SiryuRaceState o = (SiryuRaceState) other;
