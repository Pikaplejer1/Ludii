...
/** Auto-generated State subclass for SamoanGame. */
public class SamoanGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public SamoanGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public SamoanGameState(final SamoanGameState other) {
        super(other);
    ...
    @Override public SamoanGameState copy() { return new SamoanGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final SamoanGameState o = (SamoanGameState) other;
