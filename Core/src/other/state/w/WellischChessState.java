...
/** Auto-generated State subclass for WellischChess. */
public class WellischChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public WellischChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WellischChessState(final WellischChessState other) {
        super(other);
    ...
    @Override public WellischChessState copy() { return new WellischChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WellischChessState o = (WellischChessState) other;
