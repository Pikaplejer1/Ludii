...
/** Auto-generated State subclass for WaAcheWaledat. */
public class WaAcheWaledatState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public WaAcheWaledatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WaAcheWaledatState(final WaAcheWaledatState other) {
        super(other);
    ...
    @Override public WaAcheWaledatState copy() { return new WaAcheWaledatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WaAcheWaledatState o = (WaAcheWaledatState) other;
