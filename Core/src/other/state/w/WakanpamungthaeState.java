...
/** Auto-generated State subclass for Wakanpamungthae. */
public class WakanpamungthaeState extends State {
    ...
    public WakanpamungthaeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WakanpamungthaeState(final WakanpamungthaeState other) {
        super(other);
    ...
    @Override public WakanpamungthaeState copy() { return new WakanpamungthaeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WakanpamungthaeState o = (WakanpamungthaeState) other;
