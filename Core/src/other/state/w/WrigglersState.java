...
/** Auto-generated State subclass for Wrigglers. */
public class WrigglersState extends State {
    ...
    public WrigglersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WrigglersState(final WrigglersState other) {
        super(other);
    ...
    @Override public WrigglersState copy() { return new WrigglersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WrigglersState o = (WrigglersState) other;
