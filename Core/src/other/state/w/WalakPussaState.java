...
/** Auto-generated State subclass for WalakPussa. */
public class WalakPussaState extends State {
    ...
    public WalakPussaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WalakPussaState(final WalakPussaState other) {
        super(other);
    ...
    @Override public WalakPussaState copy() { return new WalakPussaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WalakPussaState o = (WalakPussaState) other;
