...
/** Auto-generated State subclass for Windflowers. */
public class WindflowersState extends State {
    ...
    public WindflowersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WindflowersState(final WindflowersState other) {
        super(other);
    ...
    @Override public WindflowersState copy() { return new WindflowersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WindflowersState o = (WindflowersState) other;
