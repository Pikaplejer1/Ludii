...
/** Auto-generated State subclass for WumpusWorld. */
public class WumpusWorldState extends State {
    ...
    public WumpusWorldState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public WumpusWorldState(final WumpusWorldState other) {
        super(other);
    ...
    @Override public WumpusWorldState copy() { return new WumpusWorldState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WumpusWorldState o = (WumpusWorldState) other;
