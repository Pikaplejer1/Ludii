...
/** Auto-generated State subclass for WorkersAndSoldiers. */
public class WorkersAndSoldiersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public WorkersAndSoldiersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WorkersAndSoldiersState(final WorkersAndSoldiersState other) {
        super(other);
    ...
    @Override public WorkersAndSoldiersState copy() { return new WorkersAndSoldiersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WorkersAndSoldiersState o = (WorkersAndSoldiersState) other;
