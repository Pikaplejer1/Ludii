...
/** Auto-generated State subclass for Woli. */
public class WoliState extends State {
    ...
    public WoliState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WoliState(final WoliState other) {
        super(other);
    ...
    @Override public WoliState copy() { return new WoliState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WoliState o = (WoliState) other;
