...
/** Auto-generated State subclass for WrigglersSquared. */
public class WrigglersSquaredState extends State {
    ...
    public WrigglersSquaredState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WrigglersSquaredState(final WrigglersSquaredState other) {
        super(other);
    ...
    @Override public WrigglersSquaredState copy() { return new WrigglersSquaredState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WrigglersSquaredState o = (WrigglersSquaredState) other;
