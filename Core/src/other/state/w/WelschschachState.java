...
/** Auto-generated State subclass for Welschschach. */
public class WelschschachState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public WelschschachState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WelschschachState(final WelschschachState other) {
        super(other);
    ...
    @Override public WelschschachState copy() { return new WelschschachState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WelschschachState o = (WelschschachState) other;
