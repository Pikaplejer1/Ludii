...
/** Auto-generated State subclass for Whyo. */
public class WhyoState extends State {
    ...
    public WhyoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WhyoState(final WhyoState other) {
        super(other);
    ...
    @Override public WhyoState copy() { return new WhyoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WhyoState o = (WhyoState) other;
