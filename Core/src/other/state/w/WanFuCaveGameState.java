...
/** Auto-generated State subclass for WanFuCaveGame. */
public class WanFuCaveGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public WanFuCaveGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WanFuCaveGameState(final WanFuCaveGameState other) {
        super(other);
    ...
    @Override public WanFuCaveGameState copy() { return new WanFuCaveGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WanFuCaveGameState o = (WanFuCaveGameState) other;
