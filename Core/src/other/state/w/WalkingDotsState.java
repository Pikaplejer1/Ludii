...
/** Auto-generated State subclass for WalkingDots. */
public class WalkingDotsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public WalkingDotsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WalkingDotsState(final WalkingDotsState other) {
        super(other);
    ...
    @Override public WalkingDotsState copy() { return new WalkingDotsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WalkingDotsState o = (WalkingDotsState) other;
