...
/** Auto-generated State subclass for Watershed. */
public class WatershedState extends State {
    ...
    public WatershedState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public WatershedState(final WatershedState other) {
        super(other);
    ...
    @Override public WatershedState copy() { return new WatershedState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final WatershedState o = (WatershedState) other;
