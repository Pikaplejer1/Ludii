...
/** Auto-generated State subclass for Unlace. */
public class UnlaceState extends State {
    ...
    public UnlaceState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UnlaceState(final UnlaceState other) {
        super(other);
    ...
    @Override public UnlaceState copy() { return new UnlaceState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UnlaceState o = (UnlaceState) other;
