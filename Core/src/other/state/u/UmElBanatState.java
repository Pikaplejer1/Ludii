...
/** Auto-generated State subclass for UmElBanat. */
public class UmElBanatState extends State {
    ...
    public UmElBanatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UmElBanatState(final UmElBanatState other) {
        super(other);
    ...
    @Override public UmElBanatState copy() { return new UmElBanatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UmElBanatState o = (UmElBanatState) other;
