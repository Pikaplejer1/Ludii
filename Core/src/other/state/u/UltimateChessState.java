...
/** Auto-generated State subclass for UltimateChess. */
public class UltimateChessState extends State {
    ...
    public UltimateChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UltimateChessState(final UltimateChessState other) {
        super(other);
    ...
    @Override public UltimateChessState copy() { return new UltimateChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UltimateChessState o = (UltimateChessState) other;
