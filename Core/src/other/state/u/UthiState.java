...
/** Auto-generated State subclass for Uthi. */
public class UthiState extends State {
    ...
    public UthiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UthiState(final UthiState other) {
        super(other);
    ...
    @Override public UthiState copy() { return new UthiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UthiState o = (UthiState) other;
