...
/** Auto-generated State subclass for UnnamedDutchDraughtsGame. */
public class UnnamedDutchDraughtsGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public UnnamedDutchDraughtsGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UnnamedDutchDraughtsGameState(final UnnamedDutchDraughtsGameState other) {
        super(other);
    ...
    @Override public UnnamedDutchDraughtsGameState copy() { return new UnnamedDutchDraughtsGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UnnamedDutchDraughtsGameState o = (UnnamedDutchDraughtsGameState) other;
