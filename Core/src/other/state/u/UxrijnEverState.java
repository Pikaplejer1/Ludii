...
/** Auto-generated State subclass for UxrijnEver. */
public class UxrijnEverState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public UxrijnEverState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UxrijnEverState(final UxrijnEverState other) {
        super(other);
    ...
    @Override public UxrijnEverState copy() { return new UxrijnEverState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UxrijnEverState o = (UxrijnEverState) other;
