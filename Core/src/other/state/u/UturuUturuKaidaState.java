...
/** Auto-generated State subclass for UturuUturuKaida. */
public class UturuUturuKaidaState extends State {
    ...
    public UturuUturuKaidaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public UturuUturuKaidaState(final UturuUturuKaidaState other) {
        super(other);
    ...
    @Override public UturuUturuKaidaState copy() { return new UturuUturuKaidaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UturuUturuKaidaState o = (UturuUturuKaidaState) other;
