...
/** Auto-generated State subclass for UdatPagada. */
public class UdatPagadaState extends State {
    ...
    public UdatPagadaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public UdatPagadaState(final UdatPagadaState other) {
        super(other);
    ...
    @Override public UdatPagadaState copy() { return new UdatPagadaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UdatPagadaState o = (UdatPagadaState) other;
