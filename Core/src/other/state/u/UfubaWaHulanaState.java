...
/** Auto-generated State subclass for UfubaWaHulana. */
public class UfubaWaHulanaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public UfubaWaHulanaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public UfubaWaHulanaState(final UfubaWaHulanaState other) {
        super(other);
    ...
    @Override public UfubaWaHulanaState copy() { return new UfubaWaHulanaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UfubaWaHulanaState o = (UfubaWaHulanaState) other;
