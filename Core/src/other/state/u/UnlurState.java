...
/** Auto-generated State subclass for Unlur. */
public class UnlurState extends State {
    ...
    public UnlurState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.usesNote()) notes = new gnu.trove.map.hash.TIntObjectHashMap<>();
    }

    public UnlurState(final UnlurState other) {
        super(other);
    ...
    @Override public UnlurState copy() { return new UnlurState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final UnlurState o = (UnlurState) other;
