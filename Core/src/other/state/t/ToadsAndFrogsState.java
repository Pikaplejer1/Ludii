...
/** Auto-generated State subclass for ToadsAndFrogs. */
public class ToadsAndFrogsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ToadsAndFrogsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ToadsAndFrogsState(final ToadsAndFrogsState other) {
        super(other);
    ...
    @Override public ToadsAndFrogsState copy() { return new ToadsAndFrogsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ToadsAndFrogsState o = (ToadsAndFrogsState) other;
