...
/** Auto-generated State subclass for TicTacChess. */
public class TicTacChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TicTacChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TicTacChessState(final TicTacChessState other) {
        super(other);
    ...
    @Override public TicTacChessState copy() { return new TicTacChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TicTacChessState o = (TicTacChessState) other;
