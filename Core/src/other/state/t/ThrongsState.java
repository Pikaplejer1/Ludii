...
/** Auto-generated State subclass for Throngs. */
public class ThrongsState extends State {
    ...
    public ThrongsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ThrongsState(final ThrongsState other) {
        super(other);
    ...
    @Override public ThrongsState copy() { return new ThrongsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThrongsState o = (ThrongsState) other;
