...
/** Auto-generated State subclass for Troll. */
public class TrollState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TrollState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TrollState(final TrollState other) {
        super(other);
    ...
    @Override public TrollState copy() { return new TrollState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TrollState o = (TrollState) other;
