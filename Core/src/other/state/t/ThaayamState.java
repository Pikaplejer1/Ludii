...
/** Auto-generated State subclass for Thaayam. */
public class ThaayamState extends State {
    ...
    public ThaayamState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public ThaayamState(final ThaayamState other) {
        super(other);
    ...
    @Override public ThaayamState copy() { return new ThaayamState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThaayamState o = (ThaayamState) other;
