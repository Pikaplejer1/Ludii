...
/** Auto-generated State subclass for Tablut. */
public class TablutState extends State {
    ...
    public TablutState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TablutState(final TablutState other) {
        super(other);
    ...
    @Override public TablutState copy() { return new TablutState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TablutState o = (TablutState) other;
