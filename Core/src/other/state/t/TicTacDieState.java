...
/** Auto-generated State subclass for TicTacDie. */
public class TicTacDieState extends State {
    ...
    public TicTacDieState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TicTacDieState(final TicTacDieState other) {
        super(other);
    ...
    @Override public TicTacDieState copy() { return new TicTacDieState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TicTacDieState o = (TicTacDieState) other;
