...
/** Auto-generated State subclass for TheSmallHolder. */
public class TheSmallHolderState extends State {
    ...
    public TheSmallHolderState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TheSmallHolderState(final TheSmallHolderState other) {
        super(other);
    ...
    @Override public TheSmallHolderState copy() { return new TheSmallHolderState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TheSmallHolderState o = (TheSmallHolderState) other;
