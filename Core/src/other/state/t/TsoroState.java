...
/** Auto-generated State subclass for Tsoro. */
public class TsoroState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TsoroState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TsoroState(final TsoroState other) {
        super(other);
    ...
    @Override public TsoroState copy() { return new TsoroState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsoroState o = (TsoroState) other;
