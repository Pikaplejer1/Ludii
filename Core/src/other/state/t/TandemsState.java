...
/** Auto-generated State subclass for Tandems. */
public class TandemsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public TandemsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TandemsState(final TandemsState other) {
        super(other);
    ...
    @Override public TandemsState copy() { return new TandemsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TandemsState o = (TandemsState) other;
