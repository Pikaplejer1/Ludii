...
/** Auto-generated State subclass for Tab. */
public class TabState extends State {
    ...
    public TabState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TabState(final TabState other) {
        super(other);
    ...
    @Override public TabState copy() { return new TabState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TabState o = (TabState) other;
