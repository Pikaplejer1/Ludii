...
/** Auto-generated State subclass for Tamman. */
public class TammanState extends State {
    ...
    public TammanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TammanState(final TammanState other) {
        super(other);
    ...
    @Override public TammanState copy() { return new TammanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TammanState o = (TammanState) other;
