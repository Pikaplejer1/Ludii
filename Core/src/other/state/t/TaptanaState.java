...
/** Auto-generated State subclass for Taptana. */
public class TaptanaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TaptanaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TaptanaState(final TaptanaState other) {
        super(other);
    ...
    @Override public TaptanaState copy() { return new TaptanaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TaptanaState o = (TaptanaState) other;
