...
/** Auto-generated State subclass for Tara. */
public class TaraState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public TaraState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TaraState(final TaraState other) {
        super(other);
    ...
    @Override public TaraState copy() { return new TaraState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TaraState o = (TaraState) other;
