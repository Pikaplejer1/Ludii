...
/** Auto-generated State subclass for TheBabylonian. */
public class TheBabylonianState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TheBabylonianState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TheBabylonianState(final TheBabylonianState other) {
        super(other);
    ...
    @Override public TheBabylonianState copy() { return new TheBabylonianState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TheBabylonianState o = (TheBabylonianState) other;
