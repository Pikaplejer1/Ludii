...
/** Auto-generated State subclass for ThereAndBack. */
public class ThereAndBackState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ThereAndBackState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ThereAndBackState(final ThereAndBackState other) {
        super(other);
    ...
    @Override public ThereAndBackState copy() { return new ThereAndBackState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThereAndBackState o = (ThereAndBackState) other;
