...
/** Auto-generated State subclass for ThePawnGame. */
public class ThePawnGameState extends State {
    ...
    public ThePawnGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ThePawnGameState(final ThePawnGameState other) {
        super(other);
    ...
    @Override public ThePawnGameState copy() { return new ThePawnGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThePawnGameState o = (ThePawnGameState) other;
