...
/** Auto-generated State subclass for TriEinSteinWurfeltNicht. */
public class TriEinSteinWurfeltNichtState extends State {
    ...
    public TriEinSteinWurfeltNichtState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TriEinSteinWurfeltNichtState(final TriEinSteinWurfeltNichtState other) {
        super(other);
    ...
    @Override public TriEinSteinWurfeltNichtState copy() { return new TriEinSteinWurfeltNichtState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TriEinSteinWurfeltNichtState o = (TriEinSteinWurfeltNichtState) other;
