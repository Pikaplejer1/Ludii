...
/** Auto-generated State subclass for TugiEpfe. */
public class TugiEpfeState extends State {
    ...
    public TugiEpfeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TugiEpfeState(final TugiEpfeState other) {
        super(other);
    ...
    @Override public TugiEpfeState copy() { return new TugiEpfeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TugiEpfeState o = (TugiEpfeState) other;
