...
/** Auto-generated State subclass for TalynBuga. */
public class TalynBugaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TalynBugaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TalynBugaState(final TalynBugaState other) {
        super(other);
    ...
    @Override public TalynBugaState copy() { return new TalynBugaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TalynBugaState o = (TalynBugaState) other;
