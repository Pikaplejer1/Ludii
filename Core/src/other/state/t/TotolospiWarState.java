...
/** Auto-generated State subclass for TotolospiWar. */
public class TotolospiWarState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TotolospiWarState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TotolospiWarState(final TotolospiWarState other) {
        super(other);
    ...
    @Override public TotolospiWarState copy() { return new TotolospiWarState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TotolospiWarState o = (TotolospiWarState) other;
