...
/** Auto-generated State subclass for Tavlej. */
public class TavlejState extends State {
    ...
    public TavlejState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TavlejState(final TavlejState other) {
        super(other);
    ...
    @Override public TavlejState copy() { return new TavlejState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TavlejState o = (TavlejState) other;
