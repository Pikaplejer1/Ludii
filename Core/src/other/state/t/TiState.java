...
/** Auto-generated State subclass for Ti. */
public class TiState extends State {
    ...
    public TiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TiState(final TiState other) {
        super(other);
    ...
    @Override public TiState copy() { return new TiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TiState o = (TiState) other;
