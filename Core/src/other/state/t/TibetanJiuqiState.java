...
/** Auto-generated State subclass for TibetanJiuqi. */
public class TibetanJiuqiState extends State {
    ...
    public TibetanJiuqiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TibetanJiuqiState(final TibetanJiuqiState other) {
        super(other);
    ...
    @Override public TibetanJiuqiState copy() { return new TibetanJiuqiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TibetanJiuqiState o = (TibetanJiuqiState) other;
