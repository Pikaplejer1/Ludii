...
/** Auto-generated State subclass for Tsaydithl. */
public class TsaydithlState extends State {
    ...
    public TsaydithlState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TsaydithlState(final TsaydithlState other) {
        super(other);
    ...
    @Override public TsaydithlState copy() { return new TsaydithlState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsaydithlState o = (TsaydithlState) other;
