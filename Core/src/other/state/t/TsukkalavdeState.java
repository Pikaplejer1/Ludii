...
/** Auto-generated State subclass for Tsukkalavde. */
public class TsukkalavdeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TsukkalavdeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TsukkalavdeState(final TsukkalavdeState other) {
        super(other);
    ...
    @Override public TsukkalavdeState copy() { return new TsukkalavdeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsukkalavdeState o = (TsukkalavdeState) other;
