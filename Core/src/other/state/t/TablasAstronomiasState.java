...
/** Auto-generated State subclass for TablasAstronomias. */
public class TablasAstronomiasState extends State {
    ...
    public TablasAstronomiasState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TablasAstronomiasState(final TablasAstronomiasState other) {
        super(other);
    ...
    @Override public TablasAstronomiasState copy() { return new TablasAstronomiasState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TablasAstronomiasState o = (TablasAstronomiasState) other;
