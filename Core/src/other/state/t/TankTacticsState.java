...
/** Auto-generated State subclass for TankTactics. */
public class TankTacticsState extends State {
    ...
    public TankTacticsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TankTacticsState(final TankTacticsState other) {
        super(other);
    ...
    @Override public TankTacticsState copy() { return new TankTacticsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TankTacticsState o = (TankTacticsState) other;
