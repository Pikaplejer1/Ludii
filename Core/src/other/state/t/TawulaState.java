...
/** Auto-generated State subclass for Tawula. */
public class TawulaState extends State {
    ...
    public TawulaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TawulaState(final TawulaState other) {
        super(other);
    ...
    @Override public TawulaState copy() { return new TawulaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TawulaState o = (TawulaState) other;
