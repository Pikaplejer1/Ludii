...
/** Auto-generated State subclass for TwoPlayerChaturangaAlBiruni. */
public class TwoPlayerChaturangaAlBiruniState extends State {
    ...
    public TwoPlayerChaturangaAlBiruniState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TwoPlayerChaturangaAlBiruniState(final TwoPlayerChaturangaAlBiruniState other) {
        super(other);
    ...
    @Override public TwoPlayerChaturangaAlBiruniState copy() { return new TwoPlayerChaturangaAlBiruniState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TwoPlayerChaturangaAlBiruniState o = (TwoPlayerChaturangaAlBiruniState) other;
