...
/** Auto-generated State subclass for Tsatsarandi. */
public class TsatsarandiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TsatsarandiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TsatsarandiState(final TsatsarandiState other) {
        super(other);
    ...
    @Override public TsatsarandiState copy() { return new TsatsarandiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsatsarandiState o = (TsatsarandiState) other;
