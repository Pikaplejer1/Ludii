...
/** Auto-generated State subclass for Trique. */
public class TriqueState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TriqueState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TriqueState(final TriqueState other) {
        super(other);
    ...
    @Override public TriqueState copy() { return new TriqueState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TriqueState o = (TriqueState) other;
