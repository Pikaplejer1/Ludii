...
/** Auto-generated State subclass for TsunKI. */
public class TsunKIState extends State {
    ...
    public TsunKIState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TsunKIState(final TsunKIState other) {
        super(other);
    ...
    @Override public TsunKIState copy() { return new TsunKIState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsunKIState o = (TsunKIState) other;
