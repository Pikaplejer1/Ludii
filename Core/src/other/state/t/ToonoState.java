...
/** Auto-generated State subclass for Toono. */
public class ToonoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ToonoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ToonoState(final ToonoState other) {
        super(other);
    ...
    @Override public ToonoState copy() { return new ToonoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ToonoState o = (ToonoState) other;
