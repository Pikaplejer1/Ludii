...
/** Auto-generated State subclass for Thales. */
public class ThalesState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ThalesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ThalesState(final ThalesState other) {
        super(other);
    ...
    @Override public ThalesState copy() { return new ThalesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThalesState o = (ThalesState) other;
