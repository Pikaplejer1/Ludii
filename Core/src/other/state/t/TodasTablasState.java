...
/** Auto-generated State subclass for TodasTablas. */
public class TodasTablasState extends State {
    ...
    public TodasTablasState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TodasTablasState(final TodasTablasState other) {
        super(other);
    ...
    @Override public TodasTablasState copy() { return new TodasTablasState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TodasTablasState o = (TodasTablasState) other;
