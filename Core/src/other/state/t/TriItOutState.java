...
/** Auto-generated State subclass for TriItOut. */
public class TriItOutState extends State {
    ...
    public TriItOutState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TriItOutState(final TriItOutState other) {
        super(other);
    ...
    @Override public TriItOutState copy() { return new TriItOutState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TriItOutState o = (TriItOutState) other;
