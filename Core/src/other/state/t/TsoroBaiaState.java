...
/** Auto-generated State subclass for TsoroBaia. */
public class TsoroBaiaState extends State {
    ...
    public TsoroBaiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TsoroBaiaState(final TsoroBaiaState other) {
        super(other);
    ...
    @Override public TsoroBaiaState copy() { return new TsoroBaiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsoroBaiaState o = (TsoroBaiaState) other;
