...
/** Auto-generated State subclass for TaikyokuShogi. */
public class TaikyokuShogiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TaikyokuShogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TaikyokuShogiState(final TaikyokuShogiState other) {
        super(other);
    ...
    @Override public TaikyokuShogiState copy() { return new TaikyokuShogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TaikyokuShogiState o = (TaikyokuShogiState) other;
