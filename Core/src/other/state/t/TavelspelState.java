...
/** Auto-generated State subclass for Tavelspel. */
public class TavelspelState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TavelspelState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TavelspelState(final TavelspelState other) {
        super(other);
    ...
    @Override public TavelspelState copy() { return new TavelspelState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TavelspelState o = (TavelspelState) other;
