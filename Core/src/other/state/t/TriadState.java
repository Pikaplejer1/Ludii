...
/** Auto-generated State subclass for Triad. */
public class TriadState extends State {
    ...
    public TriadState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TriadState(final TriadState other) {
        super(other);
    ...
    @Override public TriadState copy() { return new TriadState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TriadState o = (TriadState) other;
