...
/** Auto-generated State subclass for Tchela. */
public class TchelaState extends State {
    ...
    public TchelaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TchelaState(final TchelaState other) {
        super(other);
    ...
    @Override public TchelaState copy() { return new TchelaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TchelaState o = (TchelaState) other;
