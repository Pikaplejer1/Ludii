...
/** Auto-generated State subclass for TenjikuShogi. */
public class TenjikuShogiState extends State {
    ...
    public TenjikuShogiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TenjikuShogiState(final TenjikuShogiState other) {
        super(other);
    ...
    @Override public TenjikuShogiState copy() { return new TenjikuShogiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TenjikuShogiState o = (TenjikuShogiState) other;
