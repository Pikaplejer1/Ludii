...
/** Auto-generated State subclass for TennesseeWaltz. */
public class TennesseeWaltzState extends State {
    ...
    public TennesseeWaltzState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TennesseeWaltzState(final TennesseeWaltzState other) {
        super(other);
    ...
    @Override public TennesseeWaltzState copy() { return new TennesseeWaltzState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TennesseeWaltzState o = (TennesseeWaltzState) other;
