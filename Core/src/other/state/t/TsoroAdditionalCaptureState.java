...
/** Auto-generated State subclass for TsoroAdditionalCapture. */
public class TsoroAdditionalCaptureState extends State {
    ...
    public TsoroAdditionalCaptureState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TsoroAdditionalCaptureState(final TsoroAdditionalCaptureState other) {
        super(other);
    ...
    @Override public TsoroAdditionalCaptureState copy() { return new TsoroAdditionalCaptureState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TsoroAdditionalCaptureState o = (TsoroAdditionalCaptureState) other;
