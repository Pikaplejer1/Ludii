...
/** Auto-generated State subclass for TOki. */
public class TOkiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TOkiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TOkiState(final TOkiState other) {
        super(other);
    ...
    @Override public TOkiState copy() { return new TOkiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TOkiState o = (TOkiState) other;
