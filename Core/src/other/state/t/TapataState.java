...
/** Auto-generated State subclass for Tapata. */
public class TapataState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TapataState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TapataState(final TapataState other) {
        super(other);
    ...
    @Override public TapataState copy() { return new TapataState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TapataState o = (TapataState) other;
