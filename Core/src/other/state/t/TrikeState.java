...
/** Auto-generated State subclass for Trike. */
public class TrikeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public TrikeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TrikeState(final TrikeState other) {
        super(other);
    ...
    @Override public TrikeState copy() { return new TrikeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TrikeState o = (TrikeState) other;
