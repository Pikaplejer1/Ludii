...
/** Auto-generated State subclass for ToguzKumalak. */
public class ToguzKumalakState extends State {
    ...
    public ToguzKumalakState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ToguzKumalakState(final ToguzKumalakState other) {
        super(other);
    ...
    @Override public ToguzKumalakState copy() { return new ToguzKumalakState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ToguzKumalakState o = (ToguzKumalakState) other;
