...
/** Auto-generated State subclass for Tides. */
public class TidesState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TidesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TidesState(final TidesState other) {
        super(other);
    ...
    @Override public TidesState copy() { return new TidesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TidesState o = (TidesState) other;
