...
/** Auto-generated State subclass for Tablan. */
public class TablanState extends State {
    ...
    public TablanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TablanState(final TablanState other) {
        super(other);
    ...
    @Override public TablanState copy() { return new TablanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TablanState o = (TablanState) other;
