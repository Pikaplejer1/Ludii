...
/** Auto-generated State subclass for TablesRabbatuees. */
public class TablesRabbatueesState extends State {
    ...
    public TablesRabbatueesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TablesRabbatueesState(final TablesRabbatueesState other) {
        super(other);
    ...
    @Override public TablesRabbatueesState copy() { return new TablesRabbatueesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TablesRabbatueesState o = (TablesRabbatueesState) other;
