...
/** Auto-generated State subclass for Tepong. */
public class TepongState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public TepongState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TepongState(final TepongState other) {
        super(other);
    ...
    @Override public TepongState copy() { return new TepongState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TepongState o = (TepongState) other;
