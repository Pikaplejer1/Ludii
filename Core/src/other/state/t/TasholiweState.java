...
/** Auto-generated State subclass for Tasholiwe. */
public class TasholiweState extends State {
    ...
    public TasholiweState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TasholiweState(final TasholiweState other) {
        super(other);
    ...
    @Override public TasholiweState copy() { return new TasholiweState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TasholiweState o = (TasholiweState) other;
