...
/** Auto-generated State subclass for TayamSonalu. */
public class TayamSonaluState extends State {
    ...
    public TayamSonaluState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TayamSonaluState(final TayamSonaluState other) {
        super(other);
    ...
    @Override public TayamSonaluState copy() { return new TayamSonaluState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TayamSonaluState o = (TayamSonaluState) other;
