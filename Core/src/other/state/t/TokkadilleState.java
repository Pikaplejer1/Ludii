...
/** Auto-generated State subclass for Tokkadille. */
public class TokkadilleState extends State {
    ...
    public TokkadilleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TokkadilleState(final TokkadilleState other) {
        super(other);
    ...
    @Override public TokkadilleState copy() { return new TokkadilleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TokkadilleState o = (TokkadilleState) other;
