...
/** Auto-generated State subclass for ThreeMusketeers. */
public class ThreeMusketeersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ThreeMusketeersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ThreeMusketeersState(final ThreeMusketeersState other) {
        super(other);
    ...
    @Override public ThreeMusketeersState copy() { return new ThreeMusketeersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ThreeMusketeersState o = (ThreeMusketeersState) other;
