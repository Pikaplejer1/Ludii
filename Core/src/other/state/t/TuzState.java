...
/** Auto-generated State subclass for Tuz. */
public class TuzState extends State {
    ...
    public TuzState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TuzState(final TuzState other) {
        super(other);
    ...
    @Override public TuzState copy() { return new TuzState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TuzState o = (TuzState) other;
