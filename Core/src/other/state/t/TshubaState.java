...
/** Auto-generated State subclass for Tshuba. */
public class TshubaState extends State {
    ...
    public TshubaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public TshubaState(final TshubaState other) {
        super(other);
    ...
    @Override public TshubaState copy() { return new TshubaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TshubaState o = (TshubaState) other;
