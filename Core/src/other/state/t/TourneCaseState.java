...
/** Auto-generated State subclass for TourneCase. */
public class TourneCaseState extends State {
    ...
    public TourneCaseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public TourneCaseState(final TourneCaseState other) {
        super(other);
    ...
    @Override public TourneCaseState copy() { return new TourneCaseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final TourneCaseState o = (TourneCaseState) other;
