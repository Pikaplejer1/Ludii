...
/** Auto-generated State subclass for Qirkat. */
public class QirkatState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QirkatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QirkatState(final QirkatState other) {
        super(other);
    ...
    @Override public QirkatState copy() { return new QirkatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QirkatState o = (QirkatState) other;
