...
/** Auto-generated State subclass for Quendo. */
public class QuendoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QuendoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QuendoState(final QuendoState other) {
        super(other);
    ...
    @Override public QuendoState copy() { return new QuendoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuendoState o = (QuendoState) other;
