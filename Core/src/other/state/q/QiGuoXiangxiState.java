...
/** Auto-generated State subclass for QiGuoXiangxi. */
public class QiGuoXiangxiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QiGuoXiangxiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QiGuoXiangxiState(final QiGuoXiangxiState other) {
        super(other);
    ...
    @Override public QiGuoXiangxiState copy() { return new QiGuoXiangxiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QiGuoXiangxiState o = (QiGuoXiangxiState) other;
