...
/** Auto-generated State subclass for QuantumLeap. */
public class QuantumLeapState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QuantumLeapState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QuantumLeapState(final QuantumLeapState other) {
        super(other);
    ...
    @Override public QuantumLeapState copy() { return new QuantumLeapState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuantumLeapState o = (QuantumLeapState) other;
