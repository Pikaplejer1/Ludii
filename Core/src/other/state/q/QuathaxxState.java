...
/** Auto-generated State subclass for Quathaxx. */
public class QuathaxxState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QuathaxxState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QuathaxxState(final QuathaxxState other) {
        super(other);
    ...
    @Override public QuathaxxState copy() { return new QuathaxxState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuathaxxState o = (QuathaxxState) other;
