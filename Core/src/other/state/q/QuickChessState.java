...
/** Auto-generated State subclass for QuickChess. */
public class QuickChessState extends State {
    ...
    public QuickChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QuickChessState(final QuickChessState other) {
        super(other);
    ...
    @Override public QuickChessState copy() { return new QuickChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuickChessState o = (QuickChessState) other;
