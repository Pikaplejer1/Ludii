...
/** Auto-generated State subclass for QuinzeTablas. */
public class QuinzeTablasState extends State {
    ...
    public QuinzeTablasState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public QuinzeTablasState(final QuinzeTablasState other) {
        super(other);
    ...
    @Override public QuinzeTablasState copy() { return new QuinzeTablasState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuinzeTablasState o = (QuinzeTablasState) other;
