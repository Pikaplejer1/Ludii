...
/** Auto-generated State subclass for Quixo. */
public class QuixoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public QuixoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QuixoState(final QuixoState other) {
        super(other);
    ...
    @Override public QuixoState copy() { return new QuixoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QuixoState o = (QuixoState) other;
