...
/** Auto-generated State subclass for Qelat. */
public class QelatState extends State {
    ...
    public QelatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public QelatState(final QelatState other) {
        super(other);
    ...
    @Override public QelatState copy() { return new QelatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final QelatState o = (QelatState) other;
