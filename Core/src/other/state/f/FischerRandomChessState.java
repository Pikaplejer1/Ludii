...
/** Auto-generated State subclass for FischerRandomChess. */
public class FischerRandomChessState extends State {
    ...
    public FischerRandomChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FischerRandomChessState(final FischerRandomChessState other) {
        super(other);
    ...
    @Override public FischerRandomChessState copy() { return new FischerRandomChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FischerRandomChessState o = (FischerRandomChessState) other;
