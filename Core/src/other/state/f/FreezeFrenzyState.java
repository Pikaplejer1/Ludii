...
/** Auto-generated State subclass for FreezeFrenzy. */
public class FreezeFrenzyState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FreezeFrenzyState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FreezeFrenzyState(final FreezeFrenzyState other) {
        super(other);
    ...
    @Override public FreezeFrenzyState copy() { return new FreezeFrenzyState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FreezeFrenzyState o = (FreezeFrenzyState) other;
