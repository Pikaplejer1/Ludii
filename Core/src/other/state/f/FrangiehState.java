...
/** Auto-generated State subclass for Frangieh. */
public class FrangiehState extends State {
    ...
    public FrangiehState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public FrangiehState(final FrangiehState other) {
        super(other);
    ...
    @Override public FrangiehState copy() { return new FrangiehState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FrangiehState o = (FrangiehState) other;
