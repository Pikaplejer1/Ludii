...
/** Auto-generated State subclass for Fang. */
public class FangState extends State {
    ...
    public FangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FangState(final FangState other) {
        super(other);
    ...
    @Override public FangState copy() { return new FangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FangState o = (FangState) other;
