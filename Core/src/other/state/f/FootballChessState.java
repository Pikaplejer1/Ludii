...
/** Auto-generated State subclass for FootballChess. */
public class FootballChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public FootballChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FootballChessState(final FootballChessState other) {
        super(other);
    ...
    @Override public FootballChessState copy() { return new FootballChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FootballChessState o = (FootballChessState) other;
