...
/** Auto-generated State subclass for Feldja. */
public class FeldjaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FeldjaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FeldjaState(final FeldjaState other) {
        super(other);
    ...
    @Override public FeldjaState copy() { return new FeldjaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FeldjaState o = (FeldjaState) other;
