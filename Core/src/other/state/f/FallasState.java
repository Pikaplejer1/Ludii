...
/** Auto-generated State subclass for Fallas. */
public class FallasState extends State {
    ...
    public FallasState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public FallasState(final FallasState other) {
        super(other);
    ...
    @Override public FallasState copy() { return new FallasState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FallasState o = (FallasState) other;
