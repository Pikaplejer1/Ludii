...
/** Auto-generated State subclass for FergenGobale. */
public class FergenGobaleState extends State {
    ...
    public FergenGobaleState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public FergenGobaleState(final FergenGobaleState other) {
        super(other);
    ...
    @Override public FergenGobaleState copy() { return new FergenGobaleState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FergenGobaleState o = (FergenGobaleState) other;
