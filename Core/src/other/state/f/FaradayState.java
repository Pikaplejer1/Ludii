...
/** Auto-generated State subclass for Faraday. */
public class FaradayState extends State {
    ...
    public FaradayState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FaradayState(final FaradayState other) {
        super(other);
    ...
    @Override public FaradayState copy() { return new FaradayState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FaradayState o = (FaradayState) other;
