...
/** Auto-generated State subclass for FrisianDraughts. */
public class FrisianDraughtsState extends State {
    ...
    public FrisianDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FrisianDraughtsState(final FrisianDraughtsState other) {
        super(other);
    ...
    @Override public FrisianDraughtsState copy() { return new FrisianDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FrisianDraughtsState o = (FrisianDraughtsState) other;
