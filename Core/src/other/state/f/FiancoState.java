...
/** Auto-generated State subclass for Fianco. */
public class FiancoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FiancoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FiancoState(final FiancoState other) {
        super(other);
    ...
    @Override public FiancoState copy() { return new FiancoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FiancoState o = (FiancoState) other;
