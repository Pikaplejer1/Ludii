...
/** Auto-generated State subclass for Fortresse. */
public class FortresseState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FortresseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FortresseState(final FortresseState other) {
        super(other);
    ...
    @Override public FortresseState copy() { return new FortresseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FortresseState o = (FortresseState) other;
