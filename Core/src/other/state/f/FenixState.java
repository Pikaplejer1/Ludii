...
/** Auto-generated State subclass for Fenix. */
public class FenixState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FenixState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FenixState(final FenixState other) {
        super(other);
    ...
    @Override public FenixState copy() { return new FenixState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FenixState o = (FenixState) other;
