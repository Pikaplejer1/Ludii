...
/** Auto-generated State subclass for FourPlayerChaturangaAlBiruni. */
public class FourPlayerChaturangaAlBiruniState extends State {
    ...
    public FourPlayerChaturangaAlBiruniState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public FourPlayerChaturangaAlBiruniState(final FourPlayerChaturangaAlBiruniState other) {
        super(other);
    ...
    @Override public FourPlayerChaturangaAlBiruniState copy() { return new FourPlayerChaturangaAlBiruniState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FourPlayerChaturangaAlBiruniState o = (FourPlayerChaturangaAlBiruniState) other;
