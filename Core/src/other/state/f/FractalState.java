...
/** Auto-generated State subclass for Fractal. */
public class FractalState extends State {
    ...
    public FractalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FractalState(final FractalState other) {
        super(other);
    ...
    @Override public FractalState copy() { return new FractalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FractalState o = (FractalState) other;
