...
/** Auto-generated State subclass for FourPlayerChess. */
public class FourPlayerChessState extends State {
    ...
    public FourPlayerChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FourPlayerChessState(final FourPlayerChessState other) {
        super(other);
    ...
    @Override public FourPlayerChessState copy() { return new FourPlayerChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FourPlayerChessState o = (FourPlayerChessState) other;
