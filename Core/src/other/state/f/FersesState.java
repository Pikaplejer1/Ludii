...
/** Auto-generated State subclass for Ferses. */
public class FersesState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FersesState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FersesState(final FersesState other) {
        super(other);
    ...
    @Override public FersesState copy() { return new FersesState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FersesState o = (FersesState) other;
