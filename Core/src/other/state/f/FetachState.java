...
/** Auto-generated State subclass for Fetach. */
public class FetachState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public FetachState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FetachState(final FetachState other) {
        super(other);
    ...
    @Override public FetachState copy() { return new FetachState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FetachState o = (FetachState) other;
