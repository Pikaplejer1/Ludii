...
/** Auto-generated State subclass for Fanorona. */
public class FanoronaState extends State {
    ...
    public FanoronaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public FanoronaState(final FanoronaState other) {
        super(other);
    ...
    @Override public FanoronaState copy() { return new FanoronaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FanoronaState o = (FanoronaState) other;
