...
/** Auto-generated State subclass for FourFang. */
public class FourFangState extends State {
    ...
    public FourFangState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FourFangState(final FourFangState other) {
        super(other);
    ...
    @Override public FourFangState copy() { return new FourFangState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FourFangState o = (FourFangState) other;
