...
/** Auto-generated State subclass for Fevga. */
public class FevgaState extends State {
    ...
    public FevgaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public FevgaState(final FevgaState other) {
        super(other);
    ...
    @Override public FevgaState copy() { return new FevgaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FevgaState o = (FevgaState) other;
