...
/** Auto-generated State subclass for Forcado. */
public class ForcadoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ForcadoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ForcadoState(final ForcadoState other) {
        super(other);
    ...
    @Override public ForcadoState copy() { return new ForcadoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ForcadoState o = (ForcadoState) other;
