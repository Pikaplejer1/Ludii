...
/** Auto-generated State subclass for Fondji. */
public class FondjiState extends State {
    ...
    public FondjiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FondjiState(final FondjiState other) {
        super(other);
    ...
    @Override public FondjiState copy() { return new FondjiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FondjiState o = (FondjiState) other;
