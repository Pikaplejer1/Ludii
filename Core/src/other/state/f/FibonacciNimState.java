...
/** Auto-generated State subclass for FibonacciNim. */
public class FibonacciNimState extends State {
    ...
    public FibonacciNimState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public FibonacciNimState(final FibonacciNimState other) {
        super(other);
    ...
    @Override public FibonacciNimState copy() { return new FibonacciNimState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final FibonacciNimState o = (FibonacciNimState) other;
