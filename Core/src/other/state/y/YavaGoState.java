...
/** Auto-generated State subclass for YavaGo. */
public class YavaGoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public YavaGoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YavaGoState(final YavaGoState other) {
        super(other);
    ...
    @Override public YavaGoState copy() { return new YavaGoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YavaGoState o = (YavaGoState) other;
