...
/** Auto-generated State subclass for YoninSeireigi. */
public class YoninSeireigiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public YoninSeireigiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YoninSeireigiState(final YoninSeireigiState other) {
        super(other);
    ...
    @Override public YoninSeireigiState copy() { return new YoninSeireigiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YoninSeireigiState o = (YoninSeireigiState) other;
