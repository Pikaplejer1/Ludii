...
/** Auto-generated State subclass for Yucebao. */
public class YucebaoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public YucebaoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YucebaoState(final YucebaoState other) {
        super(other);
    ...
    @Override public YucebaoState copy() { return new YucebaoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YucebaoState o = (YucebaoState) other;
