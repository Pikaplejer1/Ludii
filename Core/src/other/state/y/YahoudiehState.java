...
/** Auto-generated State subclass for Yahoudieh. */
public class YahoudiehState extends State {
    ...
    public YahoudiehState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public YahoudiehState(final YahoudiehState other) {
        super(other);
    ...
    @Override public YahoudiehState copy() { return new YahoudiehState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YahoudiehState o = (YahoudiehState) other;
