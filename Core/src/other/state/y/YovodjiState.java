...
/** Auto-generated State subclass for Yovodji. */
public class YovodjiState extends State {
    ...
    public YovodjiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YovodjiState(final YovodjiState other) {
        super(other);
    ...
    @Override public YovodjiState copy() { return new YovodjiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YovodjiState o = (YovodjiState) other;
