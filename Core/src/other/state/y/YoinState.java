...
/** Auto-generated State subclass for Yoin. */
public class YoinState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public YoinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YoinState(final YoinState other) {
        super(other);
    ...
    @Override public YoinState copy() { return new YoinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YoinState o = (YoinState) other;
