...
/** Auto-generated State subclass for YupIkCheckers. */
public class YupIkCheckersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public YupIkCheckersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YupIkCheckersState(final YupIkCheckersState other) {
        super(other);
    ...
    @Override public YupIkCheckersState copy() { return new YupIkCheckersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YupIkCheckersState o = (YupIkCheckersState) other;
