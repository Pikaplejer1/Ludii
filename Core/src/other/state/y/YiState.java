...
/** Auto-generated State subclass for Yi. */
public class YiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public YiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public YiState(final YiState other) {
        super(other);
    ...
    @Override public YiState copy() { return new YiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final YiState o = (YiState) other;
