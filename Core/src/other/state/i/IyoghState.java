...
/** Auto-generated State subclass for Iyogh. */
public class IyoghState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public IyoghState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IyoghState(final IyoghState other) {
        super(other);
    ...
    @Override public IyoghState copy() { return new IyoghState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IyoghState o = (IyoghState) other;
