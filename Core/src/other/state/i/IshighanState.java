...
/** Auto-generated State subclass for Ishighan. */
public class IshighanState extends State {
    ...
    public IshighanState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public IshighanState(final IshighanState other) {
        super(other);
    ...
    @Override public IshighanState copy() { return new IshighanState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IshighanState o = (IshighanState) other;
