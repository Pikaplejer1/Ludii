...
/** Auto-generated State subclass for IkibuguzoOpening1. */
public class IkibuguzoOpening1State extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public IkibuguzoOpening1State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IkibuguzoOpening1State(final IkibuguzoOpening1State other) {
        super(other);
    ...
    @Override public IkibuguzoOpening1State copy() { return new IkibuguzoOpening1State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IkibuguzoOpening1State o = (IkibuguzoOpening1State) other;
