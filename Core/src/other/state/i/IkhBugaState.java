...
/** Auto-generated State subclass for IkhBuga. */
public class IkhBugaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public IkhBugaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IkhBugaState(final IkhBugaState other) {
        super(other);
    ...
    @Override public IkhBugaState copy() { return new IkhBugaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IkhBugaState o = (IkhBugaState) other;
