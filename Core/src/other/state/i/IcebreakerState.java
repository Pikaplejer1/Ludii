...
/** Auto-generated State subclass for Icebreaker. */
public class IcebreakerState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public IcebreakerState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IcebreakerState(final IcebreakerState other) {
        super(other);
    ...
    @Override public IcebreakerState copy() { return new IcebreakerState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IcebreakerState o = (IcebreakerState) other;
