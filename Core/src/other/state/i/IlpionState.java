...
/** Auto-generated State subclass for Ilpion. */
public class IlpionState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public IlpionState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IlpionState(final IlpionState other) {
        super(other);
    ...
    @Override public IlpionState copy() { return new IlpionState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IlpionState o = (IlpionState) other;
