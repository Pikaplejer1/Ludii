...
/** Auto-generated State subclass for Issiren. */
public class IssirenState extends State {
    ...
    public IssirenState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public IssirenState(final IssirenState other) {
        super(other);
    ...
    @Override public IssirenState copy() { return new IssirenState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IssirenState o = (IssirenState) other;
