...
/** Auto-generated State subclass for IPere. */
public class IPereState extends State {
    ...
    public IPereState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IPereState(final IPereState other) {
        super(other);
    ...
    @Override public IPereState copy() { return new IPereState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IPereState o = (IPereState) other;
