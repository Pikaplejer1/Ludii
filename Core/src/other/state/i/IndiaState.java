...
/** Auto-generated State subclass for India. */
public class IndiaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public IndiaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IndiaState(final IndiaState other) {
        super(other);
    ...
    @Override public IndiaState copy() { return new IndiaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IndiaState o = (IndiaState) other;
