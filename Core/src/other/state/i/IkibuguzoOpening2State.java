...
/** Auto-generated State subclass for IkibuguzoOpening2. */
public class IkibuguzoOpening2State extends State {
    ...
    public IkibuguzoOpening2State(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IkibuguzoOpening2State(final IkibuguzoOpening2State other) {
        super(other);
    ...
    @Override public IkibuguzoOpening2State copy() { return new IkibuguzoOpening2State(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IkibuguzoOpening2State o = (IkibuguzoOpening2State) other;
