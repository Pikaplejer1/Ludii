...
/** Auto-generated State subclass for InternationalDraughts. */
public class InternationalDraughtsState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public InternationalDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public InternationalDraughtsState(final InternationalDraughtsState other) {
        super(other);
    ...
    @Override public InternationalDraughtsState copy() { return new InternationalDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final InternationalDraughtsState o = (InternationalDraughtsState) other;
