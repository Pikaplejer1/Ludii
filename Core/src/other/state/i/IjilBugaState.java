...
/** Auto-generated State subclass for IjilBuga. */
public class IjilBugaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public IjilBugaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public IjilBugaState(final IjilBugaState other) {
        super(other);
    ...
    @Override public IjilBugaState copy() { return new IjilBugaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final IjilBugaState o = (IjilBugaState) other;
