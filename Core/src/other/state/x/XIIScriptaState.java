...
/** Auto-generated State subclass for XIIScripta. */
public class XIIScriptaState extends State {
    ...
    public XIIScriptaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public XIIScriptaState(final XIIScriptaState other) {
        super(other);
    ...
    @Override public XIIScriptaState copy() { return new XIIScriptaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final XIIScriptaState o = (XIIScriptaState) other;
