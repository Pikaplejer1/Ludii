...
/** Auto-generated State subclass for XiangHex. */
public class XiangHexState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public XiangHexState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public XiangHexState(final XiangHexState other) {
        super(other);
    ...
    @Override public XiangHexState copy() { return new XiangHexState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final XiangHexState o = (XiangHexState) other;
