...
/** Auto-generated State subclass for XoninShatarComplex. */
public class XoninShatarComplexState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public XoninShatarComplexState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public XoninShatarComplexState(final XoninShatarComplexState other) {
        super(other);
    ...
    @Override public XoninShatarComplexState copy() { return new XoninShatarComplexState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final XoninShatarComplexState o = (XoninShatarComplexState) other;
