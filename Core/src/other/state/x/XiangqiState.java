...
/** Auto-generated State subclass for Xiangqi. */
public class XiangqiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public XiangqiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public XiangqiState(final XiangqiState other) {
        super(other);
    ...
    @Override public XiangqiState copy() { return new XiangqiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final XiangqiState o = (XiangqiState) other;
