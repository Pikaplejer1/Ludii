...
/** Auto-generated State subclass for Virus. */
public class VirusState extends State {
    ...
    public VirusState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public VirusState(final VirusState other) {
        super(other);
    ...
    @Override public VirusState copy() { return new VirusState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VirusState o = (VirusState) other;
