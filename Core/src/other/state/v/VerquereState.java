...
/** Auto-generated State subclass for Verquere. */
public class VerquereState extends State {
    ...
    public VerquereState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public VerquereState(final VerquereState other) {
        super(other);
    ...
    @Override public VerquereState copy() { return new VerquereState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VerquereState o = (VerquereState) other;
