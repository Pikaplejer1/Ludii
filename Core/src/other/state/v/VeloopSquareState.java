...
/** Auto-generated State subclass for VeloopSquare. */
public class VeloopSquareState extends State {
    ...
    public VeloopSquareState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public VeloopSquareState(final VeloopSquareState other) {
        super(other);
    ...
    @Override public VeloopSquareState copy() { return new VeloopSquareState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VeloopSquareState o = (VeloopSquareState) other;
