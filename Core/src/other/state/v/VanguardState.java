...
/** Auto-generated State subclass for Vanguard. */
public class VanguardState extends State {
    ...
    public VanguardState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public VanguardState(final VanguardState other) {
        super(other);
    ...
    @Override public VanguardState copy() { return new VanguardState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VanguardState o = (VanguardState) other;
