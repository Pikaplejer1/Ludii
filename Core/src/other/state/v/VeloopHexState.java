...
/** Auto-generated State subclass for VeloopHex. */
public class VeloopHexState extends State {
    ...
    public VeloopHexState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public VeloopHexState(final VeloopHexState other) {
        super(other);
    ...
    @Override public VeloopHexState copy() { return new VeloopHexState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VeloopHexState o = (VeloopHexState) other;
