...
/** Auto-generated State subclass for Vigilance. */
public class VigilanceState extends State {
    ...
    public VigilanceState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public VigilanceState(final VigilanceState other) {
        super(other);
    ...
    @Override public VigilanceState copy() { return new VigilanceState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VigilanceState o = (VigilanceState) other;
