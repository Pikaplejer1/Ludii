...
/** Auto-generated State subclass for Vela. */
public class VelaState extends State {
    ...
    public VelaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresVisited()) visited = new java.util.BitSet(game.board().numSites());
    }

    public VelaState(final VelaState other) {
        super(other);
    ...
    @Override public VelaState copy() { return new VelaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final VelaState o = (VelaState) other;
