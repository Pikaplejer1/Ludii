...
/** Auto-generated State subclass for Azteka. */
public class AztekaState extends State {
    ...
    public AztekaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AztekaState(final AztekaState other) {
        super(other);
    ...
    @Override public AztekaState copy() { return new AztekaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AztekaState o = (AztekaState) other;
