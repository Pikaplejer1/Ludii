...
/** Auto-generated State subclass for Alquerque. */
public class AlquerqueState extends State {
    ...
    public AlquerqueState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AlquerqueState(final AlquerqueState other) {
        super(other);
    ...
    @Override public AlquerqueState copy() { return new AlquerqueState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AlquerqueState o = (AlquerqueState) other;
