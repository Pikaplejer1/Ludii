...
/** Auto-generated State subclass for AjSakakil. */
public class AjSakakilState extends State {
    ...
    public AjSakakilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AjSakakilState(final AjSakakilState other) {
        super(other);
    ...
    @Override public AjSakakilState copy() { return new AjSakakilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AjSakakilState o = (AjSakakilState) other;
