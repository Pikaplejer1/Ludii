...
/** Auto-generated State subclass for Annuvin. */
public class AnnuvinState extends State {
    ...
    public AnnuvinState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AnnuvinState(final AnnuvinState other) {
        super(other);
    ...
    @Override public AnnuvinState copy() { return new AnnuvinState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AnnuvinState o = (AnnuvinState) other;
