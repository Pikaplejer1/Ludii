...
/** Auto-generated State subclass for Ataxx. */
public class AtaxxState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AtaxxState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AtaxxState(final AtaxxState other) {
        super(other);
    ...
    @Override public AtaxxState copy() { return new AtaxxState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AtaxxState o = (AtaxxState) other;
