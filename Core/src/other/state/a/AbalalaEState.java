...
/** Auto-generated State subclass for AbalalaE. */
public class AbalalaEState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.set.hash.TIntHashSet pendingValues = new gnu.trove.set.hash.TIntHashSet();

    public AbalalaEState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AbalalaEState(final AbalalaEState other) {
        super(other);
    ...
    @Override public AbalalaEState copy() { return new AbalalaEState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AbalalaEState o = (AbalalaEState) other;
