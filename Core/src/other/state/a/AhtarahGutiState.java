...
/** Auto-generated State subclass for AhtarahGuti. */
public class AhtarahGutiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AhtarahGutiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AhtarahGutiState(final AhtarahGutiState other) {
        super(other);
    ...
    @Override public AhtarahGutiState copy() { return new AhtarahGutiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AhtarahGutiState o = (AhtarahGutiState) other;
