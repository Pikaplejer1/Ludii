...
/** Auto-generated State subclass for AstralesceAndConstellation. */
public class AstralesceAndConstellationState extends State {
    ...
    public AstralesceAndConstellationState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AstralesceAndConstellationState(final AstralesceAndConstellationState other) {
        super(other);
    ...
    @Override public AstralesceAndConstellationState copy() { return new AstralesceAndConstellationState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AstralesceAndConstellationState o = (AstralesceAndConstellationState) other;
