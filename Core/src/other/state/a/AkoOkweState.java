...
/** Auto-generated State subclass for AkoOkwe. */
public class AkoOkweState extends State {
    ...
    public AkoOkweState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AkoOkweState(final AkoOkweState other) {
        super(other);
    ...
    @Override public AkoOkweState copy() { return new AkoOkweState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AkoOkweState o = (AkoOkweState) other;
