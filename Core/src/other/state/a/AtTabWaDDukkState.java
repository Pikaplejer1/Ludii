...
/** Auto-generated State subclass for AtTabWaDDukk. */
public class AtTabWaDDukkState extends State {
    ...
    public AtTabWaDDukkState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AtTabWaDDukkState(final AtTabWaDDukkState other) {
        super(other);
    ...
    @Override public AtTabWaDDukkState copy() { return new AtTabWaDDukkState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AtTabWaDDukkState o = (AtTabWaDDukkState) other;
