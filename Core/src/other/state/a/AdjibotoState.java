...
/** Auto-generated State subclass for Adjiboto. */
public class AdjibotoState extends State {
    ...
    public AdjibotoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AdjibotoState(final AdjibotoState other) {
        super(other);
    ...
    @Override public AdjibotoState copy() { return new AdjibotoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AdjibotoState o = (AdjibotoState) other;
