...
/** Auto-generated State subclass for Asalto. */
public class AsaltoState extends State {
    ...
    public AsaltoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AsaltoState(final AsaltoState other) {
        super(other);
    ...
    @Override public AsaltoState copy() { return new AsaltoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AsaltoState o = (AsaltoState) other;
