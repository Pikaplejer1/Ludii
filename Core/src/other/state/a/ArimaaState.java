...
/** Auto-generated State subclass for Arimaa. */
public class ArimaaState extends State {
    ...
    public ArimaaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ArimaaState(final ArimaaState other) {
        super(other);
    ...
    @Override public ArimaaState copy() { return new ArimaaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ArimaaState o = (ArimaaState) other;
