...
/** Auto-generated State subclass for Awagagae. */
public class AwagagaeState extends State {
    ...
    public AwagagaeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AwagagaeState(final AwagagaeState other) {
        super(other);
    ...
    @Override public AwagagaeState copy() { return new AwagagaeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AwagagaeState o = (AwagagaeState) other;
