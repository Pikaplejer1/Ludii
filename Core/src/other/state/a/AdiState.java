...
/** Auto-generated State subclass for Adi. */
public class AdiState extends State {
    ...
    public AdiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AdiState(final AdiState other) {
        super(other);
    ...
    @Override public AdiState copy() { return new AdiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AdiState o = (AdiState) other;
