...
/** Auto-generated State subclass for Alquerkonane. */
public class AlquerkonaneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AlquerkonaneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AlquerkonaneState(final AlquerkonaneState other) {
        super(other);
    ...
    @Override public AlquerkonaneState copy() { return new AlquerkonaneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AlquerkonaneState o = (AlquerkonaneState) other;
