...
/** Auto-generated State subclass for Awithlaknakwe. */
public class AwithlaknakweState extends State {
    ...
    public AwithlaknakweState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
        if (game.requiresTeams()) teams = new int[game.players().size()];
    }

    public AwithlaknakweState(final AwithlaknakweState other) {
        super(other);
    ...
    @Override public AwithlaknakweState copy() { return new AwithlaknakweState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AwithlaknakweState o = (AwithlaknakweState) other;
