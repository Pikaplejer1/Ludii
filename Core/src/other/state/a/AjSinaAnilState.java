...
/** Auto-generated State subclass for AjSinaAnil. */
public class AjSinaAnilState extends State {
    ...
    public AjSinaAnilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AjSinaAnilState(final AjSinaAnilState other) {
        super(other);
    ...
    @Override public AjSinaAnilState copy() { return new AjSinaAnilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AjSinaAnilState o = (AjSinaAnilState) other;
