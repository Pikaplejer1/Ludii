...
/** Auto-generated State subclass for AleaEvangelii. */
public class AleaEvangeliiState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AleaEvangeliiState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AleaEvangeliiState(final AleaEvangeliiState other) {
        super(other);
    ...
    @Override public AleaEvangeliiState copy() { return new AleaEvangeliiState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AleaEvangeliiState o = (AleaEvangeliiState) other;
