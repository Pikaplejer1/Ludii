...
/** Auto-generated State subclass for AjTIwil. */
public class AjTIwilState extends State {
    ...
    public AjTIwilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AjTIwilState(final AjTIwilState other) {
        super(other);
    ...
    @Override public AjTIwilState copy() { return new AjTIwilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AjTIwilState o = (AjTIwilState) other;
