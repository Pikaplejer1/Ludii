...
/** Auto-generated State subclass for Azigo. */
public class AzigoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.map.TObjectIntMap<String> valueMap = new gnu.trove.map.hash.TObjectIntHashMap<>();

    public AzigoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AzigoState(final AzigoState other) {
        super(other);
    ...
    @Override public AzigoState copy() { return new AzigoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AzigoState o = (AzigoState) other;
