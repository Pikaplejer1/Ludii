...
/** Auto-generated State subclass for AtomicChess. */
public class AtomicChessState extends State {
    ...
    public AtomicChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AtomicChessState(final AtomicChessState other) {
        super(other);
    ...
    @Override public AtomicChessState copy() { return new AtomicChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AtomicChessState o = (AtomicChessState) other;
