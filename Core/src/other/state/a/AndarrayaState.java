...
/** Auto-generated State subclass for Andarraya. */
public class AndarrayaState extends State {
    ...
    public AndarrayaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AndarrayaState(final AndarrayaState other) {
        super(other);
    ...
    @Override public AndarrayaState copy() { return new AndarrayaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AndarrayaState o = (AndarrayaState) other;
