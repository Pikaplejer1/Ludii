...
/** Auto-generated State subclass for AshtaKashte. */
public class AshtaKashteState extends State {
    ...
    public AshtaKashteState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AshtaKashteState(final AshtaKashteState other) {
        super(other);
    ...
    @Override public AshtaKashteState copy() { return new AshtaKashteState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AshtaKashteState o = (AshtaKashteState) other;
