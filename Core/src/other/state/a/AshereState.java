...
/** Auto-generated State subclass for Ashere. */
public class AshereState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AshereState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AshereState(final AshereState other) {
        super(other);
    ...
    @Override public AshereState copy() { return new AshereState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AshereState o = (AshereState) other;
