...
/** Auto-generated State subclass for AtariGo. */
public class AtariGoState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AtariGoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AtariGoState(final AtariGoState other) {
        super(other);
    ...
    @Override public AtariGoState copy() { return new AtariGoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AtariGoState o = (AtariGoState) other;
