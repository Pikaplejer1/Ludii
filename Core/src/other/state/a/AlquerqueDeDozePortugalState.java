...
/** Auto-generated State subclass for AlquerqueDeDozePortugal. */
public class AlquerqueDeDozePortugalState extends State {
    ...
    public AlquerqueDeDozePortugalState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AlquerqueDeDozePortugalState(final AlquerqueDeDozePortugalState other) {
        super(other);
    ...
    @Override public AlquerqueDeDozePortugalState copy() { return new AlquerqueDeDozePortugalState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AlquerqueDeDozePortugalState o = (AlquerqueDeDozePortugalState) other;
