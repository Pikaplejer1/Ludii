...
/** Auto-generated State subclass for Apocalypse. */
public class ApocalypseState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ApocalypseState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ApocalypseState(final ApocalypseState other) {
        super(other);
    ...
    @Override public ApocalypseState copy() { return new ApocalypseState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ApocalypseState o = (ApocalypseState) other;
