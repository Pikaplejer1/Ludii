...
/** Auto-generated State subclass for Adhesion. */
public class AdhesionState extends State {
    ...
    public AdhesionState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AdhesionState(final AdhesionState other) {
        super(other);
    ...
    @Override public AdhesionState copy() { return new AdhesionState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AdhesionState o = (AdhesionState) other;
