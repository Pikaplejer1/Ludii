...
/** Auto-generated State subclass for AKAakIl. */
public class AKAakIlState extends State {
    ...
    public AKAakIlState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AKAakIlState(final AKAakIlState other) {
        super(other);
    ...
    @Override public AKAakIlState copy() { return new AKAakIlState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AKAakIlState o = (AKAakIlState) other;
