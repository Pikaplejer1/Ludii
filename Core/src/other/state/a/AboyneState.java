...
/** Auto-generated State subclass for Aboyne. */
public class AboyneState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AboyneState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AboyneState(final AboyneState other) {
        super(other);
    ...
    @Override public AboyneState copy() { return new AboyneState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AboyneState o = (AboyneState) other;
