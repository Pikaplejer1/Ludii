...
/** Auto-generated State subclass for Aiyawatstani. */
public class AiyawatstaniState extends State {
    ...
    public AiyawatstaniState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AiyawatstaniState(final AiyawatstaniState other) {
        super(other);
    ...
    @Override public AiyawatstaniState copy() { return new AiyawatstaniState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AiyawatstaniState o = (AiyawatstaniState) other;
