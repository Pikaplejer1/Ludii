...
/** Auto-generated State subclass for Archworm. */
public class ArchwormState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ArchwormState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ArchwormState(final ArchwormState other) {
        super(other);
    ...
    @Override public ArchwormState copy() { return new ArchwormState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ArchwormState o = (ArchwormState) other;
