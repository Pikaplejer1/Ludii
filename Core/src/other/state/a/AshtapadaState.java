...
/** Auto-generated State subclass for Ashtapada. */
public class AshtapadaState extends State {
    ...
    public AshtapadaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AshtapadaState(final AshtapadaState other) {
        super(other);
    ...
    @Override public AshtapadaState copy() { return new AshtapadaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AshtapadaState o = (AshtapadaState) other;
