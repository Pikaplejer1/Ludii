...
/** Auto-generated State subclass for Aime. */
public class AimeState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AimeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AimeState(final AimeState other) {
        super(other);
    ...
    @Override public AimeState copy() { return new AimeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AimeState o = (AimeState) other;
