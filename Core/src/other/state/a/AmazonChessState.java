...
/** Auto-generated State subclass for AmazonChess. */
public class AmazonChessState extends State {
    ...
    public AmazonChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AmazonChessState(final AmazonChessState other) {
        super(other);
    ...
    @Override public AmazonChessState copy() { return new AmazonChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AmazonChessState o = (AmazonChessState) other;
