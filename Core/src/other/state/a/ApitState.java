...
/** Auto-generated State subclass for Apit. */
public class ApitState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public ApitState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public ApitState(final ApitState other) {
        super(other);
    ...
    @Override public ApitState copy() { return new ApitState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final ApitState o = (ApitState) other;
