...
/** Auto-generated State subclass for AshantiAlignmentGame. */
public class AshantiAlignmentGameState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AshantiAlignmentGameState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AshantiAlignmentGameState(final AshantiAlignmentGameState other) {
        super(other);
    ...
    @Override public AshantiAlignmentGameState copy() { return new AshantiAlignmentGameState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AshantiAlignmentGameState o = (AshantiAlignmentGameState) other;
