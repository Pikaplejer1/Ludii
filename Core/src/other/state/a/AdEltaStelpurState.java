...
/** Auto-generated State subclass for AdEltaStelpur. */
public class AdEltaStelpurState extends State {
    ...
    public AdEltaStelpurState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AdEltaStelpurState(final AdEltaStelpurState other) {
        super(other);
    ...
    @Override public AdEltaStelpurState copy() { return new AdEltaStelpurState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AdEltaStelpurState o = (AdEltaStelpurState) other;
