...
/** Auto-generated State subclass for Abrobad. */
public class AbrobadState extends State {
    ...
    public AbrobadState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AbrobadState(final AbrobadState other) {
        super(other);
    ...
    @Override public AbrobadState copy() { return new AbrobadState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AbrobadState o = (AbrobadState) other;
