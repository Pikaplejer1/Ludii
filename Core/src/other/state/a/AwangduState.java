...
/** Auto-generated State subclass for Awangdu. */
public class AwangduState extends State {
    ...
    public AwangduState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AwangduState(final AwangduState other) {
        super(other);
    ...
    @Override public AwangduState copy() { return new AwangduState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AwangduState o = (AwangduState) other;
