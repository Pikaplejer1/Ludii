...
/** Auto-generated State subclass for Allemande. */
public class AllemandeState extends State {
    ...
    public AllemandeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AllemandeState(final AllemandeState other) {
        super(other);
    ...
    @Override public AllemandeState copy() { return new AllemandeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AllemandeState o = (AllemandeState) other;
