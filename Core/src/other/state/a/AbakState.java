...
/** Auto-generated State subclass for Abak. */
public class AbakState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public AbakState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AbakState(final AbakState other) {
        super(other);
    ...
    @Override public AbakState copy() { return new AbakState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AbakState o = (AbakState) other;
