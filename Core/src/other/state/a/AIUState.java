...
/** Auto-generated State subclass for AIU. */
public class AIUState extends State {
    ...
    public AIUState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AIUState(final AIUState other) {
        super(other);
    ...
    @Override public AIUState copy() { return new AIUState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AIUState o = (AIUState) other;
