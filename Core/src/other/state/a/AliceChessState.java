...
/** Auto-generated State subclass for AliceChess. */
public class AliceChessState extends State {
    ...
    public AliceChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AliceChessState(final AliceChessState other) {
        super(other);
    ...
    @Override public AliceChessState copy() { return new AliceChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AliceChessState o = (AliceChessState) other;
