...
/** Auto-generated State subclass for AcedrexAlfonso. */
public class AcedrexAlfonsoState extends State {
    ...
    public AcedrexAlfonsoState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AcedrexAlfonsoState(final AcedrexAlfonsoState other) {
        super(other);
    ...
    @Override public AcedrexAlfonsoState copy() { return new AcedrexAlfonsoState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AcedrexAlfonsoState o = (AcedrexAlfonsoState) other;
