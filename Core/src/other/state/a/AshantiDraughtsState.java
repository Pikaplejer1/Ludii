...
/** Auto-generated State subclass for AshantiDraughts. */
public class AshantiDraughtsState extends State {
    ...
    public AshantiDraughtsState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public AshantiDraughtsState(final AshantiDraughtsState other) {
        super(other);
    ...
    @Override public AshantiDraughtsState copy() { return new AshantiDraughtsState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AshantiDraughtsState o = (AshantiDraughtsState) other;
