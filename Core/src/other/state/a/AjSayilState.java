...
/** Auto-generated State subclass for AjSayil. */
public class AjSayilState extends State {
    ...
    public AjSayilState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public AjSayilState(final AjSayilState other) {
        super(other);
    ...
    @Override public AjSayilState copy() { return new AjSayilState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final AjSayilState o = (AjSayilState) other;
