...
/** Auto-generated State subclass for NodalChess. */
public class NodalChessState extends State {
    ...
    public NodalChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NodalChessState(final NodalChessState other) {
        super(other);
    ...
    @Override public NodalChessState copy() { return new NodalChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NodalChessState o = (NodalChessState) other;
