...
/** Auto-generated State subclass for Nchuwa. */
public class NchuwaState extends State {
    ...
    public NchuwaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NchuwaState(final NchuwaState other) {
        super(other);
    ...
    @Override public NchuwaState copy() { return new NchuwaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NchuwaState o = (NchuwaState) other;
