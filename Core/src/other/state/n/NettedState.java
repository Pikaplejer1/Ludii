...
/** Auto-generated State subclass for Netted. */
public class NettedState extends State {
    ...
    public NettedState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NettedState(final NettedState other) {
        super(other);
    ...
    @Override public NettedState copy() { return new NettedState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NettedState o = (NettedState) other;
