...
/** Auto-generated State subclass for Nsolo. */
public class NsoloState extends State {
    ...
    public NsoloState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NsoloState(final NsoloState other) {
        super(other);
    ...
    @Override public NsoloState copy() { return new NsoloState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NsoloState o = (NsoloState) other;
