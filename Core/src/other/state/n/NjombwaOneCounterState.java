...
/** Auto-generated State subclass for NjombwaOneCounter. */
public class NjombwaOneCounterState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NjombwaOneCounterState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NjombwaOneCounterState(final NjombwaOneCounterState other) {
        super(other);
    ...
    @Override public NjombwaOneCounterState copy() { return new NjombwaOneCounterState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NjombwaOneCounterState o = (NjombwaOneCounterState) other;
