...
/** Auto-generated State subclass for Nama. */
public class NamaState extends State {
    ...
    public NamaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public NamaState(final NamaState other) {
        super(other);
    ...
    @Override public NamaState copy() { return new NamaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NamaState o = (NamaState) other;
