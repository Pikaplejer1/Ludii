...
/** Auto-generated State subclass for Nebakuthana. */
public class NebakuthanaState extends State {
    ...
    public NebakuthanaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public NebakuthanaState(final NebakuthanaState other) {
        super(other);
    ...
    @Override public NebakuthanaState copy() { return new NebakuthanaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NebakuthanaState o = (NebakuthanaState) other;
