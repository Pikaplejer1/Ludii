...
/** Auto-generated State subclass for NinAdnaiKitAdnat. */
public class NinAdnaiKitAdnatState extends State {
    ...
    public NinAdnaiKitAdnatState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NinAdnaiKitAdnatState(final NinAdnaiKitAdnatState other) {
        super(other);
    ...
    @Override public NinAdnaiKitAdnatState copy() { return new NinAdnaiKitAdnatState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NinAdnaiKitAdnatState o = (NinAdnaiKitAdnatState) other;
