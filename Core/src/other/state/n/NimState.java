...
/** Auto-generated State subclass for Nim. */
public class NimState extends State {
    ...
    public NimState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NimState(final NimState other) {
        super(other);
    ...
    @Override public NimState copy() { return new NimState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NimState o = (NimState) other;
