...
/** Auto-generated State subclass for Nardshir. */
public class NardshirState extends State {
    ...
    public NardshirState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public NardshirState(final NardshirState other) {
        super(other);
    ...
    @Override public NardshirState copy() { return new NardshirState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NardshirState o = (NardshirState) other;
