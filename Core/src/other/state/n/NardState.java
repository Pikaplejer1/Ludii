...
/** Auto-generated State subclass for Nard. */
public class NardState extends State {
    ...
    public NardState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    ...
    public NardState(final NardState other) {
        super(other);
    ...
    @Override public NardState copy() { return new NardState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NardState o = (NardState) other;
