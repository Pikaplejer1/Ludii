...
/** Auto-generated State subclass for NjombwaTwoCounters. */
public class NjombwaTwoCountersState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NjombwaTwoCountersState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NjombwaTwoCountersState(final NjombwaTwoCountersState other) {
        super(other);
    ...
    @Override public NjombwaTwoCountersState copy() { return new NjombwaTwoCountersState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NjombwaTwoCountersState o = (NjombwaTwoCountersState) other;
