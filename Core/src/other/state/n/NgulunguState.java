...
/** Auto-generated State subclass for Ngulungu. */
public class NgulunguState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NgulunguState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NgulunguState(final NgulunguState other) {
        super(other);
    ...
    @Override public NgulunguState copy() { return new NgulunguState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NgulunguState o = (NgulunguState) other;
