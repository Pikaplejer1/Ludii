...
/** Auto-generated State subclass for Namudilakunze. */
public class NamudilakunzeState extends State {
    ...
    public NamudilakunzeState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NamudilakunzeState(final NamudilakunzeState other) {
        super(other);
    ...
    @Override public NamudilakunzeState copy() { return new NamudilakunzeState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NamudilakunzeState o = (NamudilakunzeState) other;
