...
/** Auto-generated State subclass for NMesh. */
public class NMeshState extends State {
    ...
    public NMeshState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NMeshState(final NMeshState other) {
        super(other);
    ...
    @Override public NMeshState copy() { return new NMeshState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NMeshState o = (NMeshState) other;
