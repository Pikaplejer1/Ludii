...
/** Auto-generated State subclass for NotChess. */
public class NotChessState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NotChessState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NotChessState(final NotChessState other) {
        super(other);
    ...
    @Override public NotChessState copy() { return new NotChessState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NotChessState o = (NotChessState) other;
