...
/** Auto-generated State subclass for Nex. */
public class NexState extends State {
    ...
    public NexState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NexState(final NexState other) {
        super(other);
    ...
    @Override public NexState copy() { return new NexState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NexState o = (NexState) other;
