...
/** Auto-generated State subclass for Njombwa. */
public class NjombwaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NjombwaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NjombwaState(final NjombwaState other) {
        super(other);
    ...
    @Override public NjombwaState copy() { return new NjombwaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NjombwaState o = (NjombwaState) other;
