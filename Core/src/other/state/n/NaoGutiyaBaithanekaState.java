...
/** Auto-generated State subclass for NaoGutiyaBaithaneka. */
public class NaoGutiyaBaithanekaState extends State {

    private static final long serialVersionUID = 1L;

    private gnu.trove.list.array.TIntArrayList sitesToRemove = new gnu.trove.list.array.TIntArrayList();

    public NaoGutiyaBaithanekaState(final Game game, final StateConstructorLock lock) {
        super(game, lock);
    }

    public NaoGutiyaBaithanekaState(final NaoGutiyaBaithanekaState other) {
        super(other);
    ...
    @Override public NaoGutiyaBaithanekaState copy() { return new NaoGutiyaBaithanekaState(this); }

    @Override public void resetStateTo(final State other, final Game game) {
        super.resetStateTo(other, game);
        final NaoGutiyaBaithanekaState o = (NaoGutiyaBaithanekaState) other;
