...
public abstract class State implements Serializable {
     ...
     */
    public int numTurnSamePlayer = 0;
     ...
     */
    public int isDecided = Constants.UNDEFINED;
     ...
     * certain player.
     */
    transient public Owned owned;

    /**
     * To access where are each type of piece on each track.
     */
    transient public OnTrackIndices onTrackIndices;
     ...
     */
    public int numConsecutivePasses = 0;
    ...
    public long moverHash;

    public long nextHash;

    public long prevHash;

    public long stalematedHash;

    public long[] moverHashes;

    public long[] nextHashes;

    public long[] prevHashes;

    public long[] stalematedHashes;

    public long[][] phaseHashes;

    public long[][] playerOrderHashes;

    public long[] lastFromHashes;

    public long[] lastToHashes;
